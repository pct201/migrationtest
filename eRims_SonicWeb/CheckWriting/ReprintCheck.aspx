<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReprintCheck.aspx.cs" Inherits="CheckWriting_ReprintCheck" MasterPageFile="~/Default.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function ConfirmRePrint()
    {
	    ...
	    if(!isChecked)
	    {
	        alert('Please select any check to Reprint.');
	    	return false;
	    }
	    else
	    {
            return confirm("Are you sure you want to Reprint selected checks?");
        }
        
    }
    </script>
    
    <%--<asp:ScriptManager ID="smRePrintChkDetail" EnablePageMethods="true" runat="server">
        
    </asp:ScriptManager>--%>
    <%--<asp:UpdatePanel ID="pnlRePrintChkDetail" runat="server">
        <ContentTemplate>--%>
            <table width="100%">
                <tr>
                    <td>
                        ...
                        <td class="ic">
                            ...
                            <tr>
                                <td style="text-align: left;" colspan="2">
                                    <asp:GridView ID="gvChkRePrint" runat="server" Width="100%" AllowPaging="true" AllowSorting="true"
                                        AutoGenerateColumns="false" OnSorting="gvChkRePrint_Sorting" OnPageIndexChanging="gvChkRePrint_PageIndexChanging" OnRowCreated="gvChkRePrint_RowCreated">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <input name="chkItem" type="checkbox" value='<%# Eval("Pk_check_no")%>' onclick="javascript:UnCheckHeader('gvChkRePrint')" />
                                                </ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="RecIssueDate" HeaderText="Issue Date" SortExpression="RecIssueDate" DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="false" />
                                        ...
                                        <EmptyDataTemplate>
                                            Currently There Is No Check for Re-Print.
                                        </EmptyDataTemplate>
                            ...
                            <tr>
                                <td style="width:50%;color:Red;font-weight:bolder;" align="left" class="lc" >Total of all records</td>
                                <td style="width:50%;padding-right:5px;" align="right" class="lc"><asp:Label ID="lblTotalAmount" runat="server"  ></asp:Label></td>
                            </tr>
                            <tr>
                                <td align="left">
                                <asp:Button ID="btnRePrintCheck" runat="server" Text="Reprint Checks" OnClick="btnRePrintCheck_Click" />
                                </td>
                            </tr>
                        </table>
                    </td>
