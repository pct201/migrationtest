...
public partial class WorkerCompensation_subrogation : System.Web.UI.Page
{
    ...
    private void DisplayEmployeeInfo(string claimNO)
    {
        ...
        lblDOIncident.Text = lstClaimReservesInfo[0].Date_Of_Loss.ToShortDateString(); 
        ...
        lblVDOInci.Text = lstClaimReservesInfo[0].Date_Of_Loss.ToShortDateString(); 
    ...
    protected void btnNextStep_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Claim/Workers_Compensation/SubrogationDetail.aspx");
    ...
    {
        Response.Redirect("SubrogationDetail.aspx");
    }
    #endregion
