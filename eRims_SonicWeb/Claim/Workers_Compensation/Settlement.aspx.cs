...
public partial class WorkerCompensation_Settlement : System.Web.UI.Page
{
    ...
    private void BindSettlemetDetails()
    {
        ...
        try
        {
            ...
            if (lstSettlement.Count > 0)
            {
                ...
                lblFName.Text = lstSettlement[0].First_Name;
                lblLName.Text = lstSettlement[0].Last_Name;
    ...
    public void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            rptViewer.ServerReport.ReportPath = System.Configuration.ConfigurationSettings.AppSettings["ReportPath"] + Request["Path"] + "/rptSettlement";
