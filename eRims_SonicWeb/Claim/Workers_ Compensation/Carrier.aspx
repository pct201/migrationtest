<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" Theme="Default"
    CodeFile="Carrier.aspx.cs" Inherits="WorkerCompensation_Carrier" Title="Risk Management Insurance System" %>
            ...
            <table border="0" cellpadding="1" cellspacing="0" width="99%">
                <tr>
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                        <a class="main_menu" href="WorkersCompensation.aspx">Worker's Compensation</a>
                    </td>
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                        <a class="main_menu" href="WorkerCompensationReserve.aspx">Reserve Worksheets</a>
                    </td>
                    ...
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                        <a class="main_menu" href="CheckRegister.aspx">Check Register</a>
                    </td>
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                        <a class="main_menu" href="MainDiary.aspx">Diary</a>
                    </td>
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                        <a class="main_menu" href="MainAdjuster.aspx">Adjustor Notes</a>
                    </td>
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                        <a class="main_menu" href="Settlement.aspx">Settlement</a>
                    </td>
                </tr>
            </table>
        </div>
        <div id="leftDiv" runat="server" style="width: 18%; height: 350px; float: left; border: solid 1px #7F7F7F;
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="95%">
                ...
                <tr>
                    ...
                    <td>
                        <a class="left_menu" id="second" onclick="javascript:getsecond();" href="#">Carrier
                            Data Info <span class="mf">*</span> </a>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <a class="left_menu" id="third" onclick="javascript:getthird();" href="#">Attachment</a>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div style="width: 100%; display: none;" id="divsecond" runat="server">
                <table cellpadding="2" cellspacing="0" class="stylesheet" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td class="ic" style="width: 27%;">
                            $<asp:TextBox ID="txtDefenseMedicalEva" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvDefenseMedicalEva" Display="none"
                                Text="*" ErrorMessage="Please Enter [Carrier Data Information]/Defense Medical Evaluation Paid To Date"
                                ValidationGroup="vsErrorGroup" ControlToValidate="txtDefenseMedicalEva">
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtEmpLegalExp" SkinID="txtCarrier" runat="server" MaxLength="20"
                                onKeyPress="javascript:return(currencyFormat(this,',','.',event))"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvEmpLegalExp" Display="none" Text="*"
                                ErrorMessage="Please Enter [Carrier Data Information]/Employer Legal Expense To Date"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtEmpLiability" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtEmpLiabilityPaid" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtExpertWitnessPaid" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvExpertWitnessPaid" Display="none"
                                Text="*" ErrorMessage="Please Enter [Carrier Data Information]/Expert Witness Paid To Date"
                                ValidationGroup="vsErrorGroup" ControlToValidate="txtExpertWitnessPaid">
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtFuneralExpPaid" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtHospitalCostPaid" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td>
                            <asp:TextBox ID="txtIndependentSubContractNo" SkinID="txtNo$Carrier" runat="server"
                    ...
                    <tr>
                        ...
                        <td class="ic" colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvMajorClassCode" Display="none"
                                Text="*" ErrorMessage="Please Select [Carrier Data Information]/Major Class Code"
                                InitialValue="--Select Major Class Code--" ValidationGroup="vsErrorGroup" ControlToValidate="dwMajorClassCode">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtProducerCode" runat="server" SkinID="txtNo$Carrier" MaxLength="7"
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtLumpSumRemarriage" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvLumpSumRemarriage" Display="none"
                                Text="*" ErrorMessage="Please Enter [Carrier Data Information]/Lump Sum Remarriage Payment"
                                InitialValue="" ValidationGroup="vsErrorGroup" ControlToValidate="txtLumpSumRemarriage">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtProductRecovery" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                    ...
                    <tr>
                        ...
                        <td class="ic" colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondAct" Display="none" Text="*"
                                ErrorMessage="Please Select [Carrier Data Information]/Loss Condition Act" InitialValue="--Select Loss Condition Act--"
                                ValidationGroup="vsErrorGroup" ControlToValidate="dwLossCondAct">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondRecovery" Display="none"
                                Text="*" ErrorMessage="Please Select [Carrier Data Information]/Loss Condition Type Recovery"
                                InitialValue="--Select Loss Condition Type Recovery--" ValidationGroup="vsErrorGroup"
                                ControlToValidate="dwLossCondRecovery">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic" colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCoverageCode" Display="none"
                                Text="*" ErrorMessage="Please Select [Carrier Data Information]/Loss Coverage Code"
                                InitialValue="--Select Loss Coverage Code--" ValidationGroup="vsErrorGroup" ControlToValidate="dwLossCoverageCode">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtIncurredLoss" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtOtherMedicalPaid" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtOtherVocationRehap" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                    ...
                    <tr>
                        ...
                        <td class="ic" style="height: 40px">
                            $<asp:TextBox ID="txtPenaltyPaid" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvPenaltyPaid" Display="none" Text="*"
                                ErrorMessage="Please Enter [Carrier Data Information]/Penalties Paid To Date"
                        ...
                        <td style="height: 40px" class="ic">
                            $<asp:TextBox ID="txtPensionIndem" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvPensionIndem" Display="none" Text="*"
                                ErrorMessage="Please Enter [Carrier Data Information]/Pension Indemnity Benefit Paid To Valuation Date"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtPensionIndemNotPaid" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="ic">
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvGarageState" Display="none" Text="*"
                                ErrorMessage="Please Select [Carrier Data Information]/Garage State" InitialValue="--Select State--"
                                ValidationGroup="vsErrorGroup" ControlToValidate="dwGarageState">
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="lc">
                        ...
                        <td>
                            <asp:TextBox ID="txtReserveTypeCode" SkinID="txtNo$Carrier" runat="server" onkeypress="return numberOnly(event);"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtRecoveryCurrMonth" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtRecoveryDate" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <cc1:MaskedEditValidator ID="mskValDtStart" runat="server" ControlExtender="mskSingleSumPaidDate"
                                ControlToValidate="txtSingleSumPaidDate" Display="none" IsValidEmpty="true" MaximumValue=""
                            ...
                            <asp:RegularExpressionValidator ID="revIDONoteEntry" runat="server" ControlToValidate="txtSingleSumPaidDate"
                                ...
                                ErrorMessage="[Carrier Data Information]/Date Single Sum Paid Is Not Valid Date"
                                Display="none" Text="*" ValidationGroup="vsErrorGroup"></asp:RegularExpressionValidator>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtSingleSum" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtSSOffsetAmt" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTempIndemIncurred" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td>
                            <asp:TextBox ID="txtTempIndemNoOfWeeks" SkinID="txtNo$Carrier" runat="server" onkeypress="return numberOnly(event);"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTimeExpCurrMonth" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTimeExpDate" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTotalGrossIncurred" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTotIncVocRehab" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTotIncVocRehabEduBeni" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTotIncuocationRehabExp" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            <asp:TextBox ID="txtTotIncVocRehabMaintBen" SkinID="txtNo$Carrier" runat="server"
                                onKeyPress="return(currencyFormat(this,',','.',event))" MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtTotPayToPhysician" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            <asp:TextBox ID="txtTransactCode" SkinID="txtNo$Carrier" runat="server" onkeypress="return numberOnly(event);"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtLumpSumSettleAmt" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvLumpSumSettleAmt" Display="none"
                                Text="*" ErrorMessage="Please Enter [Carrier Data Information]/Lump Sum Settlement Amount"
                                InitialValue="" ValidationGroup="vsErrorGroup" ControlToValidate="txtLumpSumSettleAmt">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtOtherRecovery" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtOtherWeekPayment" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic" style="height: 44px">
                            <asp:TextBox ID="txtCatastropheNo" SkinID="txtNo$Carrier" onkeypress="return numberOnly(event);"
                        ...
                        <td style="height: 44px" class="lc">
                            $<asp:TextBox ID="txtWorkCompIndemPay" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtIndemIncurred" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtIndemIncuCurrMonth" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtIndemPaid" runat="server" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtMediIncurToDate" runat="server" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtMedicalIncuCurrMonth" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                runat="server" MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtMediPaidToDate" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtExpIncurred" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtExpIncuCurrMonth" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtExpPaid" runat="server" SkinID="txtCarrier" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="lc">
                        ...
                        <td class="ic">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator runat="server" ID="rfvContovertedcase" Display="none"
                                            Text="*" ErrorMessage="Please Select [Carrier Data Information]/Controverter Case?"
                                            InitialValue="" ValidationGroup="vsErrorGroup" ControlToValidate="rbtnContovertedcase">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondLoss" Display="none" Text="*"
                                ErrorMessage="Please Select [Carrier Data Information]/Loss Conditions Loss"
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondSettlement" Display="none"
                                Text="*" ErrorMessage="Please Select [Carrier Data Information]/Loss Condition Settlement"
                                InitialValue="--Select Condition Settlement--" ValidationGroup="vsErrorGroup"
                                ControlToValidate="dwLossCondSettlement">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator runat="server" ID="rfvDeductibleIndicator" Display="none"
                                            Text="*" ErrorMessage="Please Select [Carrier Data Information]/Deductible Indicator"
                                            InitialValue="" ValidationGroup="vsErrorGroup" ControlToValidate="rbtnDeductibleIndicator">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="ic">
                            $<asp:TextBox ID="txtDeductRaimbursh" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvDeductRaimbursh" Display="none"
                                Text="*" ErrorMessage="Please Enter [Carrier Data Information]/Deductible Reimbursement Amount"
                                InitialValue="" ValidationGroup="vsErrorGroup" ControlToValidate="txtDeductRaimbursh">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvSettlementMethod" Display="none"
                                Text="*" ErrorMessage="Please Select [Carrier Data Information]/Settlement Method"
                                InitialValue="--Select Settlement Method--" ValidationGroup="vsErrorGroup" ControlToValidate="dwSettlementMethod">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ic">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator runat="server" ID="rfvLegalRepresant" Display="none"
                                            Text="*" ErrorMessage="Please Select [Carrier Data Information]/Legal Representation"
                                            InitialValue="" ValidationGroup="vsErrorGroup" ControlToValidate="rbtnLegalRepresant">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvAttorneyForm" Display="none" Text="*"
                                ErrorMessage="Please Select [Carrier Data Information]/Attorney form" InitialValue="--Select Loss Attorney--"
                                ValidationGroup="vsErrorGroup" ControlToValidate="dwAttorneyForm">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="ic">
                            ...
                            <div id="pnlTemp" style="display: block;">
                                <asp:TextBox ID="txtDescription" SkinID="txtCarrier" runat="server" MaxLength="4000"
                                    TextMode="MultiLine" Width="93%" Height="200px"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" class="ic" valign="top" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvUpload" runat="server" ControlToValidate="uplCommon"
                                InitialValue="" Display="none" Text="*" ErrorMessage="Please Select [Attachment]/File To Upload"
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" class="ic">
                    ...
                    <asp:Button ID="Next" runat="server" Text="Next step" OnClick="Next_Click" OnClientClick="javascript:ValSave();"
                        ValidationGroup="vsErrorGroup" />
                </td>
            </tr>
        </table>
