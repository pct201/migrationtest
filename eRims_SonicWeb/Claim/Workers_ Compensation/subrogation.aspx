     ...
     function MinMax(name)
    {
        if(name == "check")
        {
            if(document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtDescription").style.height == "")
            {
                ...
                document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtDescription").style.height = "200px";
                document.getElementById("pnlCheck").style.display = "block";
            }
            else if(document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtDescription").style.height == "200px")
            {
        ...
        if(name == "recovery")
        {
            if(document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtRecoveryDesc").style.height == "")
            {
                ...
                document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtRecoveryDesc").style.height = "200px";
                document.getElementById("pnlRecovery").style.display = "block";
            }
            else if(document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtRecoveryDesc").style.height == "200px")
            {
        ...
        if(name == "attachment")
        {
            if(document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtAttachDesc").style.height == "")
            {
                ...
                document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtAttachDesc").style.height = "200px";
                document.getElementById("pnlAttach").style.display = "block";
            }
            else if(document.getElementById("ctl00_ContentPlaceHolder1_fvSubrogation_txtAttachDesc").style.height == "200px")
            {
                                                        ...
                                                        <table border="0" cellpadding="2" cellspacing="2" class="lc" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic" colspan="4" valign="top">
                                                                    ...
                                                                    <asp:TextBox ID="txtDescription" runat="server" MaxLength="4000" TextMode="MultiLine" Height="200px"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="ic" colspan="4" valign="top">
                                                                    ...
                                                                    <div id="pnlRecovery" style="display:block;">
                                                                        <asp:TextBox runat="server" ID="txtRecoveryDesc" MaxLength="4000" TextMode="MultiLine" Height="200px"
                                                                            Width="95%"></asp:TextBox>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table cellpadding="2" cellspacing="2" class="stylesheet" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:ImageButton ID="ibtnAttachment" ImageUrl="~/Images/minus.jpg" runat="server" OnClientClick="javascript:return MinMax('attachment');" />
                                                                    ...
                                                                    <asp:TextBox ID="txtAttachDesc" runat="server" MaxLength="4000" TextMode="MultiLine" Height="200px"
                                                                        Width="95%"></asp:TextBox>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table border="0" cellpadding="2" cellspacing="2" class="lc" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic" colspan="4" valign="top">
                                                                    <asp:ImageButton ID="ibtnCheck" ImageUrl="~/Images/minus.jpg" runat="server" OnClientClick="javascript:return MinMax('check');" />
                                                                    <div id="pnlCheck" style="display:block;">
                                                                        <asp:TextBox ID="txtDescription" runat="server" Text='<%#Eval("Other_Description") %>' Height="200px"
                                                        ...
                                                        <table cellpadding="2" cellspacing="2" class="stylesheet" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="4" class="ic" style="width:75%;" valign="top">
                                                                    <asp:ImageButton ID="ibtnAttachment" ImageUrl="~/Images/minus.jpg" runat="server" OnClientClick="javascript:return MinMax('attachment');" />
                                                                    <div id="pnlAttach" style="display:block;">
                                                                        <asp:TextBox ID="txtAttachDesc" runat="server" TextMode="MultiLine" Width="95%" Height="200px" MaxLength="4000"></asp:TextBox>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
