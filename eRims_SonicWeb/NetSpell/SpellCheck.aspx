<%@ Page Language="C#" ClassName="PopUpSpell" ValidateRequest="False" Theme="" StylesheetTheme=""
...
<body id="SpellingBody" style="margin: 0px" runat="server">
    ...
    <asp:Panel ID="ModalFrame" runat="server" Visible="False" EnableViewState="False">
        <iframe id="SpellCheckFrame" hidefocus="hidefocus" name="SpellCheckFrame" src="SpellCheck.aspx"
