...
var spellURL = "NetSpell/SpellCheck.aspx";
...
function getText(index) {
    ...
    if (oElement == null) oElement = checkElements[index];
    var sText = "";
...
function initialize() {
    ...
    switch (spellMode) {
        ...
        default:
            ...
            if (loadText()) {
//                if (document.SpellingForm = null || document.SpellingForm=undefined)
//                    document.forms["SpellingForm"].submit();
//                else
