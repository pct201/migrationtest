<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_PM_Equipment_Spray_Booth.aspx.cs"
    Inherits="SONIC_Pollution_AuditPopup_PM_Equipment_Spray_Booth" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>eRIMS Sonic :: Paint Booth Audit Trail</title>
</head>
                        ...
                        <tbody>
                            <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                ...
                                <th class="cols" align="left">
                                 ...
                                 <th class="cols" align="left">
                                    <span style="display: inline-block; width: 150px;">Manual for Paint Booth location in 6H Binder?</span>
                                </th>
                                <th class="cols" align="left">
