<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="PM_FirstRepose_AEDEquipment.aspx.cs" Inherits="SONIC_Pollution_PM_FirstRepose_AEDEquipment" %>
        ...
        function ValidateFields(sender, args) {
            ...
            if (document.getElementById('<%=hdnControlIDs.ClientID%>').value != "") {
                ...
                for (i = 0; i < ctrlIDs.length; i++) {
                    ...
                    var rdoStoreService = $("#<%=rdoStoreService.ClientID%> input[type='radio']:checked");

                    if (ctrlIDs[i] == '<%=rdoStoreService.ClientID%>') {
                        if (rdoStoreService.length == 0 && ctrlIDs[i].indexOf('rdoMedical_Evaluation') > 0) bEmpty = true;
                                        ...
                                        <div id="dvEdit" runat="server" width="794px">
                                            <asp:Panel ID="pnl1" runat="server" Style="display: inline;">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        <td align="left" valign="top" colspan="3">Does the store service High Voltage, Electric or Hybrid Vehicles?
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <asp:RadioButtonList ID="rdoStoreService" runat="server">
                                                    ...
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">AED Manufacturer&nbsp;<span id="Span1" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top" width="4%">:
                                                        </td>
                                                        <td align="left" valign="top" width="28%">
                                                            <asp:TextBox ID="txtAEDManufacturer" runat="server" Width="150px" MaxLength="150"/>
                                                        </td>
                                                        <td align="left" valign="top" width="50%"></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">AED Locations&nbsp;<span id="Span2" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top" width="4%">:
                                                        </td>
                                                        <td align="left" valign="top" colspan="2">
                                                            <asp:DropDownList ID="drpFK_AEDLoaction" Width="350px" runat="server" SkinID="dropGen">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">AED Install Date&nbsp;<span id="Span3" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top" width="4%">:
                                                        </td>
                                                        <td align="left" valign="top" colspan="2">
                                                            <asp:TextBox ID="txtInstallDate" runat="server" Width="150px" SkinID="txtDate" autocomplete="off" />
                                                            <img alt="Date" onclick="return showCalendar('ctl00_ContentPlaceHolder1_txtInstallDate', 'mm/dd/y');"
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revDate" runat="server" ValidationGroup="vsErrorGroup"
                                                                ...
                                                                ControlToValidate="txtInstallDate" ValidationExpression="^(((0?[1-9]|1[012])/(0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])/(29|30)|(0?[13578]|1[02])/31)/(19|[2-9]\d)\d{2}|0?2/29/((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <uc:ctrlAttachment ID="Attachments" runat="server" PanelNumber="1" AttachmentTable="PM_FirstRepose_AEDEquipment_Attachments" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                                        ...
                                        <div id="dvView" runat="server" width="794px">
                                            ...
                                            <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top">
                                                        <asp:Label ID="lblStoreService" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" width="18%" valign="top">AED Manufacturer&nbsp;<span id="Span7" style="color: Red;" runat="server">*</span>
                                                    </td>
                                                    <td align="center" valign="top" width="4%">:
                                                    </td>
                                                    <td align="left" valign="top" width="28%">
                                                        <asp:Label ID="lblAEDManufacturer" runat="server" />
                                                    </td>
                                                    <td align="left" valign="top" width="50%"></td>
                                                </tr>
                                                <tr>
                                                    <td align="left" width="18%" valign="top">AED Locations&nbsp;<span id="Span8" style="color: Red;" runat="server">*</span>
                                                    </td>
                                                    <td align="center" valign="top" width="4%">:
                                                    </td>
                                                    <td align="left" valign="top" colspan="2">
                                                        <asp:Label ID="lblFK_AEDLoaction" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" width="18%" valign="top">AED Install Date&nbsp;<span id="Span9" style="color: Red;" runat="server">*</span>
                                                    </td>
                                                    <td align="center" valign="top" width="4%">:
                                                    </td>
                                                    <td align="left" valign="top" colspan="2">
                                                        <asp:Label ID="lblInstallDate" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4" class="Spacer">&nbsp;
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <uc:ctrlAttachment ID="AttachmentsView" runat="server" PanelNumber="1" AttachmentTable="PM_FirstRepose_AEDEquipment_Attachments" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
