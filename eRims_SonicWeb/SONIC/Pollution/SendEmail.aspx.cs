...
public partial class Admin_SendEmail_Pollution : System.Web.UI.Page
{
            ...
            else
            {
                ...
                switch (EmailType)
                {
                    case (int)clsGeneral.EmailTYpe.Attachment:
                        ...
                        string AttachmentTable = Convert.ToString(Request.QueryString["AttachmentTable"]);
                        for (int i = 0; i < AttachmentIds.Length; i++)
                        {
                            ...
                            else
                            {
                                ...
                                string strSQL = "";
                                strSQL = strSQL + "SELECT Attachment_Path";
                                strSQL = strSQL + " FROM " + AttachmentTable + Environment.NewLine;
                                ...
                                string Attachment_Name = Convert.ToString(ds.Tables[0].Rows[0]["Attachment_Path"]);
                                ...
                                string strAttachment = clsGeneral.GetAttachmentDocPath(AttachmentTable) + Attachment_Name;
