<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_PM_Equipment_OWS.aspx.cs"
    Inherits="SONIC_Pollution_AuditPopup_PM_Equipment_OWS" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>eRIMS Sonic :: Oil and Water Separator Audit Trail</title>
</head>
...
<body>
    ...
    <table width="100%" align="left">
        ...
        <tr>
            <td colspan="2">
                <div style="overflow: hidden; width: 300px;" id="divPM_Equipment_OWS" runat="server">
                    <table cellpadding="4" cellspacing="0" style="width: 300px; border-collapse: collapse;">
                        <tbody>
                            <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                ...
                                <%--<th class="cols">
                                    <span style="display: inline-block; width: 100px;">Equipment OWS</span>
                                </th>--%>
                                <th class="cols">
                                    <span style="display: inline-block; width: 150px;">Description</span>
                                </th>
                                <th class="cols">
                                    <span style="display: inline-block; width: 100px;">Connected to Public Water System?</span>
                                </th>
                                <th class="cols">
                                ...
                                <th class="cols">
                                    <span style="display: inline-block; width: 150px;">Inspection Company</span>
                                </th>
                                <th class="cols">
                                    <span style="display: inline-block; width: 150px;">Inspection Company Contact Name</span>
                                </th>
                                <th class="cols">
                                    <span style="display: inline-block; width: 140px;">Inspection Company Contact Telephone</span>
                                </th>
                                <th class="cols">
                ...
                <div style="overflow: scroll; width: 300px; height: 340px;" id="divPM_Equipment_OWS_Grid"
                    runat="server">
                    <asp:GridView ID="gvSIUtilityProvider" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <%--<asp:TemplateField HeaderText="PK_PM_Equipment_OWS">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblPK_PM_Equipment_OWS" runat="server" Text='<%#Eval("PK_PM_Equipment_OWS")%>'
                            ...
                            <asp:TemplateField HeaderText="Connected_to_Public_Water_Application">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblConnected_to_Public_Water_Application" runat="server" Text='<%#Eval("Connected_to_Public_Water_Application")%>'
                                        Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
