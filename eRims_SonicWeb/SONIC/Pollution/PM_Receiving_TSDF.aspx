<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="PM_Receiving_TSDF.aspx.cs" Inherits="SONIC_Pollution_PM_Receiving_TSDF" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowPanel(index) {
            ...
            if (op == "view") {
                ...
                if (index == 2)
                    ...
                    document.getElementById('<%=txtReceiving_TSDF_Name.ClientID%>').focus();
            }
        }
        ...
        function OpenAuditPopUp() {
            ...
            obj = window.open('AuditPopup_PM_Receiving_TSDF.aspx?id=<%=ViewState["PK_PM_Receiving_TSDF"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Receiving
                                            TSDF</span>&nbsp;<span id="MenuAsterisk1" runat="server" style="color: Red; display: none">*</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" width="100%">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
                                                            Receiving TSDF Name&nbsp;<span id="Span1" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:TextBox ID="txtReceiving_TSDF_Name" runat="server" Width="170px" MaxLength="100" />
                                                        </td>
                                                        <td align="left" width="18%" valign="top">
                                                            &nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revtxtZipCode" runat="server" ControlToValidate="txtZipCode"
                                                                ErrorMessage="Please Enter [Receiving TSDF]/Zip Code in (XXXXX-XXXX) format."
                                                                SetFocusOnError="true" ValidationGroup="vsErrorGroup" ValidationExpression="\d{5}(-\d{4})?"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            Contact Telephone (XXX-XXX-XXXX)&nbsp;<span id="Span8" style="color: Red; display: none;"
                                                                runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        ...
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revtxtTelephone" runat="server" ControlToValidate="txtContact_Telephone"
                                                                ErrorMessage="Please Enter [Receiving TSDF]/Contact Telephone in (XXX-XXX-XXXX) format."
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:RadioButtonList ID="rdoCOI_ON_File" runat="server" SkinID="YesNoType">
                                                            </asp:RadioButtonList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Method Used to Dispose of Hazardous Waste&nbsp;<span id="Span10" style="color: Red;
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:DropDownList ID="drpLUHWMethod" Width="175px" runat="server" SkinID="dropGen">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            Describe Other Method, If Selected&nbsp;<span id="Span11" style="color: Red; display: none;"
                                                                runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:TextBox ID="txtHazardous_Waste_Method" runat="server" Width="170px" MaxLength="100" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Is TSDF Located Farther than 270 miles from Hazardous Waste Generator’s Facility?
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" colspan="4" valign="top">
                                                            <asp:RadioButtonList ID="rdbTDSFDistance" runat="server" SkinID="YesNoType">
                                                            </asp:RadioButtonList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Does this Receiving TSDF data apply to all buildings at this location?
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                            ...
                                            <asp:Panel ID="pnl1View" runat="server" Style="display: none;">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:Label ID="lblReceiving_TSDF_Name" runat="server"></asp:Label>
                                                        </td>
                                                        <td align="left" width="18%" valign="top">
                                                            &nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:Label ID="lblCOI_ON_File" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Method Used to Dispose of Hazardous Waste
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <asp:Label ID="lblLUHWMethod" runat="server"></asp:Label>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            Describe Other Method, If Selected
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <asp:Label ID="lblHazardous_Waste_Method" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                        ...
                                                        <td align="left" colspan="4" valign="top">
                                                            <asp:Label ID="lblTDSFDistance" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
