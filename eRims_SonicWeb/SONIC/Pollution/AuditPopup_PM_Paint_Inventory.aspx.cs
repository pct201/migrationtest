...
public partial class SONIC_Pollution_AuditPopup_PM_Paint_Inventory : System.Web.UI.Page
{
    # region " Properties "
    ...
    private void BindUtilityProvider_Audit()
    {
        ...
        lbltable_Name.Text = "PM Paint Inventory";
        // Fill grid with audit table
        dt = PM_CR_Paint_Inventory.GetAuditView(PK).Tables[0];
