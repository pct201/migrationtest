<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="Site_Information_Utility_Provider.aspx.cs" Inherits="SONIC_Pollution_Site_Information_Utility_Provider" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowPanel(index) {
            ...
            if (op == "view") {
                ...
                if (index < 3) {
                    ...
                    if (index == 1)
                        document.getElementById('<%=drpFK_LU_Utility_Type.ClientID %>').focus();
                }
                else {
                    for (i = 1; i <= 2; i++) {
        ...
        function OpenAuditPopUp() {
            ...
            obj = window.open('AuditPopup_PM_SI_Utility_Provider.aspx?id=<%=ViewState["PK_PM_SI_Utility_Provider"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td class="ghc" align="left">
                Site Information – Utility Provider
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Utility Provider</span>&nbsp;<span
                                        ...
                                        <div id="dvEdit" runat="server" width="794px">
                                            <asp:Panel ID="pnl1" runat="server" Style="display: inline;">
                                                <div class="bandHeaderRow">
                                                    Utility Provider</div>
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
                                                            Utility Type&nbsp;<span id="Span1" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:DropDownList ID="drpFK_LU_Utility_Type" Width="175px" runat="server" SkinID="dropGen">
                                                            </asp:DropDownList>                                                            
                                                        </td>
                                                        <td align="left" width="18%" valign="top">
                                                            Utility Name&nbsp;<span id="Span2" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:TextBox ID="txtUtility_Name" runat="server" Width="170px" MaxLength="100" />                                                            
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Telephone (XXX-XXX-XXXX)&nbsp;<span id="Span3" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        ...
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revContactPhone" runat="server" ErrorMessage="Please Enter [Utility Provider]/Telephone in (XXX-XXX-XXXX) format"
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:TextBox ID="txtZip_Code" runat="server" Width="170px" MaxLength="10" onKeyPress="javascript:return FormatZipCode(event,this.id);" />                                                            
                                                             <asp:RegularExpressionValidator ID="revZipCode" ControlToValidate="txtZip_Code" runat="server"
                                                                ValidationGroup="vsErrorGroup" ErrorMessage="Please enter [Utility Provider]/Zip Code in xxxxx-xxxx format."
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Contract Start Date&nbsp;<span id="Span10" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <asp:TextBox ID="txtContact_Start_Date" runat="server" Width="150px" SkinID="txtDate" />
                                                            <img alt="Contract Start Date" onclick="return showCalendar('ctl00_ContentPlaceHolder1_txtContact_Start_Date', 'mm/dd/y');"
                                                                onmouseover="javascript:this.style.cursor='hand';" src="../../Images/iconPicDate.gif"
                                                                align="middle" />
                                                            <asp:RegularExpressionValidator ID="revContact_Start_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Utility Provider]/Contract Start Date is not a valid date"
                                                                SetFocusOnError="true" ControlToValidate="txtContact_Start_Date" ValidationExpression="^(((0?[1-9]|1[012])/(0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])/(29|30)|(0?[13578]|1[02])/31)/(19|[2-9]\d)\d{2}|0?2/29/((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$"></asp:RegularExpressionValidator>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            Contract End Date&nbsp;<span id="Span11" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <asp:TextBox ID="txtContact_End_Date" runat="server" Width="150px" SkinID="txtDate" />
                                                            <img alt="Contract End Date" onclick="return showCalendar('ctl00_ContentPlaceHolder1_txtContact_End_Date', 'mm/dd/y');"
                                                                onmouseover="javascript:this.style.cursor='hand';" src="../../Images/iconPicDate.gif"
                                                                align="middle" />
                                                            <asp:RegularExpressionValidator ID="revContact_End_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Utility Provider]/Contract End Date is not a valid date"
                                                                SetFocusOnError="true" ControlToValidate="txtContact_End_Date" ValidationExpression="^(((0?[1-9]|1[012])/(0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])/(29|30)|(0?[13578]|1[02])/31)/(19|[2-9]\d)\d{2}|0?2/29/((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$"></asp:RegularExpressionValidator>
                                                            <asp:CompareValidator ID="cvDateAdded" runat="server" ControlToValidate="txtContact_End_Date"
                                                                Display="None" ControlToCompare="txtContact_Start_Date" ValidationGroup="vsErrorGroup"
                                                                ErrorMessage="[Utility Provider]/Contract End Date must be greater than or equal to [Utility Provider]/Contract Start Date"
                                            ...
                                            <asp:Panel ID="pnl1View" runat="server" Style="display: inline;">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:Label ID="lblFK_LU_Utility_Type" runat="server"></asp:Label>
                                                        </td>
                                                        <td align="left" width="18%" valign="top">
                                                            Utility Name
                                                        </td>
                                                        ...
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:Label ID="lblUtility_Name" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:Label ID="lblContact_Start_Date" runat="server"></asp:Label>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            Contract End Date
                                                        </td>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:Label ID="lblContact_End_Date" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
