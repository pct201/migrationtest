...
public partial class SONIC_Pollution_AuditPopup_PM_PI_Inventory : System.Web.UI.Page
{
    # region " Properties "
    ...
    private void BindUtilityProvider_Audit()
    {
        ...
        lbltable_Name.Text = "PM Paint Inventory Grid";
        // Fill grid with audit table
        dt = PM_CR_PI_Inventory.GetAuditView(PK).Tables[0];
