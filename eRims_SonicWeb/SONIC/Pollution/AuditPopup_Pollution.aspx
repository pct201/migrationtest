...
<script language="javascript" type="text/javascript">
    function showAudit(divHeader, divGrid) {
        ...
        if (divheight > (window.screen.availHeight - 485) && divGrid.style.height != "") {
            divGrid.style.height = window.screen.availHeight - 485;
        }
    }
...
<body>
    ...
    <table width="100%" align="left">
        ...
        <tr>
            <td colspan="2">
                <div style="overflow: hidden; width: 300px;" id="divPollution" runat="server">
                ...
                <div style="overflow: scroll; width: 300px; height: 320px;" id="divPollution_Grid"
                    runat="server">
