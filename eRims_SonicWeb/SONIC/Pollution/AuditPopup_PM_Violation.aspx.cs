...
using ERIMS.DAL;
using System.Data;
public partial class SONIC_Pollution_AuditPopup_PM_Violation : System.Web.UI.Page
{
    # region " Properties "
    ...
    private void BindUtilityProvider_Audit()
    {
        ...
        lbltable_Name.Text = "PM Violation";
        // Fill grid with audit table
        dt = PM_Violation.GetAuditView(PK).Tables[0];
