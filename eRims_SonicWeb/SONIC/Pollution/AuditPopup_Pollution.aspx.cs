...
public partial class SONIC_Pollution_AuditPopup_Pollution : System.Web.UI.Page
{
    # region " Properties "
    ...
    private void BindUtilityProvider_Audit()
    {
        ...
        lbltable_Name.Text = "Site Information";
        // Fill grid with audit table
        dt = PM_Site_Information.GetAuditView(PK).Tables[0];
