...
using ERIMS.DAL;
using System.Data;
public partial class SONIC_Pollution_AuditPopup_PM_Remediations : System.Web.UI.Page
{
    # region " Properties "
    ...
    private void BindUtilityProvider_Audit()
    {
        ...
        lbltable_Name.Text = "PM Remediations";
        // Fill grid with audit table
        dt = PM_Remediation_Grid.GetAuditView(PK).Tables[0];
