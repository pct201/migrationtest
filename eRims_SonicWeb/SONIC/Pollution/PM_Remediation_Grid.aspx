<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="PM_Remediation_Grid.aspx.cs" Inherits="SONIC_Pollution_PM_Remediation_Grid" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowPanel(index) {
            ...
            if (op == "view") {
                ...
                if (index == 2)
                    ...
                    document.getElementById('ctl00_ContentPlaceHolder1_txtDescription_txtNote').focus();
            }
        }
        ...
        function OpenAuditPopUp() {
            ...
            obj = window.open('AuditPopup_PM_Remediations.aspx?id=<%=ViewState["PK_PM_Remediation_Grid"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Remediations</span>&nbsp;<span
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        <td align="left" valign="top" width="20%">
                                                            What Prompted Remediation?&nbsp;<span id="Span6" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top" width="2%">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top" width="28%">
                                                            <asp:DropDownList ID="drpResult_Of" runat="server">
                                                            </asp:DropDownList>
                                                            <%--<asp:TextBox ID="txtResult_Of" runat="server" Width="170px" MaxLength="100" />--%>
                                                        </td>
                                                        <td align="left" width="18%" valign="top">
                                                            Remediation Type&nbsp;<span id="Span1" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top" width="28%">
                                                            <asp:DropDownList ID="drpFK_LU_PM_Remediation_Type" runat="server" Width="160px">
                                                            </asp:DropDownList>
                                                        </td>                                                      
                                                    </tr>
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
                                                            Link to Violation&nbsp;<span id="Span16" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top" colspan="4">
                                                            <asp:DropDownList ID="drpFK_PM_Violation" runat="server" Width="555px" SkinID="dropGen">
                                                            </asp:DropDownList>
                                                        </td>                                                      
                                                    </tr>
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
                                                            Remediation Description&nbsp;<span id="Span2" style="color: Red; display: none;"
                                                                runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Assessor&nbsp;<span id="Span3" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            Contact Telephone (XXX-XXX-XXXX)&nbsp;<span id="Span5" style="color: Red; display: none;"
                                                                runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        ...
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revtxtTelephone" runat="server" ControlToValidate="txtContact_Telephone"
                                                                ErrorMessage="Please Enter [Remediations]/Contact Telephone in (XXX-XXX-XXXX) format."
                                                                SetFocusOnError="true" ValidationGroup="vsErrorGroup" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}"
                                                                Display="None"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Describe&nbsp;<span id="Span7" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top" colspan="4">
                                                            <uc:ctrlMultiLineTextBox ID="txtDescribe" runat="server" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Were Analytical Tests Performed?
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <asp:RadioButtonList ID="rdAnalytical_Tests" runat="server" SkinID="YesNoType">
                                                            </asp:RadioButtonList>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            &nbsp;
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Describe&nbsp;<span id="Span8" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top" colspan="4">
                                                            <asp:TextBox ID="txtAnalytical_Desciption" runat="server" Width="95%" MaxLength="100"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Post Remediation, No Further Action Letter (from Regulatory Entity) Obtained?
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <asp:RadioButtonList ID="rdLetter_Obtained" runat="server" SkinID="YesNoType">
                                                            </asp:RadioButtonList>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            &nbsp;
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Post Remediation, Other – Describe&nbsp;<span id="Span9" style="color: Red; display: none;"
                                                                runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        ...
                                                        <td align="left" valign="top" colspan="4">
                                                            <asp:TextBox ID="txtPost_Remediation_Other" runat="server" Width="95%" MaxLength="100"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Report Date&nbsp;<span id="Span10" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revReport_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Remediations]/Report Date is not a valid date"
                                                        ...
                                                        <td align="left" valign="top">
                                                            Cost&nbsp;<span id="Span11" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Next Review Date&nbsp;<span id="Span12" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revNext_Review_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Remediations]/Next Review Date is not a valid date"
                                                        ...
                                                        <td align="left" valign="top">
                                                            Next Report Date&nbsp;<span id="Span13" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revNext_Report_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Remediations]/Next Report Date is not a valid date"
                                                            ...
                                                            <asp:CompareValidator ID="cvnextReportDate" runat="server" ControlToValidate="txtNext_Report_Date"
                                                                Display="None" ControlToCompare="txtReport_Date" ValidationGroup="vsErrorGroup"
                                                                ErrorMessage="[Remediations]/Next Report Date must be greater than or equal to [Remediations]/Report Date"
                                                                Operator="GreaterThanEqual" Type="Date" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Recommendations&nbsp;<span id="Span14" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Does this Remediation data apply to all buildings at this location?
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                        ...
                                        <div id="dvView" runat="server" width="794px">
                                            <asp:Panel ID="pnl1View" runat="server" Style="display: none;">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        <td align="left" valign="top"  width="20%">
                                                           What Prompted Remediation?</td>
                                                        <td align="center" valign="top" width="2%">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top"  width="28%">
                                                            <asp:Label ID="lblResult_Of" runat="server"></asp:Label>
                                                        </td>                                                        
                                                        <td align="left" width="18%" valign="top">
                                                            Remediation Type
                                                        </td>
                                                        ...
                                                        <td align="left" valign="top" width="28%">
                                                            <asp:Label ID="lblFK_LU_PM_Remediation_Type" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
                                                        ...
                                                        <td align="left" colspan="4" valign="top" >
                                                            <asp:Label ID="lblFK_PM_Violation" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left"  valign="top">
                                                        ...
                                                        <td align="left" colspan="4" valign="top"  width="28%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" colspan="4">
                                                            <uc:ctrlMultiLineTextBox ID="lblDescribe" runat="server" ControlType="Label" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:Label ID="lblAnalytical_Tests" runat="server"></asp:Label>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            &nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" colspan="4">
                                                            <asp:Label ID="lblAnalytical_Desciption" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:Label ID="lblLetter_Obtained" runat="server"></asp:Label>
                                                        </td>
                                                        <td align="left" valign="top">
                                                            &nbsp;
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Post Remediation, Other – Describe
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top" colspan="4">
                                                            <asp:Label ID="lblPost_Remediation_Other" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
