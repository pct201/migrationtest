...
public partial class SONIC_Pollution_AuditPopup_EPA_Inspections : System.Web.UI.Page
{
    # region " Properties "
    ...
    private void BindUtilityProvider_Audit()
    {
        ...
        lbltable_Name.Text = "PM Regulatory Inspection";
        // Fill grid with audit table
        dt = PM_EPA_Inspection.GetAuditView(PK).Tables[0];
