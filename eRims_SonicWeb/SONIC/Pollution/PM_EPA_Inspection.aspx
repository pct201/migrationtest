<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="PM_EPA_Inspection.aspx.cs" Inherits="SONIC_Pollution_PM_EPA_Inspection" %>
        ...
        function ShowPanel(index) {
            ...
            if (op == "view") {
                ...
                if (index == 2)
                    ...
                    document.getElementById('<%=drpEPAAssesor.ClientID%>').focus();
            }
        }
...
//            document.getElementById('ctl00_ContentPlaceHolder1_Attachment_cstFile').enabled = true;
        ...
        function OpenAuditPopUp() {
            ...
            obj = window.open('AuditPopup_EPA_Inspections.aspx?id=<%=ViewState["PK_PM_EPA_Inspection"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td class="ghc" align="left">
                Audit/Inspections – Regulatory Inspections
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Regulatory Inspections</span>&nbsp;<span
                                        ...
                                        <div id="dvEdit" runat="server" width="794px">
                                            <asp:Panel ID="pnl1" runat="server" Style="display: none;">
                                                <div class="bandHeaderRow">
                                                    Regulatory Inspections</div>
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
                                                            Inspection Agency&nbsp;<span id="Span1" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" width="28%" valign="top">
                                                        <asp:DropDownList ID="drpEPAAssesor" runat="server"></asp:DropDownList>
                                                            <%--<asp:TextBox ID="txtAssessor" runat="server" Width="170px" MaxLength="75" />--%>
                                                            
                                                        </td>
                                                        <td align="left" width="18%" valign="top">
                                                            Inspection Type&nbsp;<span id="Span2" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" width="4%" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:TextBox ID="txtInspection_Type" runat="server" Width="170px" MaxLength="75" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
                                                        ...
                                                        <td align="left" valign="top">
                                                            Contact Telephone (XXX-XXX-XXXX)&nbsp;<span id="Span4" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <asp:TextBox ID="txtContact_Telephone" runat="server" Width="170px" MaxLength="12"
                                                                SkinID="txtPhone" />
                                                                <asp:RegularExpressionValidator ID="revContactPhone" runat="server" ErrorMessage="Please Enter Valid [Regulatory Inspections]/Contact Telephone"
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Report Date&nbsp;<span id="Span5" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revReport_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Regulatory Inspections]/Report Date is not a valid date"
                                                        ...
                                                        <td align="left" valign="top">
                                                            Cost&nbsp;<span id="Span6" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            $&nbsp;
                                                            <asp:TextBox ID="txtCost" runat="server" Width="150px" onkeypress="return FormatNumber(event,this.id,13,false);" onpaste="return false" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Next Review Date&nbsp;<span id="Span7" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revNext_Review_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Regulatory Inspections]/Next Review Date is not a valid date"
                                                        ...
                                                        <td align="left" valign="top">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revNext_Report_Date" runat="server" ValidationGroup="vsErrorGroup"
                                                                Display="none" ErrorMessage="[Regulatory Inspections]/Next Report Date is not a valid date"
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Recommendations&nbsp;<span id="Span9" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Does this Regulatory Inspection data apply to all buildings at this location?
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                            ...
                                            <asp:Panel ID="pnl1View" runat="server" Style="display: none;">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="left" width="28%" valign="top">
                                                            <asp:Label ID="lblInspection_Type" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" width="18%" valign="top">
