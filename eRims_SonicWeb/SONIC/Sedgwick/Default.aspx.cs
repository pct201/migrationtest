...
public partial class SONIC_Sedgwick_Default : System.Web.UI.Page
{
    ...
    public void BindControls(decimal PK_Workers_Comp_Claims_ID)
    {
        ...
        lblAssociateName_Investigation.Text = drData["First_Name"] + " " + (string.IsNullOrEmpty(drData["Middle_Name"].ToString())); //For Investigation Tab
        lblAssociateName_Subrogation.Text = drData["First_Name"] + " " + (string.IsNullOrEmpty(drData["Middle_Name"].ToString())); //For Subrogation Tab
        lblAssociateName_ClosurePlans.Text = drData["First_Name"] + " " + (string.IsNullOrEmpty(drData["Middle_Name"].ToString())); //For ClosurePlans Tab
        lblAssociateName_Disability.Text = drData["First_Name"] + " " + (string.IsNullOrEmpty(drData["Middle_Name"].ToString())); //For Disability Tab
        lblAssociateName_Leadership.Text = drData["First_Name"] + " " + (string.IsNullOrEmpty(drData["Middle_Name"].ToString())); //For Leadership Tab
        lblAssociateName_Medical.Text = drData["First_Name"] + " " + (string.IsNullOrEmpty(drData["Middle_Name"].ToString())); //For Medical Tab
        lblAssociateName_Reserves.Text = drData["First_Name"] + " " + (string.IsNullOrEmpty(drData["Middle_Name"].ToString())); //For Reserves Tab
