<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="rptInspectionsByInspector.aspx.cs" Inherits="SONIC_Exposures_rptInspectionsByInspector" %>
                    ...
                    <tr id="trGrid" runat="server">
                        <td align="left">
                            <asp:GridView ID="gvInspection" EnableTheming="false" runat="server" AutoGenerateColumns="false" Width="100%"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Region" ItemStyle-Width="20%">
                                        <ItemTemplate>
                                            <%#Eval("Region") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Inspector" ItemStyle-Width="20%">
                                        <ItemTemplate>
                                            <%#Eval("Inspector_Name")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Location D/B/A" ItemStyle-Width="25%">
                                        <ItemTemplate>
                                            <%#Eval("DBA")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Inspection Area" ItemStyle-Width="25%">
                                        <ItemTemplate>
                                            <%#Eval("Fld_Desc")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Number of Deficiencies" ItemStyle-Width="20%">
                                        <ItemTemplate>
                                            &nbsp;&nbsp;
                                            <%#Eval("No_Deficiencies")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
