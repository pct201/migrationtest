...
using System.Data;
public partial class SONIC_Exposures_AuditPopup_EPM_Project_Cost_Invoice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["id"]))
            {
                ...
                dt = AuditTrail.GetProjectCostInvoice_AuditTrial(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
