<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchedulerptPropertyAdHocWriter.aspx.cs"
    Inherits="SONIC_Exposures_SchedulerptPropertyAdHocWriter" %>
        ...
        <div>
            ...
            <div>
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left" class="ghc">Schedule Ad Hoc Report Writer
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;
                    ...
                    <tr style="height: 60%;" align="center" valign="middle">
                        <td valign="middle" align="center">
                            <table width="75%" cellpadding="3" cellspacing="0" style="border: 1pt; border-color: #7f7f7f; border-style: solid; text-align: center; height: 70px;">
                                <div>
                                ...
                                <tr>
                                    <td style="padding-top: 9px;">
                                        <table cellpadding="4" cellspacing="4">
                                            <tr>
                                                <td align="left" width="18%" valign="top">Scheduled Date<span class="mf">*</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="left" width="18%" valign="top">Scheduled End Date<span class="mf">*</span>
                                                </td>
                                                <td align="center" width="4%" valign="top">:
                                                </td>
                                                <td align="left" width="28%" valign="top">
                                            ...
                                            <tr>
                                                <td align="left">Report Name<span class="mf">*</span>
                                                </td>
                                                <td align="center">:
                                                </td>
