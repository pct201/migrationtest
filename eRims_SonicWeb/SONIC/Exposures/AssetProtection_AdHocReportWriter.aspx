<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="AssetProtection_AdHocReportWriter.aspx.cs" Inherits="SONIC_Exposures_AssetProtection_AdHocReportWriter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bandHeaderRow">
        Asset Protection: Ad Hoc Report Writer</div>
    <table cellpadding="2" cellspacing="0" width="100%" align="center">
        <tr>
            <td align="right" style="width: 40%;">
                <strong style="color: #666666;">Report Type: </strong>
            </td>
            <td width="70%">                
                <asp:RadioButtonList ID="rdbReportType" runat="server" AutoPostBack="true" 
                    onselectedindexchanged="rdbReportType_SelectedIndexChanged">
    ...
    <div id="divConfMessage" runat="server" style="border-right: black thin solid; border-top: black thin solid;
        ...
        <div style="background-color: #6699cc; height: 12%" id="Div1">
            <span style="padding-left: 3px; font-size: 14px; text-align: left;">Save Report
            </span>
        </div>
        <br />
        ...
        <div style="z-index: 105; background-color: white; text-align: center">
            <asp:Button ID="btnConfOK" runat="server" Text=" New " OnClick="btnConfOK_Click">
            </asp:Button>
            <asp:Button ID="btnConfCancel" runat="server" Text=" Replace " OnClick="btnConfCancel_Click">
            </asp:Button>
