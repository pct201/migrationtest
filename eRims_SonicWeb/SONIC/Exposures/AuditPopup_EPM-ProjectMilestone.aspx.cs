...
public partial class SONIC_Exposures_AuditPopup_EPM_ProjectMilestone : clsBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["id"]))
            {
                ...
                dt = AuditTrail.GetProjectMilestone_AuditTrial(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
                gvProjectMilestone.DataSource = dt;
