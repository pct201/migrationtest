...
public partial class SONIC_Exposures_AuditPopup_EPM_ActionAndNotes : clsBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            dt = AuditTrail.GetActionAndNotes_AuditTrial(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
            gvActionAndNotes.DataSource = dt;
            gvActionAndNotes.DataBind();
