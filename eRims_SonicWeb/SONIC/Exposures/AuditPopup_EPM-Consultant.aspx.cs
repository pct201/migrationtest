...
public partial class SONIC_Exposures_AuditPopup_EPM_Consultant : clsBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            // show Case Grid 
            dvGrid.Visible = true;
            lbltable_Name.Text = "Consultant";

            // Fill grid with audit table
            dt = AuditTrail.GetConsultant_AuditTrial(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
            gvConsultant.DataSource = dt;
