                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 1547px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 250px">Telephone(XXX-XXX-XXXX)</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 250px">Email</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 1547px; height: 400px;" id="dvGrid" runat="server">
                        <asp:GridView ID="gvProjectManagement" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Site_Contact_Name ">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSite_Contact_Name" runat="server" Text='<%# Eval("Site_Contact_Name") %>'
                                            Width="250px" CssClass="TextClip"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Site_Contact_Telephone">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSite_Contact_Telephone" runat="server" Text='<%# Eval("Site_Contact_Telephone") %>'
                                            Width="250px" CssClass="TextClip"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Site_Contact_Email">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSite_Contact_Email" runat="server" Text='<%# Eval("Site_Contact_Email") %>'
                                            Width="250px" CssClass="TextClip"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
