...
public partial class SONIC_Exposures_PremiumAllocation_AddLocation : clsBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            FillYear();
            ComboHelper.FillNewLocationForPremiumAllocation(new DropDownList[] { drpLocation }, 0, true, Convert.ToInt32(ddlYear.SelectedValue),"Add");
        }
    }
