            ...
            <table width="100%" align="left">
                ...
                <tr>
                    <td colspan="2">
                            ...
                            <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                                <tbody>
                                    <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                        ...
                                        <th class="cols">
                                            <span style="display: inline-block; width: 160px">Monthly AR Control Review</span>
                                        </th>
                                        <th class="cols">
                        ...
                        <div style="overflow: scroll; width: 600px; height: 425px;" id="divAP_Fraud_Events_Audit_Grid"
                            runat="server">
                            <asp:GridView ID="gvAP_Fraud_Events_Audit" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Monthly_AR_Control_Review">
                                        <ItemStyle CssClass="cols" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblMonthly_AR_Control_Review" runat="server" Text='<%#clsGeneral.FormatYesNoToDisplay(Eval("Monthly_AR_Control_Review"))%>'
                                                Width="160px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
