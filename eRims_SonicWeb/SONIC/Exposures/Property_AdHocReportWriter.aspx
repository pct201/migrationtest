<%@ Page Title="Property : Ad-Hoc Report Writer" Language="C#" MasterPageFile="~/Default.master"
    AutoEventWireup="true" CodeFile="Property_AdHocReportWriter.aspx.cs" Inherits="Property_AdHocReportWriter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bandHeaderRow">
        Property : Ad Hoc Report Writer</div>
                                    ...
                                    <td width="75%" valign="top">
                                        <asp:Panel ID="pnlDate_F1" runat="server">
                                            <table width="100%" cellpadding="2">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList Width="20%" ID="lstDate1" runat="server" AutoPostBack="true"
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F2" runat="server">
                                            <table width="100%" cellpadding="2">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate2" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F3" runat="server">
                                            <table width="100%" cellpadding="2">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate3" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F4" runat="server">
                                            <table cellpadding="2" width="100%">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate4" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F5" runat="server">
                                            <table width="100%" cellpadding="2">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate5" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F6" runat="server">
                                            <table width="100%" cellpadding="2">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate6" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F7" runat="server">
                                            <table cellpadding="2" width="100%">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate7" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F8" runat="server">
                                            <table cellpadding="2" width="100%">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate8" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F9" runat="server">
                                            <table cellpadding="2" width="100%">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate9" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
                                    ...
                                    <td width="75%">
                                        <asp:Panel ID="pnlDate_F10" runat="server">
                                            <table cellpadding="2" width="100%">
                                                <tr>
                                                    <td valign="top">
                                                        <asp:DropDownList ID="lstDate10" Width="20%" runat="server" AutoPostBack="true"
                                                            OnSelectedIndexChanged="rdbLstDate_SelectedIndexChanged">
                                                            <asp:ListItem Text="On" Value="O" Selected="True"></asp:ListItem>
                                                            <asp:ListItem Text="Between" Value="B"></asp:ListItem>
                                                            <asp:ListItem Text="On or Before" Value="BF"></asp:ListItem>
