<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="rptEarlyWarningRecipients.aspx.cs" Inherits="COIReports_rptEarlyWarningRecipients" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td align="left" class="ghc" colspan="2">Early Warning Recipients Report</td>
        </tr>
        <tr>
            <td width="100%" class="Spacer" style="height: 3px;" colspan="2"></td>
        </tr>
