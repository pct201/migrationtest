            ...
            <table width="100%" align="left">
                ...
                <tr>
                    <td colspan="2">
                            ...
                            <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                                <tbody>
                                    <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                        ...
                                        <th class="cols">
                                            <span style="display: inline-block; width: 160px">Number Of External Cameras</span>
                                        </th>
                                        <th class="cols">
                                            <span style="display: inline-block; width: 160px">Number Of Internal Cameras</span>
                                        </th>
                                        <th class="cols">
                                            <span style="display: inline-block; width: 160px">Key Fobs</span>
                                        </th>
                                        <th class="cols">
                        ...
                        <div style="overflow: scroll; width: 600px; height: 425px;" id="divAP_Property_Security_Audit_Grid"
                            runat="server">
                            <asp:GridView ID="gvAP_Property_Security_Audit" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="AC_Key_Fobs">
                                        <ItemStyle CssClass="cols" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblAC_Key_Fobs" runat="server" Text='<%#clsGeneral.FormatYesNoToDisplay(Eval("AC_Key_Fobs"))%>'
                                                Width="160px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="AC_Door_Restrictions">
                                        <ItemStyle CssClass="cols" />
                                        <ItemTemplate>
