...
using ERIMS.DAL;
public partial class SONIC_Exposures_AuditPopup_Building_Improvements : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                dt = AuditTrail.GetBuilding_Improvements_AuditTrail(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
                gvBuildingImprovements.DataSource = dt;
