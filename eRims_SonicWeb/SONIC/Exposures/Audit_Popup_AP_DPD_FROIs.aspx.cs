...
public partial class Audit_Popup_AP_DPD_FROIs : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            // show Case Grid 
            dvGrid.Visible = true;
            lbltable_Name.Text = "Asset Protection Module – DPD FROIs";

            // Fill grid with audit table
            dt = AuditTrail.GetAP_DPD_FROIsAuditTrail(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
            gvAP_DPD_FROIs.DataSource = dt;
