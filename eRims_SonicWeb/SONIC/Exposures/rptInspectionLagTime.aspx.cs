...
public partial class SONIC_Exposures_rptInspectionLagTime : clsBasePage
{
    #region "Page Event"
    ...
    protected void lbtExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        GridViewExportUtil.ExportGrid("Inspection Distribution Lag Time.xlsx", gvInspection, true);
