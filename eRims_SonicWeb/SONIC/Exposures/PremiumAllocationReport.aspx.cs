...
public partial class SONIC_Exposures_PremiumAllocationReport : clsBasePage
{
    ...
    protected void lbtExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "Sonic Premium Allocation Report.xls"));
    ...
    private System.Text.StringBuilder GenerageMonthlyReport()
    {
        ...
        if (dtReport.Rows.Count > 0)
        {
            ...
            sbRecorords.Append("<td align='left' style='font-size:9pt;' colspan='2'><b>Sonic Premium Allocation Report</b></td>");
            ...
            for (int i = 0; i < dtReport.Rows.Count; i++)
            {
                ...
                if (Convert.ToString(drRecords["dba"]) == "TOTALS")
                {
                    ...
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Non_Texas_Payroll"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Texas_Payroll"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Total_PayRoll"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", Convert.ToDecimal(drRecords["WC_Premium"])) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Texas_WC_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["SAI_WC_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Loss_Fund"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:N0}", drRecords["Total_Employees"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["SAI_Garage_Liability"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Property_Values"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["SAI_Property_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["SAI_Earthquake_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["SAI_Crime"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Umbrella_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Excess_Umbrella_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Second_Layer_Umbrella_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["EPL_Premium"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Cyber"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Pollution"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Risk_Management_Fee"]) + "</B></td>");
                    sbRecorords.Append("<td class='cols_' align='right'><B>" + string.Format("{0:f2}", drRecords["Total_Actual_Cost"]) + "</B></td>");
                }
                else
                {
                    sbRecorords.Append("<td class='cols_' align='left'>" + Convert.ToString(drRecords["Sonic_Location_Code"]) + "</td>");
                    ...
                    sbRecorords.Append("<td class='cols_' align='left'>" + Convert.ToString(drRecords["State"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Non_Texas_Payroll"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Texas_Payroll"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Total_PayRoll"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", Convert.ToDecimal(drRecords["WC_Premium"])) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Texas_WC_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["SAI_WC_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Loss_Fund"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:N0}", drRecords["Total_Employees"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["SAI_Garage_Liability"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Property_Values"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["SAI_Property_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["SAI_Earthquake_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["SAI_Crime"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Umbrella_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Excess_Umbrella_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Second_Layer_Umbrella_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["EPL_Premium"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Cyber"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Pollution"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Risk_Management_Fee"]) + "</td>");
                    sbRecorords.Append("<td class='cols_' align='right'>" + string.Format("{0:f2}", drRecords["Total_Actual_Cost"]) + "</td>");
                }
