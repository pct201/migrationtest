<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="NationalPremiumAllocationSearch.aspx.cs" Inherits="SONIC_Exposures_NationalPremiumAllocationSearch" %>
                                ...
                                <tr>
                                    <td style="text-align: left;">
                                        <asp:GridView ID="gvPAFields" runat="server" AutoGenerateColumns="false" OnRowCommand="gvPAFields_RowCommand"
                                            ...
                                            DataKeyNames="PK_PA_National_Allocation" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Property Valuation Date" SortExpression="Property_Valuation_Date">
                                                    <ItemStyle Width="25%" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProperty_Valuation_Date" runat="server" Text='<%# clsGeneral.FormatDBNullDateToDisplay(Eval("Property_Valuation_Date"))%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Total Risk Management Fee" SortExpression="Total_Risk_Management_Fee">
                                                    <ItemStyle Width="30%" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTotal_Risk_Management_Fee" runat="server" Text='<%# clsGeneral.FormatCommaSeperatorCurrency(Eval("Total_Risk_Management_Fee"))%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemStyle/>
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnEdit" CommandName="EditItem" CommandArgument='<%#Eval("PK_PA_National_Allocation")%>'
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnView" runat="server" Text="View" CommandName="View" CommandArgument='<%#Eval("PK_PA_National_Allocation")%>'
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CommandName="DeleteItem" CommandArgument='<%#Eval("PK_PA_National_Allocation")%>'
