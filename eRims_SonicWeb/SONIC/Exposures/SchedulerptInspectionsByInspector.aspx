<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchedulerptInspectionsByInspector.aspx.cs"
    Inherits="SONIC_Exposures_SchedulerptInspectionsByInspector" %>
    ...
    <table width="100%">
        <tr>
            <td align="left" class="ghc">
                Inspections By Inspector Report
            </td>
        </tr>
        <tr>
