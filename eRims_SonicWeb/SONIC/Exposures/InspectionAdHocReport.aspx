<%@ Page Title="Risk Insurence Management System : Inspection Ad-Hoc Report Writer" Language="C#"
    MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="InspectionAdHocReport.aspx.cs"
    Inherits="SONIC_Inspection_AdHocReportWriter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowMessage(txtMsg) {
            ...
            DisplayConfirmMessage(txtMsg, 380, 190)
        ...
        var divWidth = '';
        var divHeight = '';
        var txtFirstButton = ' New ';
        var txtSecondButton = ' Replace '
        function DisplayConfirmMessage(msg, width, height) {
            ...
            var divLayer = document.getElementById('<%=divConfMessage.ClientID %>');
        ...
        function SetText(txtButton1, txtButton2) {
            ...
            if (txtButton1 == null)
                document.getElementById('<%=btnConfOK.ClientID %>').innerText = txtFirstButton;
            else
                document.getElementById('<%=btnConfOK.ClientID %>').innerText = txtButton1;

            // Set display text for the two buttons
            if (txtButton2 == null)
                document.getElementById('<%=btnConfCancel.ClientID %>').innerText = txtSecondButton;
            else
                document.getElementById('<%=btnConfCancel.ClientID %>').innerText = txtButton2;
        ...
        function CheckReportName() {
            ...
            var hdnReportId = document.getElementById("ctl00_ContentPlaceHolder1_hdnReportId").value;
            if (hdnReportId > 0) {
                var strNew = document.getElementById("<%= txtReportName.ClientID %>");
                var strOld = document.getElementById("ctl00_ContentPlaceHolder1_hdnOldReportName").value;
                var strNewReport = strNew.value;
                if (strOld != strNewReport) {
                    callAlert("Do you want to save the report " + strNewReport + " as a new report or replace the existing report " + strOld + "");
                    if (isChoice == 7) {
                        document.getElementById("ctl00_ContentPlaceHolder1_hdnCheckReportName").value = false;
                    }
                    else {
                        document.getElementById("ctl00_ContentPlaceHolder1_hdnCheckReportName").value = true;
                    }
                }
            }
        }
    ...
    <div class="bandHeaderRow">
        Facilities Inspection Ad Hoc Report Writer</div>
    <asp:Panel ID="pnl_Container" runat="server">
                ...
                <table width="100%" cellpadding="4" cellspacing="2">
                    <tr>
                        <td align="center" colspan="2">
                           <%-- <asp:RadioButtonList ID="rdbIncidentType" Font-Bold="true" CellSpacing="3" OnSelectedIndexChanged="rdbIncidentType_SelectedIndexChanged"
                                runat="server" AutoPostBack="true" RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Text="Customer" Value="C"></asp:ListItem>
                                <asp:ListItem Text="Non-Customer" Value="N"></asp:ListItem>
                            </asp:RadioButtonList>--%>
                        </td>
                    </tr>
                    <tr>
        ...
        <table width="100%" cellpadding="4" cellspacing="2">
                    ...
                    <table cellspacing="1" cellpadding="2" style="width: 100%">
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 84%;">
                                ...
                                <asp:HiddenField ID="hdnCheckReportName" runat="server" Value="false" />
            ...
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btnSchedule" runat="Server" CssClass="btn" Text="Schedule" ValidationGroup="vsErrorGroup"
                        ...
                        Visible="false" onclick="btnSchedule_Click" />
          ...
          <asp:HiddenField ID="hdnOldReportName" runat="server" Value="" />
          <asp:HiddenField ID="hdnNewReportName" runat="server" Value="" />
          
			
    </asp:Panel>
     <asp:HiddenField ID="hdnReportId" runat="Server" />
    <div id="divConfMessage" runat="server" style="BORDER-RIGHT:black thin solid; BORDER-TOP:black thin solid; DISPLAY:none; Z-INDEX:200; BORDER-LEFT:black thin solid; BORDER-BOTTOM:black thin solid;BACKGROUND-COLOR:ButtonHighlight ">
				<div style="BACKGROUND-COLOR: #6699cc; HEIGHT: 12%" id="Div1">
                <span style="padding-left:3px;font-size:14px;text-align: left;">Save Report </span>                  
				</div><br />
                <div style="BACKGROUND-COLOR:white ;TEXT-ALIGN: center; font-size:13px" id="confirmText">
				</div>
				<div style="Z-INDEX: 105;HEIGHT: 20%;BACKGROUND-COLOR: white;TEXT-ALIGN: center">
				</div>
				<div style="Z-INDEX: 105;BACKGROUND-COLOR: white;TEXT-ALIGN: center">
					<asp:Button ID="btnConfOK" Runat="server" Text=" New " OnClick="btnConfOK_Click"></asp:Button>
					<asp:Button ID="btnConfCancel" Runat="server" Text=" Replace " OnClick="btnConfCancel_Click"></asp:Button>    
