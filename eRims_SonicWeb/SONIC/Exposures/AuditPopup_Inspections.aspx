<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_Inspections.aspx.cs"
    Inherits="SONIC_Exposures_AuditPopup_Inspections" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS :: Inspections Audit Trail</title>
...
<body>
    <form id="form1" runat="server">
        <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 600px;" id="divInspection_Audit_Header" runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 170px">PK_Enviro_Inspection_ID</span></th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 130px">FK_LU_Location_ID</span></th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">Frequency</span></th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 110px">Last_date</span></th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divInspection_Audit_Grid"
                        runat="server">
                        <asp:GridView ID="gvInspection_Audit" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_Enviro_Inspection_ID">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("PK_Enviro_Inspection_ID") %>'
                                ...
                                <asp:TemplateField HeaderText="Frequency">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("Frequency") %>' Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Last_date">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
