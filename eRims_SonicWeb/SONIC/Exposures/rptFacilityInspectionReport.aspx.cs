...
using System.IO;
using ERIMS.DAL;
public partial class SONIC_Exposures_rptFacilityInspectionReport : clsBasePage
{
    ...
    private System.Text.StringBuilder GenerageMonthlyReport()
    {
        ...
        {
            sbRecorords.Append("<style type='text/css'></style><div style='overflow-x: scroll;overflow-y:hidden; width: 994px; height: 100%;'><table style='border: black 0.5px solid;border-collapse: collapse;' cellpadding='0' cellspacing='0'  Width='100%px'><tr><td class='cols_' >");
            ...
            sbRecorords.Append("<td class='cols_' width='120px' style='border:thin;border-collapse: collapse;'>FEBRUARY</td>");
            sbRecorords.Append("<td class='cols_' width='120px' style='border:thin;border-collapse: collapse;'>MARCH</td>");
    ...
    private System.Text.StringBuilder GenerageQuarterlyReport()
    {
        ...
        if (dtRegions.Rows.Count > 0)
        {
            ...
            sbRecorords.Append("<td class='cols_' width='120px' style='border:thin'>Q2</td>");
    ...
    private System.Text.StringBuilder GenerageAnnaulyReport()
    {
        ...
        if (dtRegions.Rows.Count > 0)
        {
            ...
            sbRecorords.Append("<td align='left' style='font-size:9pt;' colspan='1'><b>Sonic Automotive</b></td>");
            sbRecorords.Append("<td align='center' style='font-size:9pt;' colspan='4' ><b> EHS INSPECTION - ANNUAL REPORT FOR " + drpYear.SelectedValue + " </b></td>");
