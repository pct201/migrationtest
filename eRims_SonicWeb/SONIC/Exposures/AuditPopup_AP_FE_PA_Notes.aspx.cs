...
public partial class SONIC_Exposures_AuditPopup_AP_FE_PA_Notes : System.Web.UI.Page
{
    #region Property
    ...
    private void BindAP_FE_Notes_Audit()
    {
        ...
        lbltable_Name.Text = "Fraud Event Partnership Assignments Notes Audit Trail";
        // Fill grid with audit table
        dt = Audit_Trail.GetAP_FE_PA_Notes_Audit(PK_AP_FE_PA_Notes).Tables[0];
