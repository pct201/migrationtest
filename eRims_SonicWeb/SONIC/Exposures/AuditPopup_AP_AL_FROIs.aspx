<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_AP_AL_FROIs.aspx.cs"
    Inherits="AuditPopup_AP_AL_FROIs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>eRIMS Sonic :: Auto Liability FROIs Audit Trail</title>
...
<body>
    ...
    <div>
        <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 1500px;" id="divAP_AL_FROIs_Audit_Header" runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 6747px; border-collapse: collapse;">
                            <tbody>
                    ...
                    <div style="overflow-y: scroll; width: 6747px; height: 425px;" id="divAP_AL_FROIs_Audit_Grid"
                        runat="server">
                        <asp:GridView ID="gvAP_AL_FROIs_Audit" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Incident Number">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblIncident_Number" runat="server" Text='<%#Eval("AL_FR_Number")%>'
                                ...
                                <asp:TemplateField HeaderText="Item_Status">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblItem_Status" runat="server" Text='<%#Eval("Item_Status")%>' Width="100px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
