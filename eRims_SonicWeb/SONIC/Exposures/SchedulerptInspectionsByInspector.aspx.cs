...
public partial class SONIC_Exposures_SchedulerptInspectionsByInspector : System.Web.UI.Page
{
    #region "Page Events"
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            clsTatva_rptInspectionsByInspectorSchedule obj = new clsTatva_rptInspectionsByInspectorSchedule();
