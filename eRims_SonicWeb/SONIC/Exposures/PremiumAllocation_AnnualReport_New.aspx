<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="PremiumAllocation_AnnualReport_New.aspx.cs" Inherits="SONIC_Exposures_PremiumAllocation_AnnualReport_New" %>
...
<script type="text/javascript" language="javascript" src="../../JavaScript/Validator.js"></script>
 ...
 <script type="text/javascript">
     function valueSave(mon) {
         var retVal = true;
         retVal = confirm("Regenerating the Premium Allocation table will erase and automatically incorporate any new locations added and will not include any locations closed since the Premium Allocation report was last run for "+ mon +"");
         if (retVal == true)
             __doPostBack(document.getElementById('<%=btnShowReport.ClientID%>').name, "UpdateDetails"); 
...
<table width="100%" cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td align="left" class="ghc" colspan="2">
               Premium Allocation Annual Report
            </td>
        </tr>
        <tr>
