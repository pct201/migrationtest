...
public partial class COIReports_rptEarlyWarningRecipients : clsBasePage
{
    #region " Page Events "
    ...
    private System.Text.StringBuilder GenerateReport()
    {
        ...
        Ds = Report.getrptEarlyAlertRecipients(strRegion, strMarket, strLocation);
        ...
        if (Ds != null && Ds.Tables[0].Rows.Count > 0)
        {
            ...
            sbRecorords.Append("<td align='left' style='font-size:9pt'  colspan='5'>Early Alert Recipients Report: " + DateTime.Now.ToString("MMMM dd, yyyy") + "</td></tr>");
            ...
            sbRecorords.Append("<tr align='left'  style='font-weight: bold;background-color:#7f7f7f;color:White;font-size:8.5pt'><td align='left' style='font-size:9pt'  colspan='5'><b> Filter(s) :  </b></td></tr>");
            sbRecorords.Append("<tr align='left'  style='font-weight: bold;background-color:#7f7f7f;color:White;font-size:8.5pt'><td align='left' style='font-size:9pt'  colspan='5'><b>Regions(s): " + strRegion + "</b></td></tr>");
            sbRecorords.Append("<tr align='left'  style='font-weight: bold;background-color:#7f7f7f;color:White;font-size:8.5pt'><td align='left' style='font-size:9pt'  colspan='5'><b>Market(s): " + strMaketText + "</b></td></tr>");
            sbRecorords.Append("<tr align='left'  style='font-weight: bold;background-color:#7f7f7f;color:White;font-size:8.5pt'><td align='left' style='font-size:9pt'  colspan='5'><b>Location(s): " + strLocationText + "</b></td></tr>");
            ...
            #region " Header TR "
            sbRecorords.Append("<tr align='left'  style='font-weight: bold;background-color:#7f7f7f;color:White;font-size:8.5pt'>");
            sbRecorords.Append("<td class='cols_' width='32%'>Region/Location</td>");
            sbRecorords.Append("<td class='cols_' width='20%'>Job Title</td>");
            sbRecorords.Append("<td class='cols_' colspan='2' width='23%'align='left'>Name</td>");
            sbRecorords.Append("<td class='cols_' width='25%'align='left'>E-Mail</td>");
            sbRecorords.Append("</tr>"); 
            #endregion
            //now data
            ...
            for (int i = 0; i < Ds.Tables[0].Rows.Count; i++)
            {
                ...
                if (i == 0 || Convert.ToString(Ds.Tables[0].Rows[i]["Region"]) != strTempRegion)
                {
                    ...
                    sbRecorords.Append("<td colspan='5' align='left' style='font-size:9pt' ><b>Region:</b>" + strTempRegion + "</td></tr>"); 
                    #endregion
                }

                if (i==0 || Convert.ToString(Ds.Tables[0].Rows[i]["dba"]) != strTempLocation)
                {
                    strTempLocation = Convert.ToString(Ds.Tables[0].Rows[i]["dba"]);
                    #region " Location TR "
                    sbRecorords.Append("<tr align='left' style='font-size:8pt;background-color:#EAEAEA;font-family:Tahoma;'>");
                    sbRecorords.Append("<td colspan='5' align='left' style='font-size:9pt' ><b>Location:</b>" + strTempLocation + "</td></tr>"); 
                    #endregion
                }

                #region " Data TR "
                sbRecorords.Append(strTempTR);
                sbRecorords.Append("<td></td><td colspan='2' align='left' style='font-size:9pt' >" + Convert.ToString(Ds.Tables[0].Rows[i]["Job_Title"]) + "</td>");
                sbRecorords.Append("<td align='left' style='font-size:9pt' >" + Convert.ToString(Ds.Tables[0].Rows[i]["NAME"]) + "</td>");
                sbRecorords.Append("<td align='left' style='font-size:9pt' >" + Convert.ToString(Ds.Tables[0].Rows[i]["Email"]) + "</td></tr>"); 
                #endregion
