...
public partial class SONIC_Exposures_AuditPopup_Property_Assessment : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                // show Case Grid 
                dvGrid.Visible = true;
                lbltable_Name.Text = "Property_Assessment";

                // Fill grid with audit table
                dt = AuditTrail.GetProperty_Assessment_AuditTrail(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
                gvPropertyAssessment.DataSource = dt;
                gvPropertyAssessment.DataBind();
