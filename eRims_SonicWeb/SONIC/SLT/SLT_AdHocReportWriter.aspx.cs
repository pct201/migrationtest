...
public partial class SLT_AdHocReportWriter : clsBasePage
{
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(strFilePath))
        {
            try
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "SLT Ad-Hoc Report.xls"));
    ...
    protected void lnkSendEmail_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(strFilePath))
        {
            if (clsGeneral.SendAdHocReport("Ad Hoc Report", strFilePath, "SLT Ad-Hoc Report.xls", Convert.ToDecimal(ddlRecipientList.SelectedItem.Value)))
