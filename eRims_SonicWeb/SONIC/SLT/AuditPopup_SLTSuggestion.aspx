<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_SLTSuggestion.aspx.cs" Inherits="SONIC_SLT_AuditPopup_SLTSuggestion" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: SLT Suggestion Audit Trail</title>
</head>
...
<body>
    ...
    <table width="100%" align="left">
        ...
        <tr>
            <td colspan="2">
                <div style="overflow: hidden; width: 675px;" id="divSLTSuggestionHeader" runat="server">
                    <table cellpadding="4" cellspacing="0" style="width: 625px; border-collapse: collapse;">
                        <tbody>
                            <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                ...
                                <th class="cols">
                                    <span style="display: inline-block; width: 200px;">PK_SLT_Suggestion</span>
                                </th>
                                <th class="cols">
                                    <span style="display: inline-block; width: 100px;">Suggestion Source</span>
                                </th>
                                <th class="cols">
                                    <span style="display: inline-block; width: 100px;">Importance</span>
                                </th>
                                <th class="cols">
                                    <span style="display: inline-block; width: 300px;">Sugges Desc</span>
                                </th>
                                <th class="cols">
                                ...
                                <th class="cols">
                                    <span style="display: inline-block; width: 100px;">Item_Status</span>
                                </th>
                                <th class="cols">
                ...
                <div style="overflow: scroll; width: 625px; height: 425px;" id="divSLTSuggestion_Grid"
                    runat="server">
                    <asp:GridView ID="gvSIUtilityProvider" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="PK_SLT_Suggestion">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblPK_SLT_Suggestion" runat="server" Text='<%#Eval("PK_SLT_Suggestion")%>'
                                        Width="200px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="FK_LU_Suggestion_Source">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblFK_LU_Suggestion_Source" runat="server" Text='<%#Eval("FK_LU_Suggestion_Source")%>'
                                        Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Suggestion_Description">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblSuggestion_Description" runat="server" Text='<%#Eval("Suggestion_Description")%>'
