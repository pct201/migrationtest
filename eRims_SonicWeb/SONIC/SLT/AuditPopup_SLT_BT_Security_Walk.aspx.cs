...
public partial class SONIC_SLT_AuditPopup_SLTBTSecurityWalk : clsBasePage
{
    # region " Properties "
    ...
    private void BindSLTMeeting_Audit()
    {
        ...
        lbltable_Name.Text = "SLT BT Security Walk";
        // Fill grid with audit table
        dt = AuditTrail.GetSLT_BT_Security_Walk_AuditTrial(PK).Tables[0];
