<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="SonicUTraining_AdHocReportWriter.aspx.cs" Inherits="SONIC_SLT_SonicUTraining_AdHocReportWriter" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OPenSchedulePopup() {
            ...
            if (Page_ClientValidate('vsErrorGroup'))
                GB_showCenter('Schedule Ad Hoc Report Writer', '<%=AppConfig.SiteURL%>SONIC/SLT/SchedulerptSonicUTraining_AdHocReport.aspx?PKID=' + PK_Schedule + "&RID=" + hdnPK_Adhoc, 300, 500, '');
            else {
