<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_SLTSafetyWalk.aspx.cs"
    Inherits="SONIC_SLT_AuditPopup_SLTSafetyWalk" %>
            ...
            <td colspan="2">
                    ...
                    <table cellpadding="4" cellspacing="0" style="width: 625px; border-collapse: collapse;">
                        <tbody>
                            <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                align="left">
                                <th class="cols">
                                    <span style="display: inline-block; width: 100px;">Safety Walk Comp</span>
                                </th>
                                <th class="cols">
                                    <span style="display: inline-block; width: 100px;">Safety Walk Comp Date</span>
                                </th>
                                <th class="cols">
                ...
                <div style="overflow: scroll; width: 625px; height: 425px;" id="divSLTMeeting_Grid"
                    ...
                    <asp:GridView ID="gvSIUtilityProvider" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Safety_Walk_Comp">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblSafety_Walk_Comp" runat="server" Text='<%# Eval("Safety_Walk_Comp")%>'
                                        Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Safety_Walk_Comp_Date">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblSafety_Walk_Comp_Date" runat="server" Text='<%#Eval("Safety_Walk_Comp_Date") != DBNull.Value ? clsGeneral.FormatDateToDisplay(Convert.ToDateTime(Eval("Safety_Walk_Comp_Date"))) : ""%>'
                                        Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
