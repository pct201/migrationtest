<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Safety_Walk_Participant_Popup.aspx.cs" Inherits="SONIC_SLT_Safety_Walk_Participant_Popup" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Safety Walk Members</title>
    <script type="text/javascript">
        function Save_Record()
        {            
            window.opener.AskfForLogoff = false;
            window.opener.document.getElementById('ctl00_ContentPlaceHolder1_btnReload_Participant').click();
            self.close();            
        }
    </script>
...
<body>
    ...
    <div>
        ...
        <table width="100%" cellpadding="2" cellspacing="2">
            <tr>
                <td class="ghc">Safety Walk Members</td>
            </tr>
            <tr>
                <td>
