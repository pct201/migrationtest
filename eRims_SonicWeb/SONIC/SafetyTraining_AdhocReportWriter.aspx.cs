...
public partial class SONIC_DealershipDetails_AdhocReportWriter : clsBasePage
{
    ...
    protected void lnkSendEmail_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(strFilePath))
        {
            if (clsGeneral.SendAdHocReport("Safety Training Ad Hoc Report", strFilePath, "Safety Training Ad-Hoc Report.xls", Convert.ToDecimal(ddlRecipientList.SelectedItem.Value)))
    ...
    {
        DataTable dtAdHocReport = DealershipDetails_AdHocReport.ExistsReportName(txtReportName.Text, (ddlReports.SelectedIndex > 0) ? Convert.ToDecimal(ddlReports.SelectedValue) : 0);
    ...
    protected void btnDeleteReport_Click(object sender, EventArgs e)
    {
        if (ddlReports.SelectedIndex > 0)
        {
            ...
            DealershipDetails_AdHocReport.DeleteByPK(Convert.ToDecimal(ddlReports.SelectedItem.Value));
            hdnReportId.Value = "0";
            txtReportName.Text = "";
            SetDefaults();
            ClearAllFilterPanel();
    ...
    protected void ddlReports_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlReports.SelectedIndex > 0)
        {
            // Set Report PK
            _dcSelectedReport = 0;
            List<AdHocFilterDealershipDetails> lstFilter = new List<AdHocFilterDealershipDetails>();

            _dcSelectedReport = Convert.ToDecimal(ddlReports.SelectedItem.Value);
            lstFilter = new AdHocFilterDealershipDetails().GetAdHocReportFieldByPk(_dcSelectedReport.Value);

            DealershipDetails_AdHocReport ObjAdHocReport = new DealershipDetails_AdHocReport(_dcSelectedReport.Value);
    ...
    /// <returns></returns>
    private int SearchList(decimal decValue, List<DealershipDetails_AdHocReportFields> lstSearch)
    {
        int i;
    ...
    private void BindReportNameDropDown()
    {
        ...
        DataTable dtReprot = DealershipDetails_AdHocReport.SelectReportName().Tables[0];
    ...
    protected string drpFilterChange(DropDownList drpFilter, Panel pnlText_F, Panel pnlAmoun_F, Panel pnlDate_F, ListBox lst_F)
    {
        ...
        List<DealershipDetails_AdHocReportFields> lstAdHoc = null;

        if (decSelectedValue > 0)
            lstAdHoc = new DealershipDetails_AdHocReportFields().GetAdHocReportFieldByPk(decSelectedValue);
        ...
        if (lstAdHoc != null && lstAdHoc.Count > 0)
        {
            switch (lstAdHoc[0].Fk_ControlType.Value)
            {
                ...
                case (int)AdHocReportHelper.AdHocControlType.MultiSelectTextList:
                    if (Convert.ToString(lstAdHoc[0].Field_Header).ToLower().Trim() == "region")
                    {
                        ComboHelper.FillRegionListBox(new ListBox[] { lst_F }, false);
                    }
                    else if (Convert.ToString(lstAdHoc[0].Field_Header).Trim() == "Learning Program Status Description")
                    {
                        ComboHelper.LearningProgramingStatusDescription(lst_F );
                    }          
                    else
                    {
                        AdHocReportHelper.FillFilterDropDown(lstAdHoc[0].Field_Header, new ListBox[] { lst_F }, false, "Safety Training");
                    }
                    pnlText_F.Visible = false;
                    pnlAmoun_F.Visible = false;
                    pnlDate_F.Visible = false;
    ...
    private void BindFilterCombo()
    {
        for (int intI = 1; intI <= 10; intI++)
        {
            ...
            if (drpFilter != null)
            {
                ...
                drpFilter.DataSource = DealershipDetails_AdHocReportFields.GetAdHocFilterFields("F");
    ...
    private void BindOutpuFields()
    {
        ...
        lstOutputFields.DataSource = DealershipDetails_AdHocReportFields.GetAdHocFilterFields("O");
    ...
    private string BindReport(ref StringBuilder sbRecord, ReportOutputType ReportType)
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(strCriteria))
                lstAdhoc = new DealershipDetails_AdHocReportFields().GetAdHocReportFieldByMultipleID(strCriteria);
            ...
            if (drpFilter1.SelectedIndex > 0)
            {
                ...
                {
                    // It takes Filed Header when Field Header is Program Completion Date
                    if (lstAdhoc[iSelected].Field_Header == "Program Completion Date" || lstAdhoc[iSelected].Field_Header == "Enrollment Date")
            ...
            if (drpFilter3.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F3.Text, txtAmount2_F3.Text, drpAmount_F3.SelectedItem.Value);
                }
            }
            if (drpFilter4.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F4.Text, txtAmount2_F4.Text, drpAmount_F4.SelectedItem.Value);
                }
            }
            if (drpFilter5.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F5.Text, txtAmount2_F5.Text, drpAmount_F5.SelectedItem.Value);
                }
            }
            if (drpFilter6.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F6.Text, txtAmount2_F6.Text, drpAmount_F6.SelectedItem.Value);
                }
            }
            if (drpFilter7.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F7.Text, txtAmount2_F7.Text, drpAmount_F7.SelectedItem.Value);
                }
            }
            if (drpFilter8.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F8.Text, txtAmount2_F8.Text, drpAmount_F8.SelectedItem.Value);
                }
            }
            if (drpFilter9.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F9.Text, txtAmount2_F9.Text, drpAmount_F9.SelectedItem.Value);
                }
            }
            if (drpFilter10.SelectedIndex > 0)
            {
                ...
                {
                    strWhere += GetDateAmountCondtion("[" + lstAdhoc[iSelected].Table_Name + "]." + lstAdhoc[iSelected].Field_Name, txtAmount1_F10.Text, txtAmount2_F10.Text, drpAmount_F10.SelectedItem.Value);
                }
            }
            ...
            Reader = AdHocReportHelper.GetAdHocReportDealershipDetails(GetAllItemString(lstSelectedFields, false), strGroupBy, strWhere, strOrderBy, strFilterIds, Convert.ToDecimal(clsSession.UserID));
            ...
            if (Reader.Read())
            {
                ...
                {
                    sbRecord.Append("<br />");
                    sbRecord.Append("<b>Report Title : DealershipDetails Ad-Hoc Report </b>");
    ...
    {
        DealershipDetails_AdHocReport objAdHocReport = new DealershipDetails_AdHocReport();
        ...
        {
            // Delete 
            AdHocFilterDealershipDetails.DeleteByFk_AdHocReport(Pk_AdHocReport);

            string strCriteria = string.Empty;
            strCriteria = GetFilterIDs(new DropDownList[] { drpFilter1, drpFilter2, drpFilter3, drpFilter4, drpFilter5, drpFilter6, drpFilter7, drpFilter8, drpFilter9, drpFilter10, });
            List<DealershipDetails_AdHocReportFields> lstAdhoc = new List<DealershipDetails_AdHocReportFields>();
    ...
    {
        AdHocFilterDealershipDetails objFilter = new AdHocFilterDealershipDetails();
    ...
    /// <param name="drpFilter"></param>
    private void LoadFilterCriteria(AdHocFilterDealershipDetails objFilter, DropDownList drpFilter)
    {
        ListItem liSelected;
    ...
    {
        lst_F.Items.Clear();
        if (Convert.ToString(Field_Header).ToLower().Trim() == "region")
        {
            ComboHelper.FillRegionListBox(new ListBox[] { lst_F }, false);
        }
        ...
        {
            AdHocReportHelper.FillFilterDropDown(Field_Header, new ListBox[] { lst_F }, false, "DealershipDetails");
        }
    ...
    /// </summary>
    private void LoadFilterControlAmount(AdHocFilterDealershipDetails objFilter, Panel pnlAmount_F, DropDownList drpAmount_F, TextBox txtAmount1_F, TextBox txtAmount2_F, Label lblAmountText1_F, Label lblAmountText2_F, CompareValidator cvAmount)
    {
    ...
    private string GenerateFilterCriteria()
    {
        ...
        strExport.Append("<tr>");
        strExport.Append("<td colspan='4'><b>Report Title : Safety Training Ad-Hoc Report</b></td>");
        strExport.Append("</tr>");
        strExport.Append("<tr><td>&nbsp;</td></tr>");
        if (drpGroupByFirst.SelectedIndex > 0)
        ...
        strExport.Append("<tr><td ></td></tr>");
        if (drpSortingFirst.SelectedIndex > 0)
            strExport.Append("<tr><td nowrap='nowrap' colspan='4'><b> First Level Sort By : </b>" + Convert.ToString(drpSortingFirst.SelectedItem.Text) + " <b>Sorting :</b> " + Convert.ToString(rdbSort1.SelectedItem.Text).ToUpper() + " </td></tr>");
        else
            strExport.Append("<tr><td ><b> First Level Sort By : </b> &nbsp; </td></tr>");

        if (drpSortingSecond.SelectedIndex > 0)
            strExport.Append("<tr><td nowrap='nowrap' colspan='4'><b> Second Level Sort By : </b>" + Convert.ToString(drpSortingSecond.SelectedItem.Text) + " <b>Sorting :</b> " + Convert.ToString(rdbSort2.SelectedItem.Text).ToUpper() + " </td></tr>");
        else
            strExport.Append("<tr><td ><b> Second Level Sort By : </b> &nbsp; </td></tr>");

        if (drpSortingThird.SelectedIndex > 0)
            strExport.Append("<tr><td nowrap='nowrap' colspan='4'><b> Third Level Sort By : </b>" + Convert.ToString(drpSortingThird.SelectedItem.Text) + " <b>Sorting :</b> " + Convert.ToString(rdbSort3.SelectedItem.Text).ToUpper() + " </td></tr>");
        else
    ...
    {
        List<ERIMS.DAL.DealershipDetails_AdHocReportFields> lstAdhoc = null;
        decimal decValue;
        int iSelected;
        string strWhere = string.Empty, strFilterIds = string.Empty, strGroupBy = string.Empty, strOrderBy = string.Empty, strCriteria = string.Empty, strPath = string.Empty;
        ...
        if (!string.IsNullOrEmpty(strCriteria))
            lstAdhoc = new ERIMS.DAL.DealershipDetails_AdHocReportFields().GetAdHocReportFieldByMultipleID(strCriteria);
