<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="CRM_Customer_Complaint_Notes.aspx.cs" Inherits="SONIC_CRM_CRM_Customer_Complaint_Notes"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_CRM_Customer_Notes.aspx?id=" + '<%=ViewState["PK_CRM_Notes"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td class="ghc" align="left">
                Customer Information – Incident Grid
            </td>
        </tr>
        <tr>
            <td>
                                            ...
                                            <asp:Panel ID="pnl1" runat="server" Style="display: none;">
                                                                ...
                                                                <asp:GridView ID="gvNotes" runat="server" AutoGenerateColumns="false" Width="100%"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Date" ItemStyle-Width="12%" HeaderStyle-HorizontalAlign="Left">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkDate" runat="server" CommandName="Edit" CommandArgument='<%#Eval("PK_CRM_Notes") %>'
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="left" width="78%" colspan="4" valign="top">
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Description of Incident&nbsp;<span id="Span2" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" colspan="4" valign="top">
                                                            <uc:ctrlMultiLineTextBox ID="txtNotes" runat="server" RequiredFieldMessage="Please Enter Description of Incident"
                                                        ...
                                                        <td style="width: 100%">
                                                            <div id="divgvComplaintView" runat="server" style="overflow-x: hidden; overflow-y: scroll;
                                                                ...
                                                                <asp:GridView ID="gvNotesView" runat="server" AutoGenerateColumns="false" Width="100%"
                                                                    EnableViewState="true" OnRowCommand="gvNotesView_RowCommand" OnRowEditing="gvNotesView_RowEditing">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Date" ItemStyle-Width="12%" HeaderStyle-HorizontalAlign="Left">
                                                                            <ItemTemplate>
