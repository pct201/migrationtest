...
using ERIMS.DAL;
public partial class SONIC_CRM_AuditPopup_CRM_NonCustomer_Notes : clsBasePage
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                if (strType == "res")
                {
                    SpNotesTitle.InnerHtml = "Resolution";
                    lbltable_Name.Text = "CRM Non Customer Resolution Audit";
                    Page.Title = "Risk Insurance Management System :: CRM Non Customer Resolution Audit";
                }
                else
                {
                    SpNotesTitle.InnerHtml = "Notes";
                    lbltable_Name.Text = "CRM Non Customer Notes Audit";
                    Page.Title = "Risk Insurance Management System :: CRM Non Customer Notes Audit";
                }
