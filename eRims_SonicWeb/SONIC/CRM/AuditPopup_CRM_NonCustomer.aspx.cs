...
public partial class SONIC_CRM_AuditPopup_CRM_NonCustomer : clsBasePage
{
    # region " Properties "
    ...
    private void BindNonCustomer_Audit()
    {
        ...
        lbltable_Name.Text = "CRM Non Customer";
        // Fill grid with audit table
        dt = AuditTrail.GetCRM_Non_Customer_AuditTrial(PK).Tables[0];
