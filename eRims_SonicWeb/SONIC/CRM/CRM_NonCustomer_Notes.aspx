<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="CRM_NonCustomer_Notes.aspx.cs" Inherits="SONIC_CRM_CRM_NonCustomer_Notes"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_CRM_NonCustomer_Notes.aspx?id=" + '<%=ViewState["PK_CRM_Notes"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Notes &nbsp;<span id="MenuAsterisk1" runat="server"
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4" valign="top">
                                                            <uc:ctrlMultiLineTextBox ID="txtNotes" runat="server" RequiredFieldMessage="Please Enter Notes"
