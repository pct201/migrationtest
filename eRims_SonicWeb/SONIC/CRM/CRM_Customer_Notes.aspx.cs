...
public partial class SONIC_CRM_CRM_Customer_Notes : clsBasePage
{
    #region Properties
    /// <summary>
    ...
    {
        DataSet dsResult = CRM_Notes.SelectByFK_CRM(FK_Table_Name, clsGeneral.CRM_Tables.CRM_Customer, Convert.ToDecimal(clsGeneral.CRM_Note_Type.CRM_Customer_Notes));
        ...
        else
        {
            ...
            divgvFieldNotes.Style["height"] = "50px";
        }
    }
    ...
    private void SaveData()
    {
        ...
        objNotes.FK_LU_CRM_Note_Type = Convert.ToDecimal(clsGeneral.CRM_Note_Type.CRM_Customer_Notes);
    ...
    {
        StrOperation = "edit";
        Response.Redirect("CRM_Customer_Notes.aspx?pid=" + Encryption.Encrypt(Convert.ToString(FK_Table_Name)) + "&id=" + Encryption.Encrypt(Convert.ToString(PK_CRM_Notes)) + "&mode=" + StrOperation, true);
    }
    ...
    /// <summary>
    /// Handles Export To Excel click Event
    /// </summary>
    /// <param name="sender"></param>
    protected void ExportToExcel_btnHandler(object sender)
    {
        ...
        sbRecorords.Append("<td class='cols_' width='60%'>Description of Field Notes</td>");
        ...
        lblNotesHTML.Text = sbRecorords.ToString();
    ...
    #region "Grid Event"
    /// <summary>
    /// handle Notes row command event of Notes Grid (for remove and edit)
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void gvNotes_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Remove")
        {
            ...
            gvNotes.DataSource = CRM_Notes.SelectByFK_CRM(FK_Table_Name, clsGeneral.CRM_Tables.CRM_Customer, Convert.ToDecimal(clsGeneral.CRM_Note_Type.CRM_Customer_Notes));
            gvNotes.DataBind();
            // Show Panel
            Page.ClientScript.RegisterStartupScript(Page.GetType(), DateTime.Now.ToString(), "javascript:ShowPanel(1);", true);
            txtNotes.Text = "";
    ...
    /// <summary>
    /// NotesView Grid Row command event
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    ...
    private void SetValidations()
    {
        ...
        MenuAsterisk1.Style["display"] = (dtFields.Select("PK_Screen_Validator in (1395, 1396)").Length > 0) ? "inline-block" : "none";
        ...
        foreach (DataRow drField in dtFields.Rows)
        {
            ...
            {
                case "Field Notes Grid - Date of Note":
                    strCtrlsIDs += txtNotesDate.ClientID + ",";
                    strMessages += "Please enter Date of Note" + ",";
                    Span1.Style["display"] = "inline-block";
                    break;
                case "Field Notes Grid - Description of Field Notes":
                    strCtrlsIDs += txtNotes.ClientID + ",";
                    strMessages += "Please enter Description of Field Notes" + ",";
