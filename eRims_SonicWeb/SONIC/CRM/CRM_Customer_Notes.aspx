<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="CRM_Customer_Notes.aspx.cs" Inherits="SONIC_CRM_CRM_Customer_Notes"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_CRM_Customer_Notes.aspx?id=" + '<%=ViewState["PK_CRM_Notes"]%>' + '&type=field', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Description
                                            of Field Notes &nbsp;<span id="MenuAsterisk1" runat="server" style="color: Red;display:none;">*</span></span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                    ...
                                    <td class="dvContainer">
                                                        ...
                                                        <td style="width: 100%">
                                                            <div id="divgvFieldNotes" runat="server" style="overflow-x: hidden; overflow-y: scroll;
                                                                ...
                                                                <asp:GridView ID="gvNotes" runat="server" AutoGenerateColumns="false" Width="100%"
                                                                    EnableViewState="true" OnRowCommand="gvNotes_RowCommand">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Note Abstract" ItemStyle-Width="75%" HeaderStyle-HorizontalAlign="Left">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblNotes" runat="server" Text='<%#Eval("Note")%>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Description of Field Notes&nbsp;<span id="Span2" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" colspan="4" valign="top">
                                                            <uc:ctrlMultiLineTextBox ID="txtNotes" runat="server" RequiredFieldMessage="Please Enter Description of Field Notes "
                                                                ValidationGroup="vsErrorGroup" IsRequired="false" ShowExportToExcelButton="true"
                                                                OnbtnHandler="ExportToExcel_btnHandler" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                                        ...
                                        <div id="dvView" runat="server" width="794px">
                                            <asp:Panel ID="pnl1View" runat="server" Style="display: none;">
                                                <div class="bandHeaderRow">
                                                    Description of Field Notes</div>
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr valign="top" align="left">
                                                        <td style="width: 100%">
                                                            <div id="divgvFieldNotesView" runat="server" style="overflow-x: hidden; overflow-y: scroll;
                                                                ...
                                                                <asp:GridView ID="gvNotesView" runat="server" AutoGenerateColumns="false" Width="100%"
                                                                    EnableViewState="true" OnRowCommand="gvNotesView_RowCommand">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Date" ItemStyle-Width="12%" HeaderStyle-HorizontalAlign="Left">
                                                                            <ItemTemplate>
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4" valign="top">
                                                            <uc:ctrlMultiLineTextBox ID="lblNotes" runat="server" ControlType="Label" ShowExportToExcelButton="true"
                                                                OnbtnHandler="ExportToExcel_btnHandler" />
                                                        </td>
                                                    </tr>
                                                </table>
                                ...
                                <table cellpadding="5" cellspacing="5" border="0" width="100%">
                                    <tr>
                                        <td width="100%" align="center">
                                            ...
                                            <asp:Button ID="btnNext" runat="server" Text="Back" OnClick="btnNext_Click" CausesValidation="false" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
