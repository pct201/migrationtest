<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="CRM_Customer_Resolution_Notes.aspx.cs" Inherits="SONIC_CRM_CRM_Customer_Resolution_Notes"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_CRM_Customer_Notes.aspx?id=" + '<%=ViewState["PK_CRM_Notes"]%>&type=res', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Field Resolution
                                    ...
                                    <td class="dvContainer">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Field Resolution Information&nbsp;<span id="Span2" style="color: Red; display: none;" runat="server">*</span>
                                                        </td>
                                                        <td align="center" valign="top">
                                                            :
                                                        </td>
                                                        <td align="left" colspan="4" valign="top">
                                                            <uc:ctrlMultiLineTextBox ID="txtNotes" runat="server" RequiredFieldMessage="Please Enter Field Resolution Information"
                                        ...
                                        <div id="dvView" runat="server" width="794px">
                                            <asp:Panel ID="pnl1View" runat="server" Style="display: none;">
                                                <div class="bandHeaderRow">
                                                    Field Resolution Information</div>
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr valign="top" align="left">
                                                        <td style="width: 100%">
                                                            <div id="divgvResolutionView" runat="server" style="overflow-x: hidden; overflow-y: scroll;
                                                                ...
                                                                <asp:GridView ID="gvResolutionView" runat="server" AutoGenerateColumns="false" Width="100%"
                                                                    EnableViewState="true" OnRowCommand="gvResolutionView_RowCommand">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Date" ItemStyle-Width="12%" HeaderStyle-HorizontalAlign="Left">
                                                                            <ItemTemplate>
