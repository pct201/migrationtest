<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_CRM_Customer_Notes.aspx.cs" Inherits="SONIC_CRM_AuditPopup_CRM_Customer_Notes" %>
                    ...
                    <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;"
                        ...
                        <tbody>
                            <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                ...
                                <th class="cols">
                                    <span style="display: inline-block; width: 350px;" id="SpNotesTitle" runat="server">Description of Complaint</span>
                                </th>
                                <th class="cols">
