                ...
                <div style="overflow: scroll; width: 600px; height: 500px;" id="divNonCustomer_Grid"
                    ...
                    <asp:GridView ID="gvNonCustomer" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="First Name Co-Buyer or Caller">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="lblFirst_Name_Co_Buyer" runat="server" Text='<%#Eval("First_Name_Co_Buyer")%>' Width="120px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
