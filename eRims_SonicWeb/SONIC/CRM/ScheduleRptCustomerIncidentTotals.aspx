<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleRptCustomerIncidentTotals.aspx.cs" Inherits="SONIC_CRM_ScheduleRptCustomerIncidentTotals" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Customer Relationship Incident Totals by Dealership</title>
</head>
<body>  
                ...
                <table border="0" cellpadding="5" cellspacing="1" width="100%">
                    <tr>
                        ...
                        <td align="left" width="70%">
                            ...
                            <img alt="Time Period Begin Date" onclick="return showCalendar('txtBeginDate', 'mm/dd/y');"
                            onmouseover="javascript:this.style.cursor='hand';" src="../../Images/iconPicDate.gif" align="middle" />
                            <asp:RegularExpressionValidator ID="revBeginDate" runat="server" 
                            ...
                            <asp:RequiredFieldValidator ID="rfvBeginDate" runat="server" ControlToValidate="txtBeginDate" Display="None" ErrorMessage="Please enter Time Period Begin Date"  SetFocusOnError="true" />
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top" width="28%">
                        ...
                        <td align="left" width="70%">
                            ...
                            <img alt="Time Period End Date" onclick="return showCalendar('txtEndDate', 'mm/dd/y');"
                            onmouseover="javascript:this.style.cursor='hand';" src="../../Images/iconPicDate.gif"
                            align="middle" />
                            <asp:RegularExpressionValidator ID="revEndDate" runat="server" 
                            ...
                            SetFocusOnError="true" Type="Date" Operator="GreaterThanEqual" Display="None"  />
                            <asp:RequiredFieldValidator ID="rfvEndDate" runat="server" ControlToValidate="txtEndDate" Display="None" ErrorMessage="Please enter Time Period End Date"  SetFocusOnError="true" />
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top" width="28%">
