...
public partial class SONIC_RealEstate_RentProjectionTRS : clsBasePage
{
    #region "Properties"
    ...
    private decimal _PK_RE_Rent_Projctions_TRS
    {
        get
        {
            return clsGeneral.GetInt(ViewState["PK_RE_Rent_Projctions_TRS"]);
        }
        set { ViewState["PK_RE_Rent_Projctions_TRS"] = value; }
    }
    ...
    private decimal _FK_RE_Rent_Projections
    {
        get
        {
            return clsGeneral.GetInt(ViewState["FK_RE_Rent_Projections"]);
        }
        set { ViewState["FK_RE_Rent_Projections"] = value; }
    }
    ...
    private void BindControls()
    {
        try
        {
            _FK_RE_Rent_Projections = Convert.ToInt32(new RE_Rent_Projections(clsSession.Current_RE_Information_ID, true).PK_RE_Rent_Projections);
            if (_PK_RE_Rent_Projctions_TRS > 0)
            {

                RE_Rent_Projctions_TRS objTrs = new RE_Rent_Projctions_TRS(_PK_RE_Rent_Projctions_TRS);
            ...
            {
                DataSet dsDetails = RE_Rent_Projctions_TRS.SelectYearMonthlyRentByPK(_FK_RE_Rent_Projections);
    ...
    private void setProperties(RE_Rent_Projctions_TRS objTrs)
    {
        objTrs.PK_RE_Rent_Projctions_TRS = _PK_RE_Rent_Projctions_TRS;
        objTrs.FK_RE_Rent_Projections = _FK_RE_Rent_Projections;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (IsValid)
        {
            try
            {
                RE_Rent_Projctions_TRS objTrs = new RE_Rent_Projctions_TRS();
