...
public partial class SONIC_RealEstate_AuditPopup_RE_Repair_Maint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                dt = AuditTrail.GetRE_Repair_Maintenance_AuditTrail(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
