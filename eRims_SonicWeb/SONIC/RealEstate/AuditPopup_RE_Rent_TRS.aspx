<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_RE_Rent_TRS.aspx.cs" Inherits="SONIC_RealEstate_AuditPopup_RE_Rent_TRS" %>
                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
	                                    <span style="display: inline-block;width:230px;">PK_RE_Rent_TRS</span>
                                    </th>
                                    <th class="cols">
	                                    <span style="display: inline-block;width:210px;">FK_RE_Rent</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="dvGrid" runat="server">
                        <asp:GridView ID="gvRent_Projctions_TRS" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_RE_Rent_TRS" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblPK_RE_Rent_TRS" runat="server" Text='<%#Eval("PK_RE_Rent_TRS")%>' Width="230px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="FK_RE_Rent" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblFK_RE_Rent_Projections" runat="server" Text='<%#Eval("FK_RE_Rent")%>' Width="210px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
