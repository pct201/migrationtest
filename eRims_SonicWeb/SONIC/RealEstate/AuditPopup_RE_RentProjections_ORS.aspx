<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_RE_RentProjections_ORS.aspx.cs" Inherits="SONIC_RealEstate_AuditPopup_RE_RentProjections_ORS" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>eRIMS Sonic :: RE_Rent_Projections_ORS Audit Trail</title>
</head>
            ...
            <tr>
                <td colspan="2">
                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
	                                    <span style="display: inline-block;width:250px;">PK_RE_Rent_Projections_ORS</span>
                                    </th>
                                    <th class="cols">
	                                    <span style="display: inline-block;width:200px;">FK_RE_Rent_Projections</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block;width:100px;">Option Period</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="dvGrid" runat="server">
                        <asp:GridView ID="gvRent_Projections_ORS" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_RE_Rent_Projections_ORS" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblPK_RE_Rent_Projections_ORS" runat="server" Text='<%#Eval("PK_RE_Rent_Projections_ORS")%>' Width="250px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="FK_RE_Rent_Projections" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblFK_RE_Rent_Projections" runat="server" Text='<%#Eval("FK_RE_Rent_Projections")%>' Width="200px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Option_Period" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblOption_Period" runat="server" Text='<%#Eval("Option_Period")%>' Width="100px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
