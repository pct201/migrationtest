...
public partial class SONIC_RealEstate_ScheduleRealEstateReport : clsBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        clsGeneral.SetDropDownToolTip(new ListBox[] { lstLeaseType, ddlRegion });
    }
    ...
    private void BindDropDownList()
    {
        ...
        else
        {
            ...
            if (PK_ReportID == 31)
            {
                ...
                ddlLeaseType.Visible = true;
                lstLeaseType.Visible = false;
            }
            else
            {
                //Lease Type
                ComboHelper.FillLeaseTypeListBox(new ListBox[] { lstLeaseType }, false);
                lstLeaseType.Visible = true;
                ddlLeaseType.Visible = false;
            }
        }
