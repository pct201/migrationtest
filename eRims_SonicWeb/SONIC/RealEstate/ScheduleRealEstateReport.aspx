<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleRealEstateReport.aspx.cs"
    Inherits="SONIC_RealEstate_ScheduleRealEstateReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Report Schedule</title>
</head>
        ...
        <tr>
            <td class="dvContent" align="left">
                <table cellpadding="5" cellspacing="0" border="0" align="center" style="width: 85%"
                    ...
                    <tr valign="top" align="left" runat="server" id="trLeaseType">
                        <td>
                            Lease Type
                        </td>
                        <td align="right">
                        ...
                        <td>
                            <asp:ListBox ID="lstLeaseType" runat="server" Rows="4" SelectionMode="Multiple" Width="200px">
                            </asp:ListBox>
                            <asp:DropDownList ID="ddlLeaseType" runat="server" Width="200px" Visible="false"
                                SkinID="dropGen">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr valign="top" align="left">
                        ...
                        <td style="width: 30%;">
                            <asp:TextBox ID="txtLCDateFrom" runat="server" MaxLength="10" SkinID="txtDate" Width="140px"></asp:TextBox>
                        ...
                        <td style="width: 32%;">
                            <asp:TextBox ID="txtLCDateTo" runat="server" MaxLength="10" SkinID="txtDate" Width="140px"></asp:TextBox>
                    ...
                    <tr valign="top" align="left">
                        ...
                        <td>
                            <asp:TextBox ID="txtLEDateFrom" runat="server" MaxLength="10" SkinID="txtDate" Width="140px"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtLEDateTo" runat="server" MaxLength="10" SkinID="txtDate" Width="140px"></asp:TextBox>
