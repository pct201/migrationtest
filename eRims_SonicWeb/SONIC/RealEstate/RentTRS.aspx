<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="RentTRS.aspx.cs"
    Inherits="SONIC_RealEstate_RentTRS" Title="Term Rent Schedule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      function AuditPopUp()
     {
        ...
        obj= window.open("AuditPopup_RE_Rent_TRS.aspx?id=" + '<%=ViewState["PK_RE_Rent_TRS"]%>','AuditPopUp','width=' + winWidth +',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');        
        obj.focus();
        return false;
    }
