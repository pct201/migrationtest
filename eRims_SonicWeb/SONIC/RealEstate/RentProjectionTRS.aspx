<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="RentProjectionTRS.aspx.cs"
    Inherits="SONIC_RealEstate_RentProjectionTRS" Title="Rent Projection Term Rent Schedule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      function AuditPopUp()
     {
        ...
        obj= window.open("AuditPopup_RE_RentProjetions_TRS.aspx?id=" + '<%=ViewState["PK_RE_Rent_Projctions_TRS"]%>','AuditPopUp','width=' + winWidth +',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');        
        obj.focus();
        return false;
    }
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="SubtenantTRS" class="LeftMenuSelected">Term Rent Schedule</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="dvContainer" align="center">
                            <div id="dvEdit" runat="server">
                                <div class="bandHeaderRow">
                                     Rent Projections - Term Rent Schedule</div>
                                <table width="98%" cellpadding="5" cellspacing="1" border="0" align="center">
                                    ...
                                    <tr runat="server" id="trEditDate">
                                        ...
                                        <td width="30%" align="left" valign="top">
                                            <asp:TextBox ID="txtFromDate" runat="server" MaxLength="10" SkinID="txtDate" onblur="javascript:return GetMonthDiff();"
                                        ...
                                        <td width="30%" align="left" valign="top">
                                            <asp:TextBox ID="txtToDate" runat="server" MaxLength="10" SkinID="txtDate" onblur="javascript:return GetMonthDiff();"
                                                onchange="javascript:return GetMonthDiff();"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%" align="left" valign="top">
                                            <asp:TextBox ID="txtNumberOfMonth" runat="server"  MaxLength="6" onpaste="return false" onkeypress="return FormatNumber(event,this.id,6,false);"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%" align="left" valign="top">
                                            $&nbsp;<asp:Label ID="lblAdditional" runat="server" Text="0.0"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="16%" align="left" nowrap="nowrap" valign="top">
                                        ...
                                        <td width="30%" align="left" valign="top">
                                            <asp:Label ID="lblPercentage" runat="server" Text="0.0"></asp:Label>
                                        </td>
                                        <td colspan="3">
                                        </td>
                                    </tr>
