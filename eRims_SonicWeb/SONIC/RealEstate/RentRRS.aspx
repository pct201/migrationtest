<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="RentRRS.aspx.cs"
    Inherits="SONIC_RealEstate_RentRRS" Title="Real Estate : Rent Projection Option Rent Schedule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      function AuditPopUp()
     {
        ...
        obj= window.open("AuditPopup_RE_Rent_RRS.aspx?id=" + '<%=ViewState["PK_RE_Rent_RRS"]%>','AuditPopUp','width=' + winWidth +',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');        
        obj.focus();
        return false;
    }
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="SubtenantTRS" class="LeftMenuSelected">Renewal Rent Schedule</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="dvContainer" align="center">
                            <div id="dvEdit" runat="server">
                                <div class="bandHeaderRow">
                                     Rent - Renewal Rent Schedule</div>
