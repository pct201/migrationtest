<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_RE_Subtenant_ORS.aspx.cs" Inherits="SONIC_RealEstate_AuditPopup_RE_Subtenant_ORS" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>eRIMS Sonic :: RE_Subtenant_ORS Audit Trail</title>
</head>
            ...
            <tr>
                <td colspan="2">
                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
	                                    <span style="display: inline-block;width:200px;">PK_RE_Subtenant_ORS</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="dvGrid" runat="server">
                        <asp:GridView ID="gvSubtenant_ORS" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_RE_SubTenant_ORS" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblPK_RE_SubTenant_ORS" runat="server" Text='<%#Eval("PK_RE_SubTenant_ORS")%>' Width="200px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
