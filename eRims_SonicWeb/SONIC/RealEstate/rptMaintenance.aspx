<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="rptMaintenance.aspx.cs"
    Inherits="SONIC_RealEstate_rptMaintenance" Title="eRIMS Sonic :: Maintenance and Repair Items" %>
                        ...
                        <td width="100%" align="left">
                            <div id="dvGrid" runat="server" visible="false">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <div runat="server" id="dvReport" style="text-align: left; width: 950px;">
                                                <asp:GridView ID="gvDBA" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                                                    Width="100%" EnableTheming="false" HorizontalAlign="Left" CellPadding="0" GridLines="None"
                                                                    ...
                                                                    <tr>
                                                                        <td width="100%" align="left">
                                                                            <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                                                                                ShowHeader="false" Width="100%" CellPadding="4" CellSpacing="0" EnableTheming="false"
                                                                                GridLines="None">
                                                                                <RowStyle CssClass="RowStyle" />
                                                                                <AlternatingRowStyle CssClass="AlterRowStyle" />
                                                                                <FooterStyle Font-Bold="true" ForeColor="Black" />
                                                                                <Columns>
                                                                                    <asp:TemplateField HeaderText="Lease Codes" ItemStyle-VerticalAlign="Top" ItemStyle-Width="20%"
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Location" ItemStyle-VerticalAlign="Top" ItemStyle-Width="20%"
                                                                                        FooterStyle-HorizontalAlign="Left">
                                                                                        <ItemTemplate>
                                                                                            <%# Eval("DBA") %><br />
                                                                                            <%# Eval("Address")%>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Rentable Area" ItemStyle-VerticalAlign="Top" ItemStyle-Width="20%"
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Lease Term" ItemStyle-VerticalAlign="Top" ItemStyle-Width="20%"
                                                                                        ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                                                                        <ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Total Repair Items" ItemStyle-VerticalAlign="Top"
                                                                                        ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"
                                                                                        FooterStyle-HorizontalAlign="Right">
                                                                                        <ItemTemplate>
                                                                                            <%# string.Format("{0:N0}", Eval("Items_Per_Location"))%>
                                                                                        </ItemTemplate>
                                                                                        <FooterTemplate>
