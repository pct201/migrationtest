...
public partial class SONIC_RealEstate_AuditPopup_RE_RentProjetions_TRS : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                // show Case Grid 
                dvGrid.Visible = true;
                lbltable_Name.Text = "RE_Rent_Projctions_TRS";

                // Fill grid with audit table
                dt = AuditTrail.GetRE_Rent_Projctions_TRS_AuditTrail(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
