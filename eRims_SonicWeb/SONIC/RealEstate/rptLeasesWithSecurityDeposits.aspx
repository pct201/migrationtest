<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="rptLeasesWithSecurityDeposits.aspx.cs"
 Inherits="SONIC_RealEstate_rptLeasesWithSecurityDeposits" Title="eRIMS Sonic :: Leases With Security Deposits" %>
                        ...
                        <tr>
                            <td>
                                <div runat="server" id="dvReport" style="overflow-x: hidden; overflow-y: hidden;
                                    ...
                                    <asp:GridView ID="gvDBA" runat="server" AutoGenerateColumns="false" ShowFooter="true" Width="1160px" EnableTheming="false" HorizontalAlign="Left"
                                        CellPadding="0" GridLines="None" CssClass="GridClass" EmptyDataText="No Record Found" OnRowDataBound="gvDBA_RowDataBound" OnRowCreated="gvDBA_RowCreated">
                                            ...
                                            <asp:TemplateField>
                                                        ...
                                                        <tr>
                                                            <td width="100%" align="left">
                                                                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="false" ShowFooter="true" ShowHeader="false"
                                                                    Width="1160px" CellPadding="4" CellSpacing="0" 
                                                                     EnableTheming="false" GridLines="None">
                                                                    <RowStyle CssClass="RowStyle" />
                                                                    <AlternatingRowStyle CssClass="AlterRowStyle" />
                                                                    <FooterStyle Font-Bold="true" ForeColor="Black" />
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Lease" ItemStyle-VerticalAlign="Top" ItemStyle-Width="135px" FooterStyle-HorizontalAlign="Left">
                                                                            <ItemTemplate>
                                                                                <%#Eval("Lease_Codes")%>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Lease Term" ItemStyle-VerticalAlign="Top" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Rentable Area" ItemStyle-VerticalAlign="Top" ItemStyle-Width="150px"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Deposit" ItemStyle-VerticalAlign="Top"
                                                                            ItemStyle-Width="100px">
                                                                            <ItemTemplate>
                                                                                <%# Eval("Tender_Type")%>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Deposit Reduced?" ItemStyle-VerticalAlign="Top" ItemStyle-Width="75px"
                                                                            ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <%# Eval("Security_Deposit_Reduced").ToString() == "N" ? "No" : "Yes" %>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Deposit Returned?" ItemStyle-VerticalAlign="Top" ItemStyle-Width="75px"
                                                                            ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <%# Eval("Security_Deposit_Returned").ToString() == "N" ? "No" : "Yes" %>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Security Deposit Amount" ItemStyle-VerticalAlign="Top"
                                                                            ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                                                            <ItemTemplate>
                                                                                <%# string.Format("{0:C2}",Eval("Amount")) %>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                ...
                                                <FooterTemplate>
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td>
                                                                <table width="100%" cellpadding="4" cellspacing="0" style="font-weight: bold; background-color: #507CD1;color: White;" id="tblFooter" runat="server">
                                                                    <tr>
                                                                        <td width="135px" align="left">
                                                                            Report Grand Totals 
                                                                        </td>
