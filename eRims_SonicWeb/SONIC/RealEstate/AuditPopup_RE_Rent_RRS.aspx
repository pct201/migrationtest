<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_RE_Rent_RRS.aspx.cs" Inherits="SONIC_RealEstate_AuditPopup_RE_Rent_RRS" %>
                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
	                                    <span style="display: inline-block;width:250px;">PK_RE_Rent_RRS</span>
                                    </th>
                                    <th class="cols">
	                                    <span style="display: inline-block;width:200px;">FK_RE_Rent</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="dvGrid" runat="server">
                        <asp:GridView ID="gvRent_Projections_ORS" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_RE_Rent_RRS" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblPK_RE_Rent_RRS" runat="server" Text='<%#Eval("PK_RE_Rent_RRS")%>' Width="250px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="FK_RE_Rent" >
	                                <ItemStyle CssClass="cols" />
	                                <ItemTemplate>
		                                <asp:Label ID="lblFK_RE_Rent" runat="server" Text='<%#Eval("FK_RE_Rent")%>' Width="200px" ></asp:Label>
	                                </ItemTemplate>
                                </asp:TemplateField>
