<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="rptLandlordNotifyDate.aspx.cs" Inherits="SONIC_RealEstate_rptLandlordNotifyDate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="ghc">Landlord Notification Report
            </td>
        </tr>
        <tr>
                        ...
                        <td width="100%" align="left">
                            <div id="dvGrid" runat="server" visible="false">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <div runat="server" id="dvReport" style="overflow-x: hidden; overflow-y: hidden; text-align: left; width: 990px;">
                                                        ...
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <table width="100%" cellpadding="4" cellspacing="0" style="font-weight: bold;" id="tblHeader"
                                                                    runat="server">
                                                                    <tr>
                                                                        <td width="125px" align="left">LL Notify Date
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table style="font-weight: bold; background-color: #507CD1; color: White;">
                                                                                ...
                                                                                <tr>
                                                                                    <td width="115px" align="left">Report Grand Totals
                                                                                    </td>
