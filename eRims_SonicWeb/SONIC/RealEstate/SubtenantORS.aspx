<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="SubtenantORS.aspx.cs"
    Inherits="SONIC_RealEstate_SubtenantORS" Title="Real Estate : Sub Tenant Option Rent Schedule" %>
...
<script type="text/javascript" language="javascript" src="../../JavaScript/jquery.maskedinput.js"></script>
    ...
    <script language="javascript" type="text/javascript">
      ...
      function AuditPopUp()
     {
        ...
        obj= window.open("AuditPopup_RE_Subtenant_ORS.aspx?id=" + '<%=ViewState["PK_RE_SubTenant_ORS"]%>','AuditPopUp','width=' + winWidth +',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');        
        obj.focus();
        return false;
    }
                        ...
                        <td class="dvContainer" align="center">
                            <div id="dvEdit" runat="server">
                                <div class="bandHeaderRow">
                                     Subtenant Information - Option Rent Schedule</div>
