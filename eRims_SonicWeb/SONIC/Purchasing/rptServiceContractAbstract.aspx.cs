...
/**************************************************************************************************************************************
 * File Name:		rptServiceContractAbstract.aspx
 *								  
 * Description:		This page is used for generate abstract report for Service Contract in Word document using aspose.word tool. 
 * 
 **************************************************************************************************************************************/
public partial class SONIC_Purchasing_rptServiceContractAbstract : System.Web.UI.Page
{
    #region "Declaration"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //doc.Save("ServiceContractAbstract.doc", Aspose.Words.SaveFormat.Doc, Aspose.Words.SaveType.OpenInWord, Response);
        doc.Save(Response, "ServiceContractAbstract.doc", ContentDisposition.Attachment, Aspose.Words.Saving.SaveOptions.CreateSaveOptions(SaveFormat.Doc));
        Response.End();
    }
    ...
    private void GenerateHTML(System.Text.StringBuilder sbHtml)
    {
        ...
        DataSet dsReport = PurchasingServiceContract.GetServiceContractAbstract(Convert.ToDecimal(Request.QueryString["ID"]));

        sbHtml.Append("<table width='100%' align='center'>");
        sbHtml.Append("<tr><td width='100%' align='center'><b>Sonic Automotive – Service Contract Abstract<b></td></tr>");
        sbHtml.Append("</table>");
        ...
        if (dsReport.Tables[0].Rows.Count > 0)
        {
            ...
            sbHtml.Append(GetHeaderRow("Service Contract"));
            ...
            sbHtml.Append("<td style='width:18%;' valign='top'>Service Type</td>");
            sbHtml.Append("<td style='width:2%;' valign='top'> :</td>");
            sbHtml.Append("<td style='width:30%;' valign='top'> " + drRow["Service_Type"].ToString() + " </td>");
            sbHtml.Append("</tr>");
            ...
            sbHtml.Append("<td valign='top'>Service Frequency</td>");
            sbHtml.Append("<td valign='top'> :</td>");
            sbHtml.Append("<td valign='top'> " + (drRow["Service_Frequency"]) + " </td>");
            sbHtml.Append("</tr>");
            ...
            sbHtml.Append("<tr>");
            sbHtml.Append("<td valign='top'>Service Contract </td>");
            sbHtml.Append("<td valign='top'> :</td>");
            sbHtml.Append("<td valign='top'> " + drRow["FK_LU_Service_Contract"].ToString() + " </td>");
            ...
            {
                sbHtml.Append("<tr valign='top'><td style='border-collapse: collapse;border-style: solid; border-color: Black; border-width: 2px;'> " + dtDealership.Rows[i]["dba"].ToString() + " </td>");
            ...
            DataTable dtAssest = Purchasing_SC_Asset.SelectByFK_Service_Contract(Convert.ToInt32(PK_Purchasing_Service_Contract), string.Empty).Tables[0];
            ...
            #region "Service Contract Notes"

            sbHtml.Append("<br /><table width='100%'>");
            sbHtml.Append(GetHeaderRow("Service Contract Notes", "1"));
            sbHtml.Append("</table><br />");

            DataTable dtNotes = Purchasing_SC_Notes.SelectAllByServiceContract((Int32)PK_Purchasing_Service_Contract).Tables[0];
            ...
            DataTable dtAttachment = ERIMSAttachment.SelectByTableName(clsGeneral.TableNames[(int)clsGeneral.Tables.Purchasing_Service_Contract], Convert.ToInt32(PK_Purchasing_Service_Contract)).Tables[0];
