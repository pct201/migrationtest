<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="Dealership.aspx.cs"
    Inherits="SONIC_Purchasing_Dealership" Title="Risk Insurance Management System :: Dealership" %>
                            ...
                            <div id="dvEdit" runat="server" width="794px">
                                <asp:Panel ID="pnlServiceContract" runat="server" Style="display: block;">
                                    <div class="bandHeaderRow">
                                        Service Contract - Dealership</div>
