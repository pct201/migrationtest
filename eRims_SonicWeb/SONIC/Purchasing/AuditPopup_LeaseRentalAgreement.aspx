<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_LeaseRentalAgreement.aspx.cs"
    Inherits="SONIC_Purchasing_AuditPopup_LeaseRentalAgreement" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Purchasing_LR_Agreement Audit Trail</title>
</head>
...
<body>
    <form id="form1" runat="server">
        <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 600px;" id="divPurchasing_LR_Agreement_Header"
                        runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 200px;">PK_Purchasing_LR_Agreement</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px;">Supplier</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 200px;">Equipment Type</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 130px;">Payment Terms</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 120px;">Buyout</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 80px;">Late Fee</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 130px;">Lease/Rental Type</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 130px;">Leased Amount</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 100px;">Leased Rate</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 220px;">Lease Rate Time Period</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 200px;">Lease/Rental Agreement Notes</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                     ...
                                     <th class="cols">
                                        <span style="display: inline-block; width: 130px;">Agreement Level </span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 140px;">Term In Months</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px;">Total Committed</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 200px;">Customer/Contract Number</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 220px;">Dealership Department</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 280px;">Dealership</span>
                                    </th>       
                                     <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divPurchasing_LR_Agreement_Grid"
                        runat="server">
                        <asp:GridView ID="gvPurchasing_LR_Agreement" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_Purchasing_LR_Agreement" SortExpression="PK_Purchasing_LR_Agreement">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblPK_Purchasing_LR_Agreement" runat="server" Text='<%#Eval("PK_Purchasing_LR_Agreement")%>'
                                ...
                                <asp:TemplateField HeaderText="Supplier" SortExpression="Supplier">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblSupplier" runat="server" Text='<%#Eval("Supplier")%>' Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="FK_LU_Equipment_Type" SortExpression="FK_LU_Equipment_Type">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblFK_LU_Equipment_Type" runat="server" Text='<%#Eval("FK_LU_Equipment_Type")%>'
                                            Width="200px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Payment_Terms" SortExpression="Payment_Terms">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblPayment_Terms" runat="server" Text='<%#Eval("Payment_Terms")%>'
                                            Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Buyout" SortExpression="Buyout">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuyout" runat="server" Text='<%#Eval("Buyout")%>' Width="120px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Late_Fee" SortExpression="Late_Fee">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblLate_Fee" runat="server" Text='<%#Eval("Late_Fee")%>' Width="80px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="FK_LU_LR_Type" SortExpression="FK_LU_LR_Type">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblFK_LU_LR_Type" runat="server" Text='<%#Eval("FK_LU_LR_Type")%>'
                                            Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Leased_Amount" SortExpression="Leased_Amount">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblLeased_Amount" runat="server" Text='<%#Eval("Leased_Amount")%>'
                                            Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Lease_Rate" SortExpression="Lease_Rate">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblLease_Rate" runat="server" Text='<%#Eval("Lease_Rate")%>' Width="100px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Lease_Rate_Time_Period" SortExpression="Lease_Rate_Time_Period">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblLease_Rate_Time_Period" runat="server" Text='<%#Eval("Lease_Rate_Time_Period")%>'
                                            Width="220px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="End_Of_Lease_Options" SortExpression="End_Of_Lease_Options">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblEnd_Of_Lease_Options" runat="server" Text='<%#Eval("End_Of_Lease_Options")%>'
                                ...
                                <asp:TemplateField HeaderText="End_Date" SortExpression="End_Date">
                                 ...
                                 <asp:TemplateField HeaderText="Agreement_Level" SortExpression="Agreement_Level">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAgreement_Level" runat="server" Text='<%#Eval("Agreement_Level")%>'
                                            Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="FK_LU_Dealership_Department" SortExpression="FK_LU_Dealership_Department">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblFK_LU_Dealership_Department" runat="server" Text='<%#Eval("FK_LU_Dealership_Department")%>'
                                            Width="220px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="COI_Needed" SortExpression="COI_Needed">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblCOINeed" runat="server" Text='<%#Eval("COI_Needed")%>'
                                            Width="100px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>                              
