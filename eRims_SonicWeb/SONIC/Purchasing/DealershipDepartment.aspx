<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="DealershipDepartment.aspx.cs"
    Inherits="SONIC_Purchasing_DealershipDepartment" Title="Risk Insurance Management System :: Dealership Department" %>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <%-- <tr>
            <td class="groupHeaderBar" align="left" colspan="2">
                <asp:Label ID="lblTitle" runat="server" Text="Service Contract" CssClass="heading"></asp:Label>
            </td>
        </tr>--%>
        <tr>
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" width="100%">
                                        <span id="dealershipdepartment" class="LeftMenuSelected">Dealership Department &nbsp;<span id="MenuAsterisk1" runat="server" style="color: Red;display:none">*</span></span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <div id="dvEdit" runat="server" width="794px">
                                <asp:Panel ID="pnlServiceContract" runat="server" Style="display: block;">
                                    <div class="bandHeaderRow">
                                        Service Contract - Dealership Department</div>
                                    <table width="100%" cellpadding="3" cellspacing="1" border="0">
                                        ...
                                        <tr>
                                            <td width="26%" align="left" nowrap="nowrap">
                                                Dealership Department&nbsp;<span id="Span1" style="color: Red; display: none;" runat="server">*</span>
                                            </td>
                                            <td width="4%" align="center">
                                                :
                                            </td>
                                            <td width="70%" align="left">
                                                <asp:DropDownList ID="drpDealerDepartment" runat="server" Width="170px">
                                                </asp:DropDownList>
                                                <%--<asp:RequiredFieldValidator ID="rfvDepartment" runat="server" ErrorMessage="Please Select Dealership Department"
                                                    ControlToValidate="drpDealerDepartment" Display="None" InitialValue="0" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
