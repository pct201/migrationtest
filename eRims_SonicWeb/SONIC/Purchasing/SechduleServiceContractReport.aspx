<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SechduleServiceContractReport.aspx.cs"
    Inherits="SONIC_Purchasing_SechduleServiceContractReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Service Contract Detail Report</title>
    <style type="text/css">
        .style1
        {
            width: 442px;
                ...
                <table cellpadding="3" cellspacing="0" border="0" align="center" style="width: 60%">
                    <tr>
                        ...
                        <td align="left" class="style1">
                            <asp:ListBox ID="lstRegions" runat="server" SelectionMode="Multiple" ToolTip="Select Region"
                                AutoPostBack="false" Width="180px"></asp:ListBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Select Region"
                                ...
                                SetFocusOnError="false" Enabled="false" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                        </td>
                        <td align="left">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1">
                            ...
                            <asp:RequiredFieldValidator ID="rfvlstLocation" runat="server" ErrorMessage="Please Select Location"
                                Font-Bold="true" Display="none" Text="*" ControlToValidate="lstLocation"
                                SetFocusOnError="false" Enabled="false" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                        </td>
                        <td align="left">
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1">
                            ...
                            <asp:RequiredFieldValidator ID="rfvlstServiceType" runat="server" ErrorMessage="Please Select Service Type"
                                Font-Bold="true" Display="none" Text="*" ControlToValidate="lstServiceType"
                                SetFocusOnError="false" Enabled="false" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                        </td>
                        <td align="left">
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1">
                            ...
                            <%--<asp:RequiredFieldValidator ID="rfvtxtStartDateFromDate" runat="server" ControlToValidate="txtStartDateFromDate"
                                ErrorMessage="Please enter From Start Date." Display="none" SetFocusOnError="true" ValidationGroup="vsErrorGroup"/>--%>
                            <asp:RangeValidator ID="RangeValidator3" ControlToValidate="txtStartDateFromDate"
                                MinimumValue="01/01/1753" MaximumValue="12/31/9999" Type="Date" ErrorMessage="Start Date is not valid."
                            ...
                            <%--<asp:RequiredFieldValidator ID="rfvtxtStartDateToDate" runat="server" ControlToValidate="txtStartDateToDate"
                                ErrorMessage="Please enter To Start Date." Display="none" SetFocusOnError="true" ValidationGroup="vsErrorGroup"/>--%>
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1">
                           ...
                           <%-- <asp:RequiredFieldValidator ID="rfvtxtEndDateFromDate" runat="server" ControlToValidate="txtEndDateFromDate"
                                ErrorMessage="Please enter From End Date." Display="none" SetFocusOnError="true" ValidationGroup="vsErrorGroup"/>--%>
                            <asp:RangeValidator ID="RangeValidator4" ControlToValidate="txtEndDateFromDate" MinimumValue="01/01/1753"
                                ...
                                SetFocusOnError="true" Display="none" ValidationGroup="vsErrorGroup"/>
                            &nbsp;&nbsp;To&nbsp;&nbsp;
                            ...
                            <%--<asp:RequiredFieldValidator ID="rfvtxtEndDateToDate" runat="server" ControlToValidate="txtEndDateToDate"
                                ErrorMessage="Please enter To End Date." Display="none" SetFocusOnError="true" ValidationGroup="vsErrorGroup"/>--%>
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1">
                            ...
                            <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Scheduled End Date must greater than current date." ValidationGroup="vsErrorGroup"
