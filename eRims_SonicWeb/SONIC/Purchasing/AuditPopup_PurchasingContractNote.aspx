<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_PurchasingContractNote.aspx.cs" Inherits="SONIC_Purchasing_AuditPopup_PurchasingContractNote" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Purchasing_SC_Notes Audit Trail</title>
</head>
...
<body>
    <form id="form1" runat="server">
        <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 600px;" id="divPurchasing_SC_Notes_Header" runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 200px">PK_Purchasing_SC_Notes</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divPurchasing_SC_Notes_Grid"
                        runat="server">
                        <asp:GridView ID="gvPurchasing_SC_Notes" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_Purchasing_SC_Notes" SortExpression="PK_Purchasing_SC_Notes">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="PK_Purchasing_SC_Notes" runat="server" Text='<%# Bind("PK_Purchasing_SC_Notes") %>'
