<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="ServiceContractNote.aspx.cs"
    Inherits="SONIC_Purchasing_ServiceContractNote" Title="Risk Insurance Management System :: Purchasing Service Contract Note" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_PurchasingContractNote.aspx?id=" + '<%=ViewState["PK_Purchasing_SC_Notes"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
        function checkNotes() {
                        ...
                        <tr>
                            <td width="40%" align="right">
                                <asp:Button ID="btnSave" runat="server" Text="Save & View" OnClick="btnSaveAndView_Click"
                                    ...
                                    <%--OnClientClick="return checkNotes();"--%>
                                &nbsp;<asp:Button runat="server" ID="btnContractNotesAudit" Text="View Audit Trail"
