<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="ClaimNotesEPMActionNotesRM.aspx.cs" Inherits="SONIC_ClaimInfo_ClaimNotesEPMActionNotesRM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_ClaimNotesEPMActionNotes.aspx?id=" + '<%=ViewState["PK_EPM_Action_Notes_RM"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
        ...
        function OpenMailPopUp() {
            var oWnd = window.open('<%=AppConfig.SiteURL%>SONIC/Exposures/EPMActionNotesMail.aspx?Tab=APNOTES&PK_Fields=' + '<%=ViewState["ClaimNoteIDs"]%>' + '&Table_Name=' + '<%=ViewState["FK_Table_Name"]%>' + '&Claim_ID=' + '<%=ViewState["FK_Claim"]%>', "Erims", "location=0,status=0,scrollbars=1,menubar=0,resizable=1,toolbar=0,width=600,height=300");
            oWnd.moveTo(450, 300);
            return false;
        }
    </script>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td colspan="3" align="left" style="font-family: Verdana; color: #266591; font-size: 13px; font-weight: 700; height: 16px">&nbsp; Risk Management Notes
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 5px;" class="Spacer"></td>
                ...
                <table cellpadding="1" cellspacing="3" width="100%">
                            ...
                            <table style="background-color: black" cellspacing="1" cellpadding="3" width="100%"
                                ...
                                <tbody>
                                    <tr class="PropertyInfoBG">
                                        <td id="tdProjectNum" runat="server" style="width: 14%;" align="left">
                                            <asp:Label ID="lblProjectNumber" runat="server" Text="Project Number"></asp:Label>
                                        </td>
                                        <td id="tdProjectType" runat="server" style="width: 12%;" align="left">
                                    ...
                                    <tr style="background-color: white">
                                        <td id="tdHeaderPro_Num" runat="server" align="left">
                                            <asp:Label ID="lblHeaderProject_Number" runat="server">&nbsp;</asp:Label>
                                        </td>
                                        <td id="tdHeaderProType" runat="server" align="left">
                    ...
                    <tr>
                        <td class="ghc" align="left" colspan="2">
                            <asp:Label ID="lblPanelDesc" runat="server" Text="Project Management Screen – Risk Management Notes" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                                        ...
                                        <table cellpadding="5" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td align="left" width="100%">
                                                    <span class="left_menu_active" style="cursor: pointer">Risk Management Notes</span>&nbsp;<span
