...
public partial class SONIC_PLClaimInfo : clsBasePage
{
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void gvPLTransList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        //check Rowtype
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void gvPLTransList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        //check Command Name
    ...
    protected void btnPrintSelectedTrans_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gRow in gvPLTransList.Rows)
        {
    ...
    /// <summary>
    /// Handles Mail button click event for Transaction grid
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void btnMailTrans_Click(object sender, EventArgs e)
    {
        ...
        if (strPKs != "")
        {
            ScriptManager.RegisterClientScriptBlock(Page, this.GetType(), "", "OpenTransMailPopUp('" + "Transactions" + "','" + strPKs + "','" + tab + "','" + PK_PL_CI_ID + "');", true);
        }
        else
        {
    ...
    public void BindWCTransList(string Origional_Claim_Number, int PageNumber, int PageSize)
    {
        ...
        gvPLTransList.DataSource = dtWCTransList;
        gvPLTransList.DataBind();
    }
    /// <summary>
   ...
   /// <param name="strPK"></param>
    private void PrintTransaction(string strPK)
    {
        if (strPK != string.Empty)
        {
            DataTable dtClaim = PL_ClaimInfo.SelectByPK(PK_PL_CI_ID).Tables[0]; ;
