<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="ClaimNotesCOI.aspx.cs" Inherits="SONIC_ClaimInfo_ClaimNotesCOI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_ClaimNotesCOI.aspx?id=" + '<%=ViewState["PK_COI_Notes"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
        ...
        function OpenMailPopUp() {
            var oWnd = window.open('<%=AppConfig.SiteURL%>SONIC/Exposures/COIMail.aspx?Tab=APNOTES&PK_Fields=' + '<%=ViewState["ClaimNoteIDs"]%>' + '&Table_Name=' + '<%=ViewState["FK_Table_Name"]%>' + '&Claim_ID=' + '<%=ViewState["FK_Claim"]%>', "Erims", "location=0,status=0,scrollbars=1,menubar=0,resizable=1,toolbar=0,width=600,height=300");
            oWnd.moveTo(450, 300);
            return false;
        }
    </script>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr class="PropertyInfoBG">
                            <td style="width: 19%" align="left">
                                <asp:Label ID="lblHeaderLocationName" runat="server" Text="D/B/A Location Name"></asp:Label>
                            </td>
                            <td style="width: 23%" align="left">
                                <asp:Label ID="lblHeaderLocationNumber" runat="server" Text="SONIC Location Number"></asp:Label>
                            </td>
                            <td style="width: 16%" align="left">
                                <asp:Label ID="lblHeaderInsuredName" runat="server" Text="InsuredName"></asp:Label>
                            </td>
                            <td style="width: 21%" align="left">
                                <asp:Label ID="lblHeaderIssueDate" runat="server" Text="Issue Date"></asp:Label>
                            </td>
                            <td style="width: 21%" align="left">
                                <asp:Label ID="lblHeaderEffectiveDate" runat="server" Text="Effective Date"></asp:Label>
                            </td>
                        </tr>
                        <tr style="background-color: white">
                            ...
                            <td align="left">
                                <asp:Label ID="lblLocationNumber" runat="server"></asp:Label>
                            </td>
                            <td align="left">
        ...
        <tr>
            <td class="ghc" align="left" colspan="2">
                <asp:Label ID="lblPanelDesc" runat="server" Text="COI Screen – COI Notes" />
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" width="100%">
                                        <span class="left_menu_active" style="cursor: pointer">Notes</span>&nbsp;<span
