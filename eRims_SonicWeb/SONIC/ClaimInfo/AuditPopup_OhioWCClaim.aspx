        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                <td colspan="2" align="left">
                    <div style="overflow: hidden; width: 600px;" id="divWC_FR_Header" runat="server">
                        <table align="left" cellpadding="4" cellspacing="0" style="border-collapse: collapse;
                            width: 600px;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 120px">Date_Of_Incident</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divWC_FR_Grid" runat="server">
                        <asp:GridView ID="gvWC_FRName" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Claim_Number">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblClaim_Number" runat="server" Text='<%#Eval("Claim_Number")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Date_Entered">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="120px" ID="lblDate_Entered" runat="server" Text='<%#clsGeneral.FormatDBNullDateToDisplay(Eval("Date_Entered"))%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Date_Closed">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="120px" ID="lblDate_Closed" runat="server" Text='<%#clsGeneral.FormatDBNullDateToDisplay(Eval("Date_Closed"))%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Date_Reopened">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="120px" ID="lblDate_Reopened" runat="server" Text=' <%#clsGeneral.FormatDBNullDateToDisplay(Eval("Date_Reopened"))%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Active_Inactive">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="100px" ID="lblActive_Inactive" runat="server" Text='<%#Eval("Active_Inactive")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Type">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblType" runat="server" Text='<%#Eval("Type")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Total_Medical">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblTotal_Medical" runat="server" Text='<%#Eval("Total_Medical")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Total_Comp">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblTotal_Comp" runat="server" Text='<%#Eval("Total_Comp")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Total_Reserve">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblTotal_Reserve" runat="server" Text='<%#Eval("Total_Reserve")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Unlimited_Cost">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblUnlimited_Cost" runat="server" Text='<%#Eval("Unlimited_Cost")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Limited_to_MV">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblLimited_to_MV" runat="server" Text='<%#Eval("Limited_to_MV")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="HC_Percent">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblHC_Percent" runat="server" Text='<%#Eval("HC_Percent")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="HC_Relief">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblHC_Relief" runat="server" Text='<%#Eval("HC_Relief")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Subrogation_Collected">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblSubrogation_Collected" runat="server" Text='<%#Eval("Subrogation_Collected")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Claim_Activity">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblClaim_Activity" runat="server" Text='<%#Eval("Claim_Activity")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Total_Charged">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblTotal_Charged" runat="server" Text='<%#Eval("Total_Charged")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Imported">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label Width="140px" ID="lblImported" runat="server" Text='<%#Eval("Imported")%>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
