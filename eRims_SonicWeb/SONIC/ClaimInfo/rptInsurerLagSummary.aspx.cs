...
using ERIMS.DAL;
public partial class SONIC_ClaimInfo_rptInsurerLagSummary : clsBasePage
{
    #region "Variables"
    ...
    protected void btnShowReport_Click(object sender, EventArgs e)
    {
        ...
        DataSet dsReport = clsClaimReports.GetInsurerLagSummaryData(Convert.ToDateTime(txtLossFromDate.Text), Convert.ToDateTime(txtLossToDate.Text), strRegion, strMarket);
    ...
    protected void lbtExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        GridViewExportUtil.ExportGrid("InsurerLagSummaryReport.xlsx", gvDescription, true);
    ...
    protected void btnClearCriteria_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("rptInsurerLagSummary.aspx", false);
    }
