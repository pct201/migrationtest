...
public partial class SONIC_ClaimInfo_ScheduleInsurerLagSummary : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            Tatva_RptInsurerLagSummarySchedule obj = new Tatva_RptInsurerLagSummarySchedule();
            string strRegion = "";
