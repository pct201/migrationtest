<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="rptTPALagSummary.aspx.cs"
 Inherits="SONIC_ClaimInfo_rptTPALagSummary" Title="eRIMS Sonic :: Reported to TPA Lag Summary Report" %>
    ...
    <table width="100%">
        <tr>
            <td align="left" class="ghc">
                Reported to TPA Lag Summary Report
            </td>
        </tr>
        <tr>
