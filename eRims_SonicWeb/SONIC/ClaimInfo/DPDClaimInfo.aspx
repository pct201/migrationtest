    ...
    <script type="text/javascript" language="javascript">
        ...
        function ShowPanel(index) {
            ...
            if (index == 1) {
                ...
                SetPanelByIndex("block", "none", "none", "none", "none","none", "none", "block");
            }
            if (index == 2) {
                //Set Addresses Screen Visible
                SetPanelByIndex("none", "block", "none", "none", "none", "none", "block", "block");

            }
            if (index == 3) {
                //Set Incidents Screen Visible
                SetPanelByIndex("none", "none", "block", "none", "none", "none", "block", "block");

            }
            if (index == 4) {
                //Set Details Screen Visible
                SetPanelByIndex("none", "none", "none", "block", "none", "none", "block", "block");

            }
            if (index == 5) {
                //Set Notes Screen Visible
                // SetPanelByIndex("none", "none", "none", "none", "block", "block", "none");
                SetPanelByIndex("none", "none", "none", "none", "block", "none", "block", "block");

            }

            if (index == 6) {
                //Set Sonic Notes Screen Visible
                SetPanelByIndex("none", "none", "none", "none", "none", "block", "block", "none");

            }
        }

        //Enable-Disable zx Screen and Previous/Next Button as per Click
        function SetPanelByIndex(ClaimInfo, Addresses, Incidents, Details, Notes, SonicNotes, btnPrev, btnNext) {
            ...
            document.getElementById("<%=pnlSonicNotes.ClientID%>").style.display = SonicNotes;
                            ...
                            <tr>
                                <td width="100%">
                                    <table cellpadding="5" cellspacing="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <span id="WCMenu6" href="#" onclick="javascript:ShowPanel('6');">Sonic Notes</span>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td width="794px" valign="top" class="dvContainer">
                                    <div id="dvView" runat="server" style="width: 100%;">
                                        ...
                                        <asp:Panel ID="pnlIncidents" runat="server" Width="100%">
                                            <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                <tr>
                                                    <td valign="top" style="width: 15%">DPD Incidents Grid                                                           
                                                    </td>
                                                    <td align="center" valign="top" style="width: 3%">:
                                                    </td>
                                                    <td style="margin-left: 40px" style="width: 650px">
                                        ...
                                        <asp:Panel ID="pnlDetails" runat="server">
                                            <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        Third Party Vehicle License Plate Number
                                                    </td>
                                                    <td align="center"></td>
                                                    <td align="left">
