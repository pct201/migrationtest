<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="rptCompletionLagSummary.aspx.cs"
 Inherits="SONIC_ClaimInfo_rptCompletionLagSummary" Title="eRIMS Sonic :: Reported to Completion Lag Summary Report" %>
    ...
    <table width="100%">
        <tr>
            <td align="left" class="ghc">
                Reported to Completion Lag Summary Report
            </td>
        </tr>
        <tr>
