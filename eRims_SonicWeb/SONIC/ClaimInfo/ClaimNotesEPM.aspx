<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="ClaimNotesEPM.aspx.cs" Inherits="SONIC_ClaimInfo_ClaimNotesEPM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_ClaimNotesEPM.aspx?id=" + '<%=ViewState["PK_EPM_Consultant_Notes"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
        ...
        function OpenMailPopUp() {
            var oWnd = window.open('<%=AppConfig.SiteURL%>SONIC/Exposures/EPMMail.aspx?Tab=APNOTES&PK_Fields=' + '<%=ViewState["ClaimNoteIDs"]%>' + '&Table_Name=' + '<%=ViewState["FK_Table_Name"]%>' + '&Claim_ID=' + '<%=ViewState["FK_Claim"]%>', "Erims", "location=0,status=0,scrollbars=1,menubar=0,resizable=1,toolbar=0,width=600,height=300");
            oWnd.moveTo(450, 300);
            return false;
        }
    </script>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
       <%-- <tr>
        ...
        <tr>
            <td colspan="3" align="left" style="font-family: Verdana; color: #266591; font-size: 13px; font-weight: 700; height: 16px">&nbsp; Consultant Notes
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 5px;" class="Spacer"></td>
                            ...
                            <table cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" width="100%">
                                        <span class="left_menu_active" style="cursor: pointer">Consultant Notes</span>&nbsp;<span
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" width="28%" valign="top">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="rvtxtNote_Date" runat="server" ControlToValidate="txtNote_Date" ValidationGroup="vsErrorGroup"
                                                            ...
                                                            ErrorMessage="[Consultant Notes]/Date of Note is Not Valid Date." Display="none" SetFocusOnError="true">
