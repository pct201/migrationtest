...
/**********************************************************************************************
    * File Name:		ScheduleSummaryPITReport.aspx
    *								  
    * Developer Name:	Amit Makwana	  
    *								  
    * Description:		This Page provide interface to user select filters for report Summary Point-In-Time.
    * 
    **************************************************************************************************/

public partial class ClaimDetailReport_ScheduleSummaryPITReport : clsBasePage
{
    #region Events
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            Tatva_RptSummaryPITSchedule obj = new Tatva_RptSummaryPITSchedule();
