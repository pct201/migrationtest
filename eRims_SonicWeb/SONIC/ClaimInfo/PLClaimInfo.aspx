<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="PLClaimInfo.aspx.cs"
    Inherits="SONIC_PLClaimInfo" Title="Claim Information :: Premises Liability" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ShowPanel(index) {
            ...
            if (index == 1) {
                ...
                document.getElementById("<%=pnlWorksheet.ClientID%>").style.display = "none";
            ...
            if (index == 5) {
                ...
                document.getElementById("<%=pnlTransactions.ClientID%>").style.display = "none";
                document.getElementById("<%=pnlNotes.ClientID%>").style.display = "none";
                document.getElementById("<%=pnlWorksheet.ClientID%>").style.display = "block";
                document.getElementById("<%=pnlAttachment.ClientID%>").style.display = "none";
                document.getElementById("<%=pnlSonicNotes.ClientID%>").style.display = "none";
                document.getElementById("btnPrev").style.display = "block";
                document.getElementById("btnNext").style.display = "block";
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OpenWizardPopup(claimId, num) {
            ...
            GB_showCenter('', '<%=AppConfig.SiteURL%>SONIC/ClaimInfo/EmailAttachment.aspx?claimId=' + claimId + '&Tbl=pl', 500, 950, ReturnFunction);
        }
        ...
        function AuditPopUp() {
            ...
            obj = window.open("PLClaimInfoAuditPopup.aspx?id=" + '<%=ViewState["PK_Premises_Loss_RMW"]%>', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=0,menubar=0');
            obj.focus();
            return false;
        }
                                        ...
                                        <div id="dvView" runat="server" style="width: 100%;">
                                                ...
                                                <table cellpadding="1" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td width="100%" align="left">
                                                            <uc:CtrlAdjusterNotes ID="ucAdjusterNotes" runat="server" CurrentClaimType="PL" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                                            <asp:Panel ID="pnlWorksheet" runat="server" Width="100%">
                                                        ...
                                                        <td colspan="6">
                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                        <asp:Label ID="lblLegal_Expense_Incurred" runat="server" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="Spacer" style="height: 10px;"></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                        <asp:Label ID="lblLegal_Expense_Paid_to_Date" runat="server" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="Spacer" style="height: 10px;"></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                        <asp:Label ID="lblLoss_Gross_Subrogation" runat="server" />
                                                                    </td>
                                                                    <td align="left">
                                                ...
                                                <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                                    <tr>
                                                        <td colspan="6">
                                                            <a href="#" onclick="OpenWizardPopup(<%=ViewState["PL_CI_ID"] %>,0);">Email ALL</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">&nbsp;
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" width="26%">
                                                                        ...
                                                                        <img onmouseover="javascript:this.style.cursor='hand';" onclick="return showCalendar('ctl00_ContentPlaceHolder1_txtPresident_Last_Email_Date', 'mm/dd/y',OnChangeFunction);"
                                                                            alt="President Last Email Date" src="../../Images/iconPicDate.gif" align="middle" /><br />
                                                                        <asp:RegularExpressionValidator ID="revtxtPresident_Last_Email_Date" runat="server"
                                                                            ControlToValidate="txtPresident_Last_Email_Date" ValidationExpression="^((0?[13578]|10|12)(-|\/)(([1-9])|(0[1-9])|([12])([0-9]?)|(3[01]?))(-|\/)((19)([2-9])(\d{1})|(20)([01])(\d{1})|([8901])(\d{1}))|(0?[2469]|11)(-|\/)(([1-9])|(0[1-9])|([12])([0-9]?)|(3[0]?))(-|\/)((19)([2-9])(\d{1})|(20)([01])(\d{1})|([8901])(\d{1})))$"
                                                                            ErrorMessage="Date Not Valid(Last E-Mail Date)" Display="none" ValidationGroup="vsErrorGroup"></asp:RegularExpressionValidator>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                        ...
                                                                        <img onmouseover="javascript:this.style.cursor='hand';" onclick="return showCalendar('ctl00_ContentPlaceHolder1_txtPresident_Response_Date', 'mm/dd/y',OnChangeFunction);"
                                                                            alt="President Response Date" src="../../Images/iconPicDate.gif" align="middle" /><br />
                                                                        <asp:RegularExpressionValidator ID="revtxtPresident_Response_Date" runat="server"
                                                                            ControlToValidate="txtPresident_Response_Date" ValidationExpression="^((0?[13578]|10|12)(-|\/)(([1-9])|(0[1-9])|([12])([0-9]?)|(3[01]?))(-|\/)((19)([2-9])(\d{1})|(20)([01])(\d{1})|([8901])(\d{1}))|(0?[2469]|11)(-|\/)(([1-9])|(0[1-9])|([12])([0-9]?)|(3[0]?))(-|\/)((19)([2-9])(\d{1})|(20)([01])(\d{1})|([8901])(\d{1})))$"
                                                    ...
                                                    <tr>
                                                        <td colspan="6" align="center">
                                                            <asp:Button Width="90px" runat="server" ID="btnSave" Text="Save" OnClick="btnSave_Click"
