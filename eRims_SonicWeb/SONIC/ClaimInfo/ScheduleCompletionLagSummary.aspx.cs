...
public partial class SONIC_ClaimInfo_ScheduleCompletionLagSummary : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            Tatva_RptCompletionLagSummarySchedule obj = new Tatva_RptCompletionLagSummarySchedule();
            string strRegion = "";
