...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" width="99%" align="center">
        ...
        <tr>
            <td class="ghc" align="left">Financial Pay Type Summary Report
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="dvContent">
                <table cellpadding="3" cellspacing="1" border="0" width="40%" align="center">
                    <tr>
                        <td width="30%" align="left" valign="top">Accident Year<span class="mf">*</span>
                        </td>
                    ...
                    <tr>
                        <td align="left" valign="top">Prior Valuation Date<span class="mf">*</span>
                        </td>
                        <td width="2%" align="center" valign="top">:</td>
                        <td align="left">
                    ...
                    <tr>
                        <td class="Spacer" colspan="3" style="height: 10px;"></td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                        <td align="left">
                    ...
                    <tr>
                        <td colspan="3" class="Spacer" style="height: 15px;"></td>
                    </tr>
                </table>
            </td>
        </tr>
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                                                                            ...
                                                                                            <td width="100%">
                                                                                                <table width="100%" cellpadding="0" cellspacing="0" id="tblHeader" runat="server" style="font-weight: bold;">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="width: 16%;" align="right">Indemnity/PD</td>
                                                                                                        <td style="width: 16%;" align="right">Medical/BI</td>
                                                                                                        <td style="width: 16%;" align="right">Expense</td>
                                                                                                        <td style="width: 16%;" align="right">Total
                                                                                                        </td>
                                                                                                        <td style="width: 16%;" align="center">Claim Count</td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
                                            ...
                                            <ItemTemplate>
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="100%" align="left" colspan="6" style="border: thin">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td width="100%" align="left" colspan="6" style="border: thin">
                                                                                        <%--<b>Region ---
                                                                                            <asp:Label ID="lblRegion" runat="server" Text='<%# Eval("Region") %>'></asp:Label></b>--%>
                                                                                        <asp:Label ID="lblRegion" runat="server" Text='<%# "Region - " + Eval("Region")%>'
                                                                                            Font-Bold="true">
                                                                                        </asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                                                ...
                                                                                                <asp:TemplateField>
                                                                                                    <ItemTemplate>
                                                                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0" id="tblDetails" runat="server">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="width: 20%" align="left">Incurred</td>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td width="100%">
                                                                                                <table width="100%" cellpadding="0" cellspacing="0" style="font-weight: bold; background-color: #507CD1; color: White;"
