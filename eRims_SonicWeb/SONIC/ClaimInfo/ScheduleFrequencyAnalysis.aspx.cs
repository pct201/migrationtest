...
public partial class SONIC_ClaimInfo_ScheduleFrequencyAnalysis : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            Tatva_RptFrequencyAnalysisSchedule obj = new Tatva_RptFrequencyAnalysisSchedule();
