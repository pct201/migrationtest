<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_ClaimNotesCOI.aspx.cs" Inherits="SONIC_ClaimInfo_AuditPopup_ClaimNotesCOI" %>
                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 100px;">PK_COI_Notes</span>
                                    </th>
                                    <%-- <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 510px;" id="divPurchasing_Service_Contract_Grid"
                        ...
                        <asp:GridView ID="gvPurchasing_Service_Contract" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_COI_Notes" SortExpression="PK_COI_Notes">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="PK_COI_Notes" runat="server" Text='<%# Bind("PK_COI_Notes") %>' Width="100px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
