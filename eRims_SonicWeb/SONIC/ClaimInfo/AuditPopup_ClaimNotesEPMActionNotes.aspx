<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_ClaimNotesEPMActionNotes.aspx.cs" Inherits="SONIC_ClaimInfo_AuditPopup_ClaimNotesEPMActionNotes" %>
...
<body>
    <form id="form1" runat="server">
        <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 600px;" id="divEPM_Action_Notes_Header"
                        runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 100px;">EPM Action Notes</span>
                                    </th>
                                    <%-- <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 510px;" id="divEPM_Action_Notes_Grid"
                        runat="server">
                        <asp:GridView ID="gvEPM_Action_Notes" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_EPM_Action_Notes_RM" SortExpression="PK_EPM_Action_NotesPK_EPM_Action_Notes_RM">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="PK_EPM_Action_Notes_RM" runat="server" Text='<%# Bind("PK_EPM_Action_Notes_RM") %>' Width="100px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
