<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ALClaimInfoAuditPopup.aspx.cs" Inherits="SONIC_ClaimInfo_ALClaimInfoAuditPopup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Auto_Loss_RMW_Audit Audit Trail</title>
...
<body>
    ...
    <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                <div style="overflow: hidden; width: 1500px;" id="divAuto_Loss_RMW_Audit_Header" runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 1500px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 160px">PK_Auto_Loss_RMW</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 165px">FK_Auto_Loss_Claims</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 120px">Driver_Customer</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 125px">Driver_Associate</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 140px">FK_LU_Part_Of_Body</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 160px">FK_LU_Nature_Of_Injury</span>
                                    </th>
                                    <th class="cols">
                ...
                <div  style="overflow-y:scroll; width: 1500px; height: 425px;" id="divAuto_Loss_RMW_Audit_Grid"
                        runat="server" >
                        <asp:GridView ID="gvAuto_Loss_RMW_Audit" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="PK_Auto_Loss_RMW" runat="server" Text='<%#Eval("PK_Auto_Loss_RMW")%>'
                                    Width="160px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                            <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="FK_Auto_Loss_Claims" runat="server" Text='<%#Eval("FK_Auto_Loss_Claims")%>'
                            ...
                            <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                <asp:Label ID="Driver_Customer" runat="server" Text='<%#Eval("Driver_Customer")%>'
                            ...
                            <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                <asp:Label ID="Driver_Associate" runat="server" Text='<%#Eval("Driver_Associate")%>'
                            ...
                            <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                <asp:Label ID="FK_LU_Part_Of_Body" runat="server" Text='<%#Eval("FK_LU_Part_Of_Body")%>'
                                    Width="140px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField >
                            <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                <asp:Label ID="FK_LU_Nature_Of_Injury" runat="server" Text='<%#Eval("FK_LU_Nature_Of_Injury")%>'
                                    Width="160px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField >
