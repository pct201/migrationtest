        ...
        <tr>
            <td align="center">
                <table width="85%" border="0" cellpadding="3" cellspacing="2">
                    ...
                    <tr>
                        <td width="100%" class="Spacer" style="height: 10px;" colspan="7">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div id="dvGrid" runat="server" style="width: 996px; overflow-x: scroll; overflow-y: hidden">
                                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                    CellSpacing="0" Width="1800px" GridLines="None" ShowFooter="false" EmptyDataText="No Record Found !">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Reserves and Payments" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <asp:TemplateField HeaderText=" Resignation">
                                            <ItemStyle Width="100px" />
                                            <ItemTemplate>
                                                <div style="padding-left:20px;"><%#Eval("Resignation")%></div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText=" Who Approved">
                                            <ItemStyle Width="100px" />
                                            <ItemTemplate>
                                               <div style="padding-left:20px;"><%#Eval("Who_Approved")%></div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
