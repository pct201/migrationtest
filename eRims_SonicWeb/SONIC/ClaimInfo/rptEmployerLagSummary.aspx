<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="rptEmployerLagSummary.aspx.cs"
    Inherits="SONIC_ClaimInfo_rptEmployerLagSummary" Title="eRIMS Sonic :: Reported to Employer Lag Summary Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td align="left" class="ghc">Reported to Employer Lag Summary Report
            </td>
        </tr>
        <tr>
            ...
            <td align="center">
                <table width="65%" border="0">
                    <tr>
                        ...
                        <td align="left" width="150">&nbsp; &nbsp; &nbsp; Loss Date From
                        </td>
                        <td colspan="1" align="left" width="150">&nbsp; &nbsp; &nbsp; Loss Date To
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" align="left" width="150">&nbsp; &nbsp; &nbsp; (MM/DD/YYYY)
                        </td>
                        <td colspan="1" align="left" width="150">&nbsp; &nbsp; (MM/DD/YYYY)
                        </td>
                        <td align="left" colspan="1"></td>
                    ...
                    <tr>
                        <td valign="top" align="left" width="100">Dates of Loss <span style="color: Red; font-weight: bold;">*</span>
                        </td>
                    ...
                    <tr>
                        <td align="left" valign="top">Region<span class="mf">*</span>
                        </td>
                    ...
                    <tr>
                        <td align="left" valign="top">Market<span class="mf">*</span>
                        </td>
                        <td width="2%" align="center" valign="top">:</td>
                        <td align="left" colspan="2">
                        ...
                        <Columns>
                            <asp:TemplateField>
                                        ...
                                        <tr>
                                            <td>
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-weight: bold;" id="tblHeader" runat="server">
                                                    <tr>
                                                        <td align="left" style="width: 26%">Lag Period(Days)</td>
                                                        <td align="right" style="width: 14%">No of Claims</td>
                                                        <td align="right" style="width: 14%">Percentage To
                                                            <br />
                                                            Total Claim
                                                        </td>
                                                        <td align="right" style="width: 18%">Total
                                                            <br />
                                                            Incurred Dollars
                                                        </td>
                                                        <td align="right" style="width: 14%">Percentage To
                                ...
                                <ItemTemplate>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td align="left" style="background-color: White; height: 25px; color: Black; border: thin" colspan="5">
                                                <b>
                                                    <asp:Label ID="lblDescription" runat="server"><%# "Region : " + Eval("Region")%></asp:Label>
                                                </b>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <asp:GridView Width="100%" ShowHeader="false" ID="gvLagSummaryReport" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblClaimCount" runat="server" Text='<%# String.Format("{0:N0}",Eval("ClaimCount"))%>' />
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lblFooterClaimCount" runat="server" Text='<%#Eval("ClaimCount")%>' />
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemStyle Width="14%" HorizontalAlign="right" />
                                                            <FooterStyle Width="14%" BackColor="white" ForeColor="black" Font-Bold="true" HorizontalAlign="Right" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblClaimPercent" runat="server" Text='<%# String.Format("{0:N2}",Eval("ClaimPercent"))%>' />
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lblFooterClaimCountPercentage" runat="server" />
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblIncurred" runat="server" Text='<%# String.Format("{0:C2}",Eval("Incurred"))%>' />
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lblFooterIncurred" runat="server" Text='<%#Eval("Incurred")%>' />
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemStyle Width="14%" HorizontalAlign="right" />
                                                            <FooterStyle Width="14%" BackColor="white" ForeColor="black" Font-Bold="true" HorizontalAlign="Right" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblIncurredPercent" runat="server" Text='<%# String.Format("{0:N2}",Eval("IncurredPercent"))%>' />
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lblFooterIncurredPercentage" runat="server" />
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                        ...
                                        <tr>
                                            <td valign="middle">
                                                <table width="100%" cellpadding="4" cellspacing="0" border="0" style="font-weight: bold; background-color: #507CD1; color: White;"
                                                    ...
                                                    <tr>
                                                        <td align="left" style="width: 26%">Total</td>
