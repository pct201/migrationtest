<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleWCCauseAnalysis.aspx.cs"
    Inherits="SONIC_ClaimInfo_ScheduleWCCauseAnalysis" Title="eRIMS Sonic :: WC Cause Analysis Report" %>
                    ...
                    <tr>
                        ...
                        <td width="150" align="left">
                            ...
                            <asp:RangeValidator ID="revDateTo" ControlToValidate="txtAccidentToDate" MinimumValue="01/01/1753"
                                ...
                                runat="server" SetFocusOnError="true" Display="none" />
                            <asp:CompareValidator ID="CompareValidator1" runat="server" Type="Date" ControlToValidate="txtAccidentToDate"
                                ControlToCompare="txtAccidentFromDate" Operator="GreaterThanEqual" ErrorMessage="Accident Date To must be greater than Accident Date From"
