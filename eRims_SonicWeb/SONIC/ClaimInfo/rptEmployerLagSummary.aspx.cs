...
using ERIMS.DAL;
public partial class SONIC_ClaimInfo_rptEmployerLagSummary :clsBasePage
{
    #region "Variables"
    ...
    protected void lbtExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        GridViewExportUtil.ExportGrid("EmployerLagSummaryReport.xls", gvDescription);
    ...
    protected void btnClearCriteria_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("rptEmployerLagSummary.aspx", false);
    }
