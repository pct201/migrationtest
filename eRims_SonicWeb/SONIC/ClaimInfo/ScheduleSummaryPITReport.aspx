<%@ Page Language="C#" Title="eRIMS :: Summary Point-In-Time Comparison Report "
    MasterPageFile="~/Tatva_ScheduleMaster.master" AutoEventWireup="true" CodeFile="ScheduleSummaryPITReport.aspx.cs"
    Inherits="ClaimDetailReport_ScheduleSummaryPITReport" %>
    ...
    <table width="100%">
        <tr>
            <td align="left" class="ghc">
                Summary Point-In-Time Comparison Report
            </td>
        </tr>
        <tr>
                ...
                <table width="80%" align="center" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="4">
                            ...
                            <asp:RequiredFieldValidator ID="rfvlsbPlicyYear" runat="server" ErrorMessage="Please Select Accident Year."
