...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" width="99%" align="center">
        ...
        <tr>
            <td class="ghc" align="left">Financial Summary Report
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="dvContent">
                <table cellpadding="3" cellspacing="1" border="0" width="40%" align="center">
                    ...
                    <tr>
                        <td width="30%" align="left" valign="top">Claim Type<span class="mf">*</span>
                        </td>
                        <td width="2%" align="center" valign="top">:</td>
                        <td align="left">
                                                                                ...
                                                                                <tr>
                                                                                    <td width="100%">
                                                                                        <table width="100%" cellpadding="0" cellspacing="0" style="font-weight: bold;" id="tblHeader" runat="server">
                                                                                            <tr>
                                                                                                <td style="width: 25%;" align="left">Financial Summary Report
                                                                                                </td>
                                                                                                <td style="width: 15%;" align="right">Total Incurred Amount
                                                                                                </td>
                                                                                                <td style="width: 15%;" align="right">Total Paid Amount
                                                                                                </td>
                                                                                                <td style="width: 20%;" align="right">Total Outstanding Amount
                                                                                                </td>
                                                                                                <td style="width: 13%;" align="right">Number Of Claims
                                                                                                </td>
                                                                                                <td style="width: 12%;" align="right">Percent<br />
                                                                                                    Paid/Inc
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
