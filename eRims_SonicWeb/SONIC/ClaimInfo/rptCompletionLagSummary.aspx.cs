...
using ERIMS.DAL;
public partial class SONIC_ClaimInfo_rptCompletionLagSummary : clsBasePage
{
    #region "Variables"
    ...
    protected void btnShowReport_Click(object sender, EventArgs e)
    {
        ...
        DataSet dsReport = clsClaimReports.GetCompletionLagSummaryData(Convert.ToDateTime(txtLossFromDate.Text), Convert.ToDateTime(txtLossToDate.Text), strRegion, strMarket);
    ...
    protected void lbtExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        GridViewExportUtil.ExportGrid("CompletionLagSummaryReport.xls", gvDescription);
    ...
    protected void btnClearCriteria_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("rptCompletionLagSummary.aspx", false);
    }
