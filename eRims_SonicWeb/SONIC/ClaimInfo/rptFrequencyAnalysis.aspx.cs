...
public partial class SONIC_ClaimInfo_rptFrequencyAnalysis : clsBasePage
{
    #region "Variables"
    ...
    protected void btnGenerateReport_Click(object sender, EventArgs e)
    {
        ...
        foreach(ListItem itm in lstClaimType.Items)
        {
            if(itm.Selected)
                strClaimType = strClaimType + itm.Value + ",";
        }
        strClaimType = strClaimType.TrimEnd(',');

        // get report data into a dataset
        DataSet dsReport = clsClaimReports.GetFrequencyAnalysisData(dtFrom, dtTo, strClaimType);
    ...
    protected void btnClearCriteria_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("rptFrequencyAnalysis.aspx", false);
    }
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        GridViewExportUtil.ExportGrid("FrequencyAnalysisReport.xlsx", gvRegions, true);
