<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_SonicNotes.aspx.cs"
    Inherits="SONIC_ClaimInfo_AuditPopup_SonicNotes" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Risk Insurance Management System :: Sonic Notes Audit</title>
</head>
                    ...
                    <table cellpadding="4" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                        <tbody>
                            <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                ...
                                <th class="cols">
                                    <span style="display: inline-block; width: 100px;">Pk_Claim_Notes</span>
                                </th>
                                <th class="cols">
                ...
                <div style="overflow: scroll; width: 600px; height: 510px;" id="divPurchasing_Service_Contract_Grid"
                    ...
                    <asp:GridView ID="gvPurchasing_Service_Contract" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Pk_Claim_Notes" SortExpression="Pk_Claim_Notes">
                                <ItemStyle CssClass="cols" />
                                <ItemTemplate>
                                    <asp:Label ID="Pk_Claim_Notes" runat="server" Text='<%# Bind("Pk_Claim_Notes") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
