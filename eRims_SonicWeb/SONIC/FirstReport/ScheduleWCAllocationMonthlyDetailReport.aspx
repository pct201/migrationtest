<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleWCAllocationMonthlyDetailReport.aspx.cs"
    Inherits="SONIC_FirstReport_ScheduleWCAllocationMonthlyDetailReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: WC Allocation Monthly Detail Report"</title>
</head>
        ...
        <table width="100%">
            <tr>
                <td align="left" class="ghc">
                    WC Allocation Monthly Detail Report 
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvYear" ControlToValidate="ddlYear" Display="None"
                                    SetFocusOnError="true" runat="server" InitialValue="0" Text="*" ErrorMessage="Please select Year."></asp:RequiredFieldValidator>
                            </td>
                            <td align="left">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" style="width: 40%">
                                ...
                                <asp:RequiredFieldValidator ID="rfvMonth" ControlToValidate="ddlMonth" Display="None"
                                    SetFocusOnError="true" runat="server" InitialValue="0" Text="*" ErrorMessage="Please select Month."></asp:RequiredFieldValidator>
                            </td>
                            <td align="left">
                            </td>
                        </tr>
