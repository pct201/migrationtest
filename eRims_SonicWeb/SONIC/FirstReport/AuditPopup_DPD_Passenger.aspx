<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_DPD_Passenger.aspx.cs" Inherits="SONIC_FirstReport_AuditPopup_DPD_Passenger" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: DPD_FR_Injured_Passenger Audit Trail</title>
</head>
...
<body>
    <form id="form1" runat="server">
        <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 600px;" id="divDPD_FR_Injured_Passenger_Header" runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 220px">PK_DPD_FR_Injured_Passenger_id</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 130px">FK_DPD_FR_ID</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px">FK_DPD_FR_Vehicle_ID</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px">Zip_Code</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 130px">phone</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 130px">injured</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divDPD_FR_Injured_Passenger_Grid"
                        runat="server">
                        <asp:GridView ID="gvDPD_FR_Injured_Passenger" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_DPD_FR_Injured_Passenger_id" SortExpression="PK_DPD_FR_Injured_Passenger_id">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="PK_DPD_FR_Injured_Passenger_id" runat="server" Text='<%# Bind("PK_DPD_FR_Injured_Passenger_id") %>'
                                ...
                                <asp:TemplateField HeaderText="FK_DPD_FR_ID" SortExpression="FK_DPD_FR_ID">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="FK_DPD_FR_ID" runat="server" Text='<%# Bind("FK_DPD_FR_ID") %>'
                                            Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="FK_DPD_FR_Vehicle_ID" SortExpression="FK_DPD_FR_Vehicle_ID">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="FK_DPD_FR_Vehicle_ID" runat="server" Text='<%# Bind("FK_DPD_FR_Vehicle_ID") %>' Width="150px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="name" SortExpression="name">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="name" runat="server" Text='<%# Bind("name") %>' Width="150px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Zip_Code" SortExpression="Zip_Code">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Zip_Code" runat="server" Text='<%# Bind("Zip_Code") %>' Width="150px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="phone" SortExpression="phone">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="phone" runat="server" Text='<%# Bind("phone") %>' Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="injured" SortExpression="injured">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="injured" runat="server" Text='<%# clsGeneral.FormatYesNoToDisplayForView(Eval("injured")) %>' Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
