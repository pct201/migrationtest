...
public partial class SONIC_FirstReport_AuditPopup_IncidentInvolvement : clsBasePage
{
    # region " Properties "
    ...
    private void BindNonCustomer_Audit()
    {
        ...
        lbltable_Name.Text = "Incident Involvement";
        // Fill grid with audit table
        dt = AuditTrail.GetIncidentInvolvement_AuditTrial(PK).Tables[0];
