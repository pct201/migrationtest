<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_Property_FR_Witness.aspx.cs" Inherits="SONIC_FirstReport_AuditPopup_Property_FR_Witness" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Property_FR_Witness Audit Trail</title>
</head>
...
<body>
    <form id="form1" runat="server">
        <table width="100%" align="left">
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 600px;" id="divProperty_FR_Witness_Header" runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">PK_Property_FR_Witness_ID</span>
                                    </th>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divProperty_FR_Witness_Grid"
                        runat="server">
                        <asp:GridView ID="gvProperty_FR_Witness" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_Executive_Risk_Contacts" SortExpression="PK_Property_FR_Witness_ID">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="PK_Property_FR_Witness_ID" runat="server" Text='<%# Bind("PK_Property_FR_Witness_ID") %>'
                                ...
                                <asp:TemplateField HeaderText="Name" SortExpression="Name">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Name" runat="server" Text='<%# Bind("Name") %>' Width="130px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
