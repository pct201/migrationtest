...
public partial class SONIC_FirstReport_ScheduleWCAllocationMonthlyDetailReport : clsBasePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            Tatva_RptWCAllocationMonthlyDetailReport obj = new Tatva_RptWCAllocationMonthlyDetailReport();

            //Report Filters
            obj.Year = ddlYear.SelectedIndex > 0 ? Convert.ToInt32(ddlYear.SelectedValue) : 0;
            obj.Month = ddlMonth.SelectedIndex > 0 ? Convert.ToInt32(ddlMonth.SelectedValue) : 0;
