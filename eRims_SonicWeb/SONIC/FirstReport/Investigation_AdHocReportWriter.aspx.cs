...
public partial class SONIC_FirstReport_Investigation_AdHocReportWriter : clsBasePage
{
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(strFilePath))
        {
            try
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "Investigation Ad-Hoc Report.xls"));
    ...
    protected void lnkSendEmail_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(strFilePath))
        {
            if (clsGeneral.SendAdHocReport("Ad Hoc Report", strFilePath, "Investigation Ad-Hoc Report.xls", Convert.ToDecimal(ddlRecipientList.SelectedItem.Value)))
