                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">Loss Category – Other Description</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <%-- 3381 --%>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">Conditions_Of_Area</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">Visible_Impairments</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">Describe_Impairments</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">Lighting_Conditions</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 180px">Describe_Lighting</span>
                                    </th>
                                    <%-- 3381 --%>
                                    <th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divPL_FR_Audit_Grid"
                        ...
                        <asp:GridView ID="gvPL_FR_Audit" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Loss_Category" SortExpression="LU_Loss_Category_Description">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="LU_Loss_Category_Description" runat="server" Text='<%# Eval("LU_Loss_Category_Description") %>'
                                            Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Loss Category – Other Description" SortExpression="Loss_Category">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                ...
                                <%-- 3381 --%>
                                <asp:TemplateField HeaderText="Conditions_Of_Area" SortExpression="Conditions_Of_Area">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Conditions_Of_Area" runat="server" Text='<%# Eval("Conditions_Of_Area") %>'
                                            Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Visible_Impairments" SortExpression="Visible_Impairments">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Visible_Impairments" runat="server" Text='<%# Eval("Visible_Impairments") %>'
                                            Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Describe_Impairments" SortExpression="Describe_Impairments">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Describe_Impairments" runat="server" Text='<%# Eval("Describe_Impairments") %>'
                                            Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Describe_Impairments" SortExpression="Lighting_Conditions">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Lighting_Conditions" runat="server" Text='<%# Eval("Lighting_Conditions") %>'
                                            Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Describe_Lighting" SortExpression="Describe_Lighting">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Describe_Lighting" runat="server" Text='<%# Eval("Describe_Lighting") %>'
                                            Width="180px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%-- 3381 --%>
