<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleWCAllocationDetailReport.aspx.cs"
    Inherits="SONIC_FirstReport_ScheduleWCAllocationDetailReport" %>
                    ...
                    <table cellpadding="3" cellspacing="0" border="0" align="left" style="width: 70%">
                        <tr>
                            ...
                            <td align="center" style="width: 4%">
                                :</td>
                            <td align="left">
                                <asp:DropDownList runat="Server" ID="ddlYear" SkinID="dropGen"
                                    Width="150px">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td align="center" style="width: 4%">
                                :</td>
                            <td align="left">
                                <asp:DropDownList runat="Server" ID="ddlMonth" SkinID="dropGen"
                                    Width="150px">
