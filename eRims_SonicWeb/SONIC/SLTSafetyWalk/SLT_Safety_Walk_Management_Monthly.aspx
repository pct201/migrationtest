<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
	CodeFile="SLT_Safety_Walk_Management_Monthly.aspx.cs" Inherits="SONIC_SLT_Safety_Walk_SLT_Safety_Walk_Management_Monthly" %>
				...
				<td>
					<asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSave">
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							<tbody>
								<tr>
									<td colspan="2"><span class="heading">SLT Safety Walk Question Management - Monthly</span>
									</td>
								</tr>
								<tr>
									<td colspan="2">&nbsp;</td>
						...
						<tbody>
							<tr>
								<td style="height: 24px" align="center">
									<asp:Button ID="btnSave" runat="server" Text="Save" CausesValidation="true" ToolTip="Save" OnClick="btnSave_Click"
										ValidationGroup="vsSearch"></asp:Button>&nbsp;&nbsp;&nbsp;
