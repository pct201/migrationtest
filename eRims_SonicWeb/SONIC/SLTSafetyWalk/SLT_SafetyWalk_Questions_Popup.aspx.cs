...
public partial class SONIC_SLTSafetyWalk_SLT_SafetyWalk_Questions_Popup : clsBasePage
{
    #region Properties
    ...
    {
        ComboHelper.FillSLT_DepartmentObserved(new ListBox[] { lstDepartments });

        //DataSet dsSLTMembers = SLT_Members.SelectBY_FK_SLT_Safety_Walk(FK_SLT_Safety_Walk);
        DataSet dsSLTMembers = SLT_Members.SLT_MembersSelectByFk(PK_SLT_Meeting, 0, PK_SLT_Meeting_Schedule);
        if (dsSLTMembers != null)
        {
            DataTable dtSLTMembers = dsSLTMembers.Tables[0];
    ...
    {
        DataSet dsQuestions = LU_SLT_Safety_Walk_Focus_Area.SelectByMonthAndYear(Year, Month, 0, PK_SLT_Meeting_Schedule);
        ...
        if (dsQuestions != null)
        {
            if (dsQuestions.Tables.Count > 0)
            {
                ...
                LU_SLT_Safety_Walk_Focus_Area objFocusArea;
                if (PK_LU_SLT_Safety_Walk_Focus_Area > 0)
                    objFocusArea = new LU_SLT_Safety_Walk_Focus_Area(PK_LU_SLT_Safety_Walk_Focus_Area);
                else
                    objFocusArea = new LU_SLT_Safety_Walk_Focus_Area(Convert.ToDecimal(dsQuestions.Tables[0].Rows[0]["PK_LU_SLT_Safety_Walk_Focus_Area"]));
        ...
        DataSet dsOtherInfo = LU_SLT_Safety_Walk_Focus_Area.SelectByMonthAndYear(Year, Month, PK_LU_SLT_Safety_Walk_Focus_Area, PK_SLT_Meeting_Schedule);
        if (dsOtherInfo != null)
        {
            if (dsOtherInfo.Tables.Count > 0)
            {
                ...
                {
                    if (!string.IsNullOrEmpty(dtOtherInfo.Rows[0]["PK_SLT_Safety_Walk_Responses"].ToString()))
                        hdnPK_SLT_Safety_Walk_Responses.Value = dtOtherInfo.Rows[0]["PK_SLT_Safety_Walk_Responses"].ToString();
                    else
                        hdnPK_SLT_Safety_Walk_Responses.Value = "0";
                    ...
                    if (!string.IsNullOrEmpty(dtOtherInfo.Rows[0]["PK_SLT_Safety_Walk_Responses"].ToString()))
                    {
                        DataSet dsDepartment = SLT_Safety_Walk_Responses_Departments.SelectBy_FK_SLT_Safety_Walk_Responses(Convert.ToDecimal(dtOtherInfo.Rows[0]["PK_SLT_Safety_Walk_Responses"]));
                        if (dsDepartment.Tables[0].Rows.Count > 0)
                        {
                            foreach (DataRow drDepartment in dsDepartment.Tables[0].Rows)
                            {
                                ...
                                {
                                    if (lstDepartmentName.Value == drDepartment["FK_LU_SLT_Safety_Walk_Department"].ToString())
                                    {
    ...
    public void BindControlsForView()
    {
        ...
        if (dsOtherInfo != null)
        {
            if (dsOtherInfo.Tables.Count > 0)
            {
                DataTable dtOtherInfo = dsOtherInfo.Tables[0];
                if (!string.IsNullOrEmpty(dtOtherInfo.Rows[0]["PK_SLT_Safety_Walk_Responses"].ToString()))
                    hdnPK_SLT_Safety_Walk_ResponsesView.Value = dtOtherInfo.Rows[0]["PK_SLT_Safety_Walk_Responses"].ToString();
                else
                    hdnPK_SLT_Safety_Walk_ResponsesView.Value = "0";
                if (!string.IsNullOrEmpty(dtOtherInfo.Rows[0]["FK_SLT_Members"].ToString()))
    ...
    {
        if (hdnPK_SLT_Safety_Walk_Responses.Value != "")
        {
            if (hdnPK_SLT_Safety_Walk_Responses.Value != "0")
            {
                DataTable dtAttach = SLT_Safety_Walk_Attachments.SelectByFK(Convert.ToDecimal(hdnPK_SLT_Safety_Walk_Responses.Value)).Tables[0];
    ...
    {
        if (hdnPK_SLT_Safety_Walk_ResponsesView.Value != "0")
        {
            DataTable dtAttach = SLT_Safety_Walk_Attachments.SelectByFK(Convert.ToDecimal(hdnPK_SLT_Safety_Walk_ResponsesView.Value)).Tables[0];
    ...
    protected void gvSLT_Questions_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("SLT_SafetyWalk_Questions_Popup.aspx?id=" + Encryption.Encrypt(Convert.ToString(e.CommandArgument)) + "&FK_SLTID= " + FK_SLT_Safety_Walk + "&Year=" + Encryption.Encrypt(Convert.ToString(Year)) + "&Month=" + Encryption.Encrypt(Convert.ToString(Month)) + "&PK_SLT_Meeting=" + PK_SLT_Meeting.ToString() + "&PK_MSID=" + PK_SLT_Meeting_Schedule + "&AM_date=" + Actual_Meeting_Date + "&op=" + StrOperation, true);
        }
    }
    protected void gvSLT_Questions_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            {
                if (Convert.ToDecimal(lnkReference.CommandArgument) == PK_LU_SLT_Safety_Walk_Focus_Area)
    ...
    //protected void rblGuidanceView_SelectedIndexChanged(object sender, EventArgs e)
    //{
    //    if (rblGuidanceView.SelectedValue == "N")
    //        pnlrblGuidanceView.Visible = false;
    //    else
    //        pnlrblGuidanceView.Visible = true;
    //}
    //protected void rblObservationView_SelectedIndexChanged(object sender, EventArgs e)
    //{
    //    if (rblObservationView.SelectedValue == "N")
    //    {
    //        rblPictureDocView.SelectedValue = "N";
    //        pnlrblPictureDocView.Visible = false;
    //        pnlrblObservationView.Visible = false;
    //    }
    //    else
    //    {
    //        rblPictureDocView.SelectedValue = "Y";
    //        pnlrblPictureDocView.Visible = true;
    //        pnlrblObservationView.Visible = true;
    //    }
    //}
    //protected void rblPictureDocView_SelectedIndexChanged(object sender, EventArgs e)
    //{
    //    if (rblPictureDoc.SelectedValue == "N")
    //        pnlrblPictureDocView.Visible = false;
    //    else
    ...
    protected void gvFocusAreaAttachmentEdit_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "RemoveAttachment")
        {
            ...
            SLT_Safety_Walk_Attachments.Delete(intPK);
            BindGridAttachmentsFocusArea();
    ...
    protected void UploadFocusArea_Attachment()
    {
        try
        {
            ...
            {
                // add attachment
                ucInspectionFocusAreaAttachment.FK_SLT_Safety_Walk_Responses = Convert.ToInt32(hdnPK_SLT_Safety_Walk_Responses.Value);
                ucInspectionFocusAreaAttachment.Add(clsGeneral.Exposure_Tables.SLT_Safety_Walk_Attachments);
            ...
            {
                clsGeneral.ShowAlert("Please Save First SLT Safety Walk Responses Details.", this);
                return;
            }
        }
        catch (Exception ex)
    ...
    protected void UploadFocusArea2_Attachment()
    {
        ...
        {
            // add attachment
            ucInspectionFocusAreaAttachment2.FK_SLT_Safety_Walk_Responses = Convert.ToInt32(hdnPK_SLT_Safety_Walk_Responses.Value);
            ucInspectionFocusAreaAttachment2.Add(clsGeneral.Exposure_Tables.SLT_Safety_Walk_Attachments);
            trAttachmentFA.Style["display"] = "none";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            TextBox txtAttachmentDesc = (TextBox)ucInspectionFocusAreaAttachment2.FindControl("txtType");
            FileUpload fpFile = (FileUpload)ucInspectionFocusAreaAttachment2.FindControl("fpFile");
            ...
            else
            {
                ...
                if (Actual_Meeting_Date != null)
                {
                    ...
                    decimal PK_SLT_Safety_Walk_Responses;
                    objRes.FK_SLT_Safety_Walk = FK_SLT_Safety_Walk;
                    objRes.FK_LU_SLT_Safety_Walk_Focus_Area = PK_LU_SLT_Safety_Walk_Focus_Area;
                    ...
                    if (!string.IsNullOrEmpty(hdnPK_SLT_Safety_Walk_Responses.Value))
                    {
                        if (hdnPK_SLT_Safety_Walk_Responses.Value != "0")
                        {
                            objRes.PK_SLT_Safety_Walk_Responses = Convert.ToDecimal(hdnPK_SLT_Safety_Walk_Responses.Value);
                            PK_SLT_Safety_Walk_Responses = Convert.ToDecimal(hdnPK_SLT_Safety_Walk_Responses.Value);
                            objRes.Update();
                        }
                        else
                        {
                            PK_SLT_Safety_Walk_Responses = objRes.Insert();
                            hdnPK_SLT_Safety_Walk_Responses.Value = Convert.ToString(PK_SLT_Safety_Walk_Responses);
                        }
                    }
                    else
                    {
    ...
    protected void btnSaveAndNext_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                Page.ClientScript.RegisterStartupScript(Page.GetType(), DateTime.Now.ToString(), "javascript:alert('Error occured while saving your data.');", true);
            }
        }
    }
        ...
        try
        {
            ...
            else
            {
                ...
                if (Actual_Meeting_Date != null)
                {
                    ...
                    BindControls2();
                    //if (attachmentrow == "1")
                    //    trAttachmentFA.Style["display"] = "";
                    //else if (attachmentrow == "2")
                    //    trAttachmentFA2.Style["display"] = "";
                    //else
                    //    trAttachmentFA.Style["display"] = "";
                    if (attachmentrow == "1")
                    {
