...
public partial class SONIC_SLTSafetyWalk_SLT_Safety_Walk_Management_Annual : clsBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                DataSet dsMonthlyQuestions = LU_SLT_Safety_Walk_Focus_Area.Search(Year, "",true, "Sort_Order", "ASC", 1, 10);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (PK_LU_SLT_Safety_Walk_Focus_Area > 0)
        {
            ...
            ReturnVal = objSSWFA.UpdateAnnual();
        }
        else
            ReturnVal = objSSWFA.InsertAnnual();
        ...
        if (ReturnVal == -1)
        {
            ...
            Response.Redirect("SLT_Safety_Walk_Management_Annual_Grid.aspx?Year=" + Encryption.Encrypt(Convert.ToString(Year)) , true);
    }
