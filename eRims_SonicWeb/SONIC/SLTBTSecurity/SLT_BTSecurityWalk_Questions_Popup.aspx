<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SLT_BTSecurityWalk_Questions_Popup.aspx.cs" Inherits="SONIC_SLT_BTSecurityWalk_Questions_Popup" %>
...
<head id="Head1" runat="server">
    <title>SLT BT Security Walk Questions</title>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowAttachmentFA() {
                var pk = document.getElementById('<%= hdnPK_SLT_BTSecurity_Walk_Responses.ClientID %>').value;
            ...
            if (pk > 0) {
                ...
                //document.getElementById('<%=trAttachmentFA.ClientID%>').style.display = "";
                alert("Please select/enter the BT Security Walk Response details");
            }
        ...
        function SaveRecord() {
            ...
            window.opener.document.getElementById('ctl00_ContentPlaceHolder1_btnhdnBTSecurityReload').click();
            self.close();
            return false;
        }
            ...
            <asp:Panel ID="pnl" runat="server">
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tbody>
                        ...
                        <tr>
                            <td class="ghc">SLT BT Security Walk Questions for
                                                        ...
                                                        <tr style="background-color: lightgray; font-family: Tahoma; color: #3366FF; font-size: 8pt; font-weight: bold;">
                                                            <td style="background-color: lightgray;">
                                                                <asp:LinkButton ID="lnkReference" runat="server" Text='<%#Eval("QuestionNumber")%>' CommandName="Edit"
                                                                    CommandArgument='<%#Eval("PK_LU_SLT_BT_Security_Walk_Focus_Area") %>' ForeColor="#3366FF" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                ...
                                <table cellpadding="2" cellspacing="2" border="0" width="100%" style="border: 2px solid black;">
                                    ...
                                    <asp:Panel ID="pnlAttachment" runat="server">
                                                ...
                                                <asp:GridView ID="gvFocusAreaAttachmentEdit" runat="server" Width="100%" OnRowDataBound="gvFocusAreaAttachement_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Remove" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemStyle Width="30%" />
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkRemoveAttachment" runat="server" Text="Remove" CommandArgument='<%#Eval("PK_SLT_BT_Security_Walk_Attachments") + ":" + Eval("Attachment_Filename") %>'
                                        ...
                                        <tr id="trAttachmentFA" runat="server" visible="false" >
                                            <td align="left" colspan="6">
                                                <uc:ctrlAttachment runat="server" ID="ucBTsecurityFocusAreaAttachment" OnFileSelection="UploadFocusArea_Attachment" />
                                            </td>
                                        </tr>

                                    </asp:Panel>
                                    <asp:HiddenField ID="hdnPK_SLT_BTSecurity_Walk_Responses" runat="server" />
                                    <asp:Panel ID="pnlNeedtoBeDone" runat="server">
                                        ...
                                        <asp:Panel ID="pnlAttachment2" runat="server">
                                            ...
                                            <tr id="trAttachmentFA2" runat="server" visible="false" >
                                                <td align="left" colspan="6">
                                                    <uc:ctrlAttachment runat="server" ID="ucBTsecurityFocusAreaAttachment2" OnFileSelection="UploadFocusArea2_Attachment"/>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                                        <tr style="background-color: #7f7f7f; font-family: Tahoma; color: white; font-size: 8pt; font-weight: bold;">
                                                            <td style="background-color: #7f7f7f;">
                                                                <asp:LinkButton ID="lnkReference" runat="server" Text='<%#Eval("QuestionNumber")%>' CommandName="Edit"
                                                                    CommandArgument='<%#Eval("PK_LU_SLT_BT_Security_Walk_Focus_Area") %>' ForeColor="White" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                            ...
                            <td>
                                <table cellpadding="2" cellspacing="2" border="0" width="100%" style="border: 2px solid black;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 4%" align="center" valign="top">: </td>
                                        <td style="width: 33%" align="left">
                                            <asp:HiddenField ID="hdnPK_SLT_BTSecurity_Walk_ResponsesView" runat="server" />
