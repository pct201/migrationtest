...
public partial class SONIC_SLT_BT_Security_Management_Monthly_Grid : clsBasePage
{
    ...
    {
        DataSet dsMonthlyQuestions = clsLU_SLT_BT_Security_Walk_Focus_Area.Search(Year, Month, false, SortBy, SortOrder, PageNumber, PageSize);
    ...
    protected void gvMonthlyQuestions_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                DataSet dsMonthlyQuestions = clsLU_SLT_BT_Security_Walk_Focus_Area.Search(Year, Month, false, SortBy, SortOrder, ctrlPageMonthlyQue.CurrentPage, ctrlPageMonthlyQue.PageSize);
    ...
    protected void gvMonthlyQuestions_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("SLT_BTSecurity_Walk_Management_Monthly.aspx?id=" + Encryption.Encrypt(Convert.ToString(e.CommandArgument)) + "&Year=" + Encryption.Encrypt(Convert.ToString(Year)) + "&Month=" + Encryption.Encrypt(Convert.ToString(Month)), true);
        }
        if (e.CommandName == "up")
        {
            clsLU_SLT_BT_Security_Walk_Focus_Area.UpdateSortOrder_Monthly(Convert.ToDecimal(e.CommandArgument), e.CommandName);
            BindGrid(ctrlPageMonthlyQue.CurrentPage, ctrlPageMonthlyQue.PageSize);
        }
    ...
    {
        Response.Redirect("SLT_BTSecurity_Walk_Management_Monthly.aspx?id=" + Encryption.Encrypt("0") +"&Year=" + Encryption.Encrypt(Convert.ToString(Year)) + "&Month=" + Encryption.Encrypt(Convert.ToString(Month)), true);
    }
