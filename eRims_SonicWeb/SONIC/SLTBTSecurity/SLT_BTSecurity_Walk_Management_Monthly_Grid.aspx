<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="SLT_BTSecurity_Walk_Management_Monthly_Grid.aspx.cs" Inherits="SONIC_SLT_BT_Security_Management_Monthly_Grid" %>
                    ...
                    <tr>
                        <td width="45%">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td align="left"><span class="heading">SLT BT Security Walk Question Management - Monthly</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">&nbsp;
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td width="100%" colspan="7" valign="top">
                            <asp:GridView ID="gvMonthlyQuestions" runat="server" DataKeyNames="PK_LU_SLT_BT_Security_Walk_Focus_Area"
                                    ...
                                    <asp:TemplateField HeaderText="Sorter">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton runat="server" ID="imgDown" ImageUrl="~/Images/arrow_down.png"
                                                CommandName="down" CommandArgument='<%# Eval("PK_LU_SLT_BT_Security_Walk_Focus_Area") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
