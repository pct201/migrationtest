...
using ERIMS.DAL;
public partial class SONIC_SLTBT_Security_EditFocusArea : clsBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DataSet dsMonthlyQuestions = clsLU_SLT_BT_Security_Walk_Focus_Area.Search(Year, Month, IsAnnual, "Sort_Order", "ASC", 1, 10);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (txtFocusArea.Text != "")
            clsLU_SLT_BT_Security_Walk_Focus_Area.EditFocusArea(Year, Month, Convert.ToString(txtFocusArea.Text), IsAnnual);
