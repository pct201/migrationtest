<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
	CodeFile="SLT_BTSecurity_Walk_Management_Annual_Grid.aspx.cs" Inherits="SONIC_SLT_BTSecurity_Walk_Management_Annual_Grid" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<table cellpadding="0" cellspacing="0" width="99%" align="center">
					...
					<tr>
						<td width="45%">
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									<td align="left"><span class="heading">SLT BT Security Walk Question Management - Annual</span>
									</td>
								</tr>
								<tr>
									<td align="left">&nbsp;
										<asp:Label ID="lblNumber" runat="server" Text="0"></asp:Label>&nbsp;Annual Question(s)
										Found </td>
								</tr>
							</table>
						</td>
						<td valign="top" align="right">
							<uc:ctrlPaging ID="ctrlPageAnnualQue" runat="server" OnGetPage="GetPage" />
						</td>
					</tr>
				</table>
			</td>
        ...
        <tr>
            <td><a id="ahrefEditFocusArea" href="#" runat="server" onclick="OpenEditFocusArea();">Edit Focus Area</a></td>
		...
		<tr>
			<td>
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td width="100%" colspan="7" valign="top">
							<asp:GridView ID="gvAnnualQuestions" runat="server" DataKeyNames="PK_LU_SLT_BT_Security_Walk_Focus_Area"
								AutoGenerateColumns="false" Width="100%" AllowSorting="True" OnSorting="gvAnnualQuestions_Sorting"
								OnRowCommand="gvAnnualQuestions_RowCommand" OnRowDataBound="gvAnnualQuestions_RowDataBound">
								<Columns>
									<asp:TemplateField HeaderText="Focus Area" SortExpression="Focus_Area">
										...
										<ItemTemplate>
											<asp:LinkButton ID="lnkFocus_Area" runat="server" Text='<%#Eval("Focus_Area")%>'
												CommandName="Edit" CommandArgument='<%#Eval("PK_LU_SLT_BT_Security_Walk_Focus_Area") %>' />
												<asp:HiddenField ID="hdnIntMonth" runat="server" Value ='<%#Eval("intMonth")%>' />
										</ItemTemplate>
									</asp:TemplateField>
									<asp:TemplateField HeaderText="Month Sort" SortExpression="Sort_Order">
										<ItemStyle HorizontalAlign="Left" Width="10%" />
										<ItemTemplate>
											<asp:LinkButton ID="lnkSort_Order" runat="server" Text='<%#Eval("Month")%>'
												CommandName="Edit" CommandArgument='<%#Eval("PK_LU_SLT_BT_Security_Walk_Focus_Area") %>' />
										</ItemTemplate>
									</asp:TemplateField>
									<asp:TemplateField HeaderText="Sorter">
										...
										<ItemTemplate>
											<asp:ImageButton runat="server" ID="imgUp" ImageUrl="~/Images/arrow_up.png" CommandName="up"
												CommandArgument='<%# Eval("PK_LU_SLT_BT_Security_Walk_Focus_Area") %>' />
											<asp:ImageButton runat="server" ID="imgDown" ImageUrl="~/Images/arrow_down.png" CommandName="down"
												CommandArgument='<%# Eval("PK_LU_SLT_BT_Security_Walk_Focus_Area") %>' />
										</ItemTemplate>
									</asp:TemplateField>
