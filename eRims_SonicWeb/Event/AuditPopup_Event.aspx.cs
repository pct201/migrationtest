...
public partial class Event_AuditPopup_Event : System.Web.UI.Page
{
    #region " Properties "
    ...
    private void BindManagement()
    {
        ...
        dt = Audit_Trail.GetEvent_AuditTrail(PK).Tables[0];
        ...
        if (dt.Rows.Count > 0)
        {
            // set Grid view div height and width on client side. 
            ...
            // set Grid view div Scroll bar events so Scroll Header as per grid scroll
