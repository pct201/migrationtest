<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="RptNetWorkCallSummary.aspx.cs"
    Inherits="ERReports_NetWorkCallSummary" Title="eRIMS Sonic :: Network Call Summary Report" %>
                                                            ...
                                                            <table cellpadding="4" cellspacing="0" width="100%" style="font-weight: bold;" id="tblHeader"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 150px;">
                                                                        <asp:Label ID="Label1" runat="server" Width="150px" Text='Store/Facility' />
                                                                    </td>
                                                                    <td style="width: 300px;">
                                                                        <asp:Label ID="Label7" runat="server" Width="300px" Text='Claim Description' />
                                                                    </td>
                                                                    <td style="width: 300px;">
                                                                        <asp:Label ID="Label6" runat="server" Width="300px" Text='Claim Status/Comments' />
                                                                    </td>
                                                                    <td style="width: 150px;">
                                                                        <asp:Label ID="Label8" runat="server" Width="150px" Text='HR Contact Name' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="gvClaimData" runat="server" ShowHeader="false" Width="100%" OnRowDataBound="gvClaimData_RowDataBound"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl15" runat="server" Width="120px" Text='<%#Eval("Claim_Open_Date") != DBNull.Value ? clsGeneral.FormatDateToDisplay(Convert.ToDateTime(Eval("Claim_Open_Date"))) : ""%>' />
                                                                        </ItemTemplate>
                                                                        <FooterTemplate>
                                                                            Total
                                                                        </FooterTemplate>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl3" runat="server" Width="300px" Text='<%#Eval("Claim_Description")%>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField>
                                                                        <ItemStyle Width="300px" HorizontalAlign="left" />
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemStyle Width="150px" HorizontalAlign="left" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl6" runat="server" Width="150px" Text='<%# Eval("Contact_Name")%>' /></ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
                                                        </td>
                                                        ...
                                                        <td width="100%" align="left">
                                                            <table cellpadding="4" cellspacing="0" width="100%" style="font-weight: bold; color: White;"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 150px;">
                                                                        <asp:Label ID="Label9" runat="server" Width="150px" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
