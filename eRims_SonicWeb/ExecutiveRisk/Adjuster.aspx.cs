...
public partial class Liability_Adjuster : clsBasePage
{
    #region Variable
    ...
    {
        ExecutiveRiskInfo.SetSelectedTab(CtrlExecutiveRiskInfo.Tab.Adjustor_Notes);
    ...
    private void DisplayEmployeeInfo(string claimNO)
    {
        ...
        //lstClaimReservesInfo = m_objClaimReservesInfo.GetClaimInfoByClaimNo(claimNO, Convert.ToDecimal(clsSession.UserID));
        ...
        //    lblDateIncident.Text = Convert.ToDateTime(lstClaimReservesInfo[0].Date_Of_Loss).ToShortDateString();
        ...
        //    lblDOIncident.Text = Convert.ToDateTime(lstClaimReservesInfo[0].Date_Of_Loss).ToShortDateString();
        ...
        //    lblVDOInci.Text = Convert.ToDateTime(lstClaimReservesInfo[0].Date_Of_Loss).ToShortDateString();
    ...
    protected List<RIMS_Base.CAdjustor> BindAdjustorDetails()
    {
        ...
        try
        {
            ...
            {
                lstAdjustor = objAdjustor.SearchAdjustorData(ddlSearch.SelectedValue, txtSearch.Text.Trim().Replace("'", "''"), (ViewState["TableFK"] != null) ? Convert.ToDecimal(ViewState["TableFK"].ToString()) : 0, (ViewState["TableName"] != null) ? ViewState["TableName"].ToString() : "");
            }
            else
            {
                lstAdjustor = objAdjustor.SearchAdjustorData(null, null, (ViewState["TableFK"] != null) ? Convert.ToDecimal(ViewState["TableFK"].ToString()) : 0, (ViewState["TableName"] != null) ? ViewState["TableName"].ToString() : "");
            }
    ...
    protected void gvAdjustorDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    private void InsertUpdate()
    {
        ...
        objAdjustor.Updated_By = clsSession.UserID;
        objAdjustor.Update_Date = DateTime.Now;
    ...
    protected void gvAttachmentDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            {
                string strFilePath = "";
                strFilePath = m_strGlobalPath + (((ImageButton)e.Row.FindControl("imgbtnDwnld")).CommandArgument.ToString());
                strFilePath = Encryption.Encrypt(strFilePath).Replace("'", "\\'");
                ((ImageButton)e.Row.FindControl("imgbtnDwnld")).Attributes.Add("onclick", "javascript:return openWindow('" + AppConfig.SiteURL + "/Download.aspx?attachfile=" + strFilePath + "');");
    ...
    {
        DataTable dtFields = clsScreen_Validators.SelectByScreen(143).Tables[0];
        ...
        foreach (DataRow drField in dtFields.Rows)
        {
            ...
            switch (Convert.ToString(drField["Field_Name"]))
            {
                case "Date of Activity":
                    strCtrlsIDs += ((TextBox)fvAdjustorDetail.FindControl("txtDOActivity")).ClientID + ",";
                    strMessages += "Please enter [Adjustor Notes]/Date of Activity" + ",";
                    ((HtmlControl)fvAdjustorDetail.FindControl("Span1")).Style["display"] = "inline-block";
                    break;
                case "Date":
                    strCtrlsIDs += ((TextBox)fvAdjustorDetail.FindControl("txtDate")).ClientID + ",";
                    strMessages += "Please enter [Adjustor Notes]/Date" + ",";
                    ((HtmlControl)fvAdjustorDetail.FindControl("Span2")).Style["display"] = "inline-block";
                    break;
                case "Author":
                    strCtrlsIDs += ((TextBox)fvAdjustorDetail.FindControl("txtAuthor")).ClientID + ",";
                    strMessages += "Please enter [Adjustor Notes]/Author" + ",";
                    ((HtmlControl)fvAdjustorDetail.FindControl("Span3")).Style["display"] = "inline-block";
                    break;
                case "Note Type":
                    strCtrlsIDs += ((DropDownList)fvAdjustorDetail.FindControl("dwNoteType")).ClientID + ",";
                    strMessages += "Please select [Adjustor Notes]/Note Type" + ",";
                    ((HtmlControl)fvAdjustorDetail.FindControl("Span4")).Style["display"] = "inline-block";
                    break;
                case "Last Updated By":
                    strCtrlsIDs += ((TextBox)fvAdjustorDetail.FindControl("txtLastUpdateBy")).ClientID + ",";
                    strMessages += "Please enter [Adjustor Notes]/Last Updated By" + ",";
                    ((HtmlControl)fvAdjustorDetail.FindControl("Span5")).Style["display"] = "inline-block";
                    break;
                case "Notes":
                    strCtrlsIDs += ((TextBox)fvAdjustorDetail.FindControl("txtNote")).ClientID + ",";
                    strMessages += "Please enter [Adjustor Notes]/Notes" + ",";
                    ((HtmlControl)fvAdjustorDetail.FindControl("Span6")).Style["display"] = "inline-block";
                    break;
            }
