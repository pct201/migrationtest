...
public partial class ExecutiveRisk_AuditPopup_DefenseAttorney : clsBasePage
{
    # region " Properties "
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null && Request.QueryString["Table_Name"] != null)
            {
                ...
                if (Table_Name == "Defense_Attorney")
                    BindDefense_Attorney();
            }
        }
    }
    ...
    /// </summary>
    private void BindDefense_Attorney()
    {
        DataTable dt = new DataTable();

        // show Case Grid 
        divDefense_Attorney_Grid.Visible = true;
        lbltable_Name.Text = "Defense_Attorney";

        // Fill grid with audit table
        dt = AuditTrail.GetDefense_Attorney_AuditTrial(PK).Tables[0];
