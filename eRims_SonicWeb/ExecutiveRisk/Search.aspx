<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Diary_Search"
    MasterPageFile="~/Default.master" Title="eRIMS Sonic :: Diary Search"%>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td class="ic">
                                                ...
                                                <asp:RegularExpressionValidator ID="revPageNumber" runat="server" ErrorMessage="*" ControlToValidate="txtPageNo" Display="dynamic" ValidationExpression="^([0-9]*|\d*\d{1}?\d*)$" ValidationGroup="Paging"></asp:RegularExpressionValidator>
                                            </td>
                                            <td class="ic">
                                                <asp:Button ID="btnGo" runat="server" Text="Go" OnClick="btnGo_Click" ValidationGroup="Paging" CausesValidation="true"/></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvUser" AllowPaging="true" AllowSorting="True" runat="server" AutoGenerateColumns="false"
                        DataKeyNames="Pk_Assign_Id" Width="100%" OnSorting="gvUser_Sorting" EmptyDataText="No record exists">
                        <Columns>
