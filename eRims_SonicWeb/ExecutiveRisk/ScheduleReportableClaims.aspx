<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleReportableClaims.aspx.cs" Inherits="ExecutiveRisk_ScheduleReportableClaims" %>
                ...
                <td class="dvContent" align="left">
                    <table cellpadding="3" cellspacing="0" border="0" align="left" style="width: 70%">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox runat="server" ID="txtScheduleDate" Width="120px" SkinID="txtDate"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" width="166px">
                                <asp:TextBox runat="server" ID="txtScheduleEndDate" Width="120px" SkinID="txtDate"></asp:TextBox>
