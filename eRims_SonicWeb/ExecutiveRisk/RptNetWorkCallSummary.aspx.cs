...
public partial class ERReports_NetWorkCallSummary : clsBasePage
{
    #region "Variables"
    ...
    protected void lnkExport_Click(object sender, EventArgs e)
    {
        ...
        GridViewExportUtil.ExportGrid("Network_Call_Summary_Report.xlsx", gvReport, true);
    ...
    protected void gvReport_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            string strCellText = "FINPRO Network Call Summary Report<br />" + DateTime.Now.ToLongDateString() + " " + strTime + "<br/>";
