...
public partial class ERReports_LitigationSummary : clsBasePage
{
    #region "Variables"
    ...
    protected void btnGenerateReport_Click(object sender, EventArgs e)
    {
        ...
        DataSet dsReport = ERReports.Get_Litigation_Summary_Report(Start_Date, End_Date, drpRegion.SelectedValue, ddlMarket.SelectedValue);
    ...
    protected void gvClaimData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            // get the labels for "Summary of Issues" column and set text for that
            Label lblSummary = (Label)e.Row.FindControl("lblSummary");
            string strText = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Type_of_Allegation"));
            if (strText != "")
                strText = "<b>" + strText + ":</b> ";
            strText = strText + Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Claim_Description"));
            lblSummary.Text = strText;
