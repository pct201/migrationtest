<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_DefenseAttorney.aspx.cs"
    Inherits="ExecutiveRisk_AuditPopup_DefenseAttorney" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Defense_Attorney Audit Trail</title>
</head>
                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;">
                            <tbody>
                                <tr style="background-color: #95B3D7; color: White; font-size: 12px; font-weight: bold;"
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px">PK_Defense_Attorney</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 90px">Panel</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 500px">Notes</span>
                                    </th>
                                    <th class="cols">
                        ...
                        <asp:GridView ID="gvDefense_Attorney" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PK_Defense_Attorney" SortExpression="PK_Defense_Attorney">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="PK_Defense_Attorney" runat="server" Text='<%# Bind("PK_Defense_Attorney") %>'
                                ...
                                <asp:TemplateField HeaderText="Firm" SortExpression="Firm">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Firm" runat="server" Text='<%# Bind("Name") %>' Width="150px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Panel" SortExpression="Panel">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="Panel" runat="server" Text='<%# (Eval("Panel").ToString() == "Y") ? "Yes" : "No" %>'
