<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefenseAttorney.aspx.cs"
    Inherits="PropertyLiability_DefenseAttorney" MasterPageFile="~/Default.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="cnProperty_PropertyIdentification"
    ...
    <script type="text/javascript">
        ...
        function AuditPopUp() {
            ...
            obj = window.open("AuditPopup_DefenseAttorney.aspx?id=" + '<%=ViewState["PK_Defense_Attorney"]%>' + '&Table_Name=Defense_Attorney', 'AuditPopUp', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
        ...
        function OpenPopupAttorney() {
            var winHeight = 500;
            var winWidth = 900;

            obj = window.open("PopupDefenseAttorney.aspx?", 'AuditAttorney', 'width=' + winWidth + ',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');
            obj.focus();
            return false;
        }
                ...
                <table cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="left" width="100%">
                            <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Defense Attorney</span>&nbsp;<span id="MenuAsterisk1" runat="server" style="color: Red;display:none">*</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" width="100%">
                                    ...
                                    <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td align="left" width="28%">
                                                ...
                                                <asp:Button ID="btnPopUpAttorney" runat="server" Text="V" OnClientClick="OpenPopupAttorney();return false;" />
                                                <%--<asp:RequiredFieldValidator ID="rfvFirm" runat="server" ControlToValidate="txtFirm"
                                                    Display="none" Text="*" ErrorMessage="Please Enter [Defense Attorney]/Firm" SetFocusOnError="true"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:RegularExpressionValidator ID="revZipCode" ControlToValidate="txtZipCode" runat="server"
                                                    ValidationGroup="vsErrorGroup" ErrorMessage="Please Enter [Defense Attorney]/Zip Code in xxxxx-xxxx format."
                                            ...
                                            <td align="left">
                                               ...
                                               <asp:RegularExpressionValidator ID="revTelephone" ControlToValidate="txtTelephone"
                                                    runat="server" ValidationGroup="vsErrorGroup" ErrorMessage="Please Enter [Defense Attorney]/Telephone Number in xxx-xxx-xxxx format."
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail"
                                                    ValidationGroup="vsErrorGroup" Display="None" ErrorMessage="[Defense Attorney]/Email Address Is Invalid"
