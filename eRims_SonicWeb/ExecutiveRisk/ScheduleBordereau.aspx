<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleBordereau.aspx.cs"
    Inherits="ExecutiveRisk_ScheduleBordereau" %>
                    ...
                    <table cellpadding="3" cellspacing="0" border="0" align="left" style="width: 70%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <img alt="Date Opened" onclick="return showCalendar('txtEndDate', 'mm/dd/y');" onmouseover="javascript:this.style.cursor='hand';"
                                ...
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtEndDate"
                                    ...
                                    Operator="GreaterThanEqual" SetFocusOnError="true" Display="none"></asp:CompareValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
