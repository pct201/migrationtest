<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="Property_Claims_AdHocReportWriter.aspx.cs" Inherits="PropertyClaims_Property_Claims_AdHocReportWriter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        <%--function OPenSchedulePopup() {
            ...
            if (Page_ClientValidate('vsErrorGroup'))
                GB_showCenter('Schedule Ad Hoc Report Writer', '<%=AppConfig.SiteURL%>/Event/SchedulerptAdHocWriter.aspx', 300, 500, '');
            else {
    ...
    <div class="bandHeaderRow">
        Property Claims: Ad Hoc Report Writer</div>
                        ...
                        <td>
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drpGroupByThird" runat="server" Width="250px" EnableTheming="false">
