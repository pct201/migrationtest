...
<asp:Content ID="cntSubrogation" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
     function openProviderPopup()
        {
            oWnd=window.open("../Claim/ProviderPopup.aspx?page=WC","Erims","location=0,status=0,scrollbars=1,menubar=0,resizable=1,toolbar=0,width=980,height=500");
            //oWnd=window.open("../Claim/temp.aspx","Erims1","location=0,status=0,scrollbars=1,menubar=0,resizable=1,toolbar=0,width=700,height=450");
            oWnd.moveTo(10,20);
            self.close;
            return false;
        }
        ...
        function OpenWMail(grdName,attTbl)
{
    ...
    <div id="contmain" runat="server" style="width: 100%;">
        ...
        <div id="mainContent" runat="server" style="border: solid 1px #7F7F7F; width: 79%;
           ...
           <asp:HiddenField ID="add1" runat="server" />
           <asp:HiddenField ID="add2" runat="server" />
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <asp:GridView ID="gvSubrogation" runat="server" AutoGenerateColumns="false" OnRowCommand="gvSubrogation_RowCommand"
                                                    ...
                                                    OnRowDataBound="gvSubrogation_RowDataBound" AllowPaging="True" AllowSorting="True"
                                                    OnSorting="gvSubrogation_Sorting" OnRowCreated="gvSubrogation_RowCreated">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Date Of Transaction" HeaderStyle-HorizontalAlign="Right"
                                                            ItemStyle-HorizontalAlign="Right" SortExpression="Update_Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblDOTransaction" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Update_Date", "{0:MM/dd/yyyy}")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Check Amount $" HeaderStyle-HorizontalAlign="Right"
                                                            ItemStyle-HorizontalAlign="Right" SortExpression="Check_Amount">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCheckAmt" runat="server" Text='<%#Eval("Check_Amount")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Check_Number" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Check Number" SortExpression="Check_Number"></asp:BoundField>
                                                        <asp:TemplateField HeaderText="Subrogation" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                                            SortExpression="Subrogation">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSubrogation" runat="server" Text='<%#Eval("Subrogation")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField HeaderText="Payment" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                                            DataField="Payment_Id" SortExpression="Payment_Id" />
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:UpdatePanel ID="pnlprovider" runat="server">
                                                    <triggers>
                                                    <asp:PostBackTrigger ControlID="fvSubrogation_btnAddAttachment" />
                                                </triggers>
                                                    <contenttemplate>
                                                        ...
                                                        <table border="0" cellpadding="2" cellspacing="2" class="lc" width="100%">
                                                            ...
                                                            <tr>
                                                               ...
                                                               <%--  <asp:UpdatePanel ID="pnlprovider" runat="server">
                                                                   <contenttemplate>--%>
                                                                <td align="left"  class="ic" style="width: 25%">
                                                                    <asp:TextBox id="txtProvider" runat="server" onkeydown="javascript:return disableDeleteBackSpace();" ></asp:TextBox>
                                                                    <asp:Button id="btnname" runat="server" Text="V" OnClientClick="javascript:return openProviderPopup();"></asp:Button>
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvProviderName" ControlToValidate="txtProvider"
                                                                        ErrorMessage="Please Select Provider Name." Display="none" Text="*" InitialValue=""
                                                    ...
                                                    <EditItemTemplate>
                                                        <table border="0" cellpadding="2" cellspacing="2" class="lc" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left"  class="ic" style="width: 25%">
                                                                    <asp:TextBox id="txtProvider" runat="server" Text='<%#Eval("Name") %>' onkeydown="javascript:return disableDeleteBackSpace();" ></asp:TextBox>
                                                                    <asp:Button id="btnname" runat="server" Text="V" OnClientClick="javascript:return openProviderPopup();"></asp:Button>
                                                                     <div id="Div2" runat="server" style="display: none">
                                                                    <asp:TextBox id="txtPId" runat="server" Text='<%#Eval("PK_Provider_ID") %>'  ></asp:TextBox>
                                                                    </div>
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvProviderName" ControlToValidate="txtProvider"
                                                                        ErrorMessage="Please Select Provider Name." Display="none" Text="*" InitialValue=""
                                                                        ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                ...
                                                <asp:Button ID="fvSubrogation_btnAddAttachment" runat="server" BackColor="Transparent" BorderColor="Transparent" BorderStyle="None"     Enabled="False" />
                                                  </contenttemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                        </tr>
