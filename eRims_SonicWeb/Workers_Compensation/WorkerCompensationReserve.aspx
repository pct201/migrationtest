...
<asp:Content ID="cntReserveWrkSht" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    //ctl00_ContentPlaceHolder1_gvAttachmentDetails_ctl01_chkHeader
    ...
    <div style="width: 100%" id="contmain" runat="server">
        ...
        <div style="width: 100%; text-align: center" id="Div1" runat="server">
            <table cellspacing="0" cellpadding="1" width="99%" border="0">
                <tbody>
                    <tr>
                        <td style="background-image: url(../images/normal_btn.jpg); height: 21px;" class="normal_tab" valign="middle"
                            align="center">
                            <a class="main_menu" href="Workers_ Compensation.aspx">Worker's Compensation</a></td>
                        <td style="background-image: url(../images/active_btn.jpg); height: 21px;" class="active_tab" valign="middle"
                            align="center">
                               ...
                               <td style="width:25%;" align="left" class="lc">
                                ...
                                <td style="width:25%;" align="left" class="ic">
                                    ...
                                    <%--<asp:RadioButtonList ID="rbtnEmployee" runat="server" Enabled="false" RepeatDirection="Horizontal">
                                        <asp:ListItem Selected="true">Yes1</asp:ListItem>
                                        <asp:ListItem>No</asp:ListItem>
                                    </asp:RadioButtonList>--%>
                                </td>
                            ...
                            <tbody>
                                <tr>
                                    <td class="ghc" colspan="8">
                                        Worker's Compensation Reserve Worksheet History
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="8">
                                        <asp:GridView ID="gvWorkerRW" runat="server" Width="100%" OnSorting="gvWorkerRW_Sorting"
                                            ...
                                            AllowSorting="True" BorderStyle="Solid" BorderWidth="1px" BorderColor="silver" AllowPaging="True" OnRowDataBound="gvWorkerRW_RowDataBound" OnRowCreated="gvWorkerRW_RowCreated">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign ="Right"  ItemStyle-HorizontalAlign="Right" SortExpression="Transaction_Date">
                                                    <ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="Indemnity_Total" HeaderStyle-HorizontalAlign ="Right" ItemStyle-HorizontalAlign="Right" HeaderText="Indemnity in Reserve $" SortExpression="Indemnity_Total" />
                                                <asp:BoundField DataField="Medical_Total" HeaderStyle-HorizontalAlign ="Right" ItemStyle-HorizontalAlign="Right" HeaderText="Medical in Reserve $" SortExpression="Medical_Total" />
                                        ...
                                        <asp:FormView ID="fvWorkersRW" runat="server" Width="100%" OnDataBound="fvWorkersRW_DataBound">
                                            <InsertItemTemplate>
                                                <table border="0" cellpadding="4" cellspacing="0" class="stylesheet" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="lc">
                                                         <asp:Label runat="server" ID="Lab1MedicalTotal">Medical Total</asp:Label> 
                                                            </td>
                                                        <td>
                                                            :</td>
                                                        <td class="ic">
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#F0F2E1" class="ghc" colspan="6">
                                                          <asp:Label runat="server" ID="lablIndemnityHead">Indemnity</asp:Label> 
                                                            </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="lc">
                                                        <asp:Label runat="server" ID="lablIndemnityTotal">Indemnity Total</asp:Label> 
                                                            </td>
                                                        <td>
                                                            :</td>
                                                        <td class="ic">
                                            ...
                                            <EditItemTemplate>
                                                <table border="0" cellpadding="4" cellspacing="0" class="stylesheet" width="100%">
                                                    ...
                                                    <asp:Label runat="server" ID="lablIndemnity">Indemnity</asp:Label> </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
                                                            <table width="87%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="lc">
                                                            <asp:Label runat="server" ID="lablIndemnityTotal">Indemnity Total</asp:Label> </td>
                                                        <td>
                                                            :</td>
                                                        <td class="ic">
                                            ...
                                            <ItemTemplate>
                                              ...
                                              <%--   <tr>
                                                <td>
                                                    <asp:Label runat="server" ID="lblRwid" Text='<%#Eval("PK_Workers_Comp_RW_ID") %>'
