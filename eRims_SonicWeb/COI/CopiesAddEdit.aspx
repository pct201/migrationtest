<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.master" CodeFile="CopiesAddEdit.aspx.cs"
    Inherits="Admin_CopiesAddEdit" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script type="text/javascript">
        ...
        function IfSave() {
            var values = '<%=ViewState["CopiesID"]%>';
            if (values == '' || values == '0') {
                alert('Please Save Copies Record First');
                ShowPanel(1);
                return false;
            }
        ...
        function ShowDialogBox() {
            ...
            var QryString = 'Search.aspx?coi=<%=Encryption.Encrypt(FK_COI.ToString())%>&tbl=<%=(int)clsGeneral.Tables.Copies%>'
                    ...
                    <table cellpadding="3" cellspacing="2" width="180px">
                        ...
                        <tr>
                            <td align="left" width="100%">
                                <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Copies</span>&nbsp;<span id="MenuAsterisk1" runat="server" style="color: Red;display:none;">*</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" width="100%">
                                                ...
                                                <asp:Panel ID="Panel1" runat="server" Style="display: block; height: 100%">
                                                    ...
                                                    <table cellpadding="3" cellspacing="1" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="28%" align="left">
                                                                <asp:TextBox ID="txtContactLastName" runat="server" Width="200px" MaxLength="50"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtContactFirstName" runat="server" Width="200px" MaxLength="50"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtContactTitle" runat="server" Width="200px" MaxLength="50" TabIndex="11"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtCity" runat="server" Width="200px" MaxLength="50" TabIndex="4"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtContactPhone" runat="server" Width="200px" MaxLength="12" onKeyPress="javascript:return FormatPhone(event,this.id);"
                                                                    TabIndex="12"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="revContactPhone" runat="server" ErrorMessage="Please enter Valid Contact Phone"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtContactFax" runat="server" MaxLength="12" Width="200px" onKeyPress="javascript:return FormatPhone(event,this.id);"
                                                                    TabIndex="13"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="revContactFax" runat="server" ErrorMessage="Please enter Valid Contact Fax"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtContactEmail" runat="server" Width="200px" MaxLength="254" TabIndex="14"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="revEmail" runat="server" ErrorMessage="Please enter Valid Contact E-Mail"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:RadioButtonList ID="rdoGenerateEnvelope" runat="server" SkinID="YesNoType" TabIndex="7" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="height: 10px;" class="Spacer" colspan="7">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
                                                ...
                                                <asp:Panel ID="Panel2" runat="server" Style="display: block; height: 100%">
                                                    ...
                                                    <table cellpadding="5" cellspacing="1" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:Label ID="lblGenerateEnvelope" runat="server" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
