<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.master" CodeFile="ProfessionalPolicy.aspx.cs"
    Inherits="Admin_ProfessionalPolicy" %>
    ...
    <script type="text/javascript">
        ...
        function RedirectToPage(PageName) {
            if (PageName.indexOf("?") > 0)
                window.location.href = PageName + '&Page=PL&prop=<%=Encryption.Encrypt(PK_COI_Professional_Policies.ToString())%>&coi=<%=Encryption.Encrypt(FK_COI.ToString())%>&op=<%=Request.QueryString["op"]%>';
            else
                window.location.href = PageName + '?Page=PL&prop=<%=Encryption.Encrypt(PK_COI_Professional_Policies.ToString())%>&coi=<%=Encryption.Encrypt(FK_COI.ToString())%>';
            ...
            <tr>
                <td class="leftMenu" valign="top" style="padding-left: 5px;">
                    <table cellpadding="5" cellspacing="0" width="190px">
                        ...
                        <tr>
                            <td align="left">
                                <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Professional
                                    Liability Policies</span>&nbsp;<span id="MenuAsterisk1" runat="server" style="color: Red;display:none;">*</span>
                            </td>
                        </tr>
                        <tr>
                                            ...
                                            <td class="tblGrid" align="left">
                                                <asp:Panel ID="Panel1" runat="server" Style="display: block; height: 100%">
                                                    <div class="bandHeaderRow">
                                                        Professional Liability Policies</div>
                                                    <table cellpadding="3" cellspacing="1" width="100%">
                                                        <tr>
                                                            <td colspan="7">
                                                                <a href="javascript:ShowDialogCOI('Search.aspx?coi=<%=Encryption.Encrypt(FK_COI.ToString())%>&tbl=<%=(int)clsGeneral.Tables.Professional_Liability_Policies%>');">
                                                                    Find</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td width="26%" align="left">
                                                                <asp:DropDownList ID="drpCompany" runat="server" Width="205px" SkinID="Default">
                                                                </asp:DropDownList>
                                                                <%--<asp:RequiredFieldValidator ID="rfvCompany" runat="server" InitialValue="--Select--"
                                                                    ValidationGroup="vsErrorGroup" ErrorMessage="Please Select Insurance Company"
                                                            ...
                                                            <td width="26%" align="left">
                                                                <asp:TextBox ID="txtPolicyNumber" runat="server" Width="200px" MaxLength="35"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtIssueDate" runat="server" IsRequiredField="false" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Professional Liability Policies]/Issue Date" RegularExpressionMessage="Please enter Valid [Professional Liability Policies]/Issue Date" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtEffectiveDate" runat="server" IsRequiredField="false" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Professional Liability Policies]/Effective Date"
                                                                    RegularExpressionMessage="Please enter Valid [Professional Liability Policies]/Effective Date" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtExpirationDate" runat="server" IsRequiredField="false" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Professional Liability Policies]/Expiration Date"
                                                                    RegularExpressionMessage="Please enter Valid [Professional Liability Policies]/Expiration Date" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtCancellationDate" runat="server" IsRequiredField="false" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Professional Liability Policies]/Cancellation Date" RegularExpressionMessage="Please enter Valid [Professional Liability Policies]/Cancellation Date" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                $&nbsp;<asp:TextBox ID="txtOccurrenceCoverage" Width="190px" runat="server" SkinID="DollarFieldBox"
                                                                    onkeypress="javascript:return FormatNumber(event,this.id,13,false);"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
