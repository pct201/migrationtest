<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.master" CodeFile="LiquorPolicyAddEdit.aspx.cs"
    Inherits="COI_LiquorLiability" %>
    ...
    <script type="text/javascript">
        ...
        function RedirectToPage(PageName) {
            if (PageName.indexOf("?") > 0)
                window.location.href = PageName + '&Page=LP&prop=<%=Encryption.Encrypt(PK_COI_Liquor_Policies.ToString())%>&coi=<%=Encryption.Encrypt(FK_COI.ToString())%>&op=<%=Request.QueryString["op"]%>';
            else
                window.location.href = PageName + '?Page=LP&prop=<%=Encryption.Encrypt(PK_COI_Liquor_Policies.ToString())%>&coi=<%=Encryption.Encrypt(FK_COI.ToString())%>';
        ...
        function SetFocusOnFirstControl(index) {
            switch (index) {
                case 1:
                    document.getElementById('ctl00_ContentPlaceHolder1_drpOtherLiabilityPolicies').focus(); break;
                case 2:
                    ...
                    <table cellpadding="5" cellspacing="0" width="200px">
                        ...
                        <tr>
                            <td align="left" width="100%">
                                <span id="Menu1" onclick="javascript:ShowPanel(1);" class="LeftMenuStatic">Other Liability
                                    Policies</span>&nbsp;<span id="MenuAsterisk1" runat="server" style="color: Red;display:none;">*</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" width="100%">
                                            ...
                                            <td class="tblGrid" align="left">
                                                <asp:Panel ID="Panel1" runat="server" Style="display: block; height: 100%">
                                                    <div class="bandHeaderRow">
                                                        Other Liability Policies</div>
                                                    <table cellpadding="3" cellspacing="1" width="100%">
                                                        <tr>
                                                            <td colspan="7">
                                                                <a href="javascript:ShowDialogCOI('Search.aspx?coi=<%=Encryption.Encrypt(FK_COI.ToString())%>&tbl=<%=(int)clsGeneral.Tables.COI_Liquor_Policies%>');">
                                                                    Find</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="20%" align="left" valign="top">
                                                                Other Liability Policies&nbsp;<span id="Span1" style="color: Red; display: none;"
                                                                    runat="server">*</span>
                                                            </td>
                                                            ...
                                                            <td align="left" colspan="5">
                                                                <asp:DropDownList ID="drpOtherLiabilityPolicies" runat="server" Width="205px" SkinID="Default"
                                                                    TabIndex="1">
                                                                </asp:DropDownList>
                                                                <%--<asp:RequiredFieldValidator ID="rfvOtherLiabilityPolicies" runat="server" InitialValue="--Select--"
                                                                    ValidationGroup="vsErrorGroup" ErrorMessage="Please Select Other Liability Policies"
                                                                    ControlToValidate="drpOtherLiabilityPolicies" Display="None" SetFocusOnError="true" />--%>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="20%" align="left" valign="top">
                                                                Insurance Company&nbsp;<span id="Span2" style="color: Red; display: none;" runat="server">*</span>
                                                            </td>
                                                            <td width="2%" align="center" valign="top">
                                                                :
                                                            </td>
                                                            <td width="26%" align="left">
                                                                <asp:DropDownList ID="drpCompany" runat="server" Width="205px" SkinID="Default" TabIndex="2">
                                                                </asp:DropDownList>
                                                                <%--<asp:RequiredFieldValidator ID="rfvCompany" runat="server" InitialValue="--Select--"
                                                                    ValidationGroup="vsErrorGroup" ErrorMessage="Please Select [Liquor Liability Policies]/Insurance Company"
                                                            ...
                                                            <td width="18%" align="left" valign="top">
                                                                Policy Number&nbsp;<span id="Span3" style="color: Red; display: none;" runat="server">*</span>
                                                            </td>
                                                            <td width="2%" align="center" valign="top">
                                                                :
                                                            </td>
                                                            <td width="30%" align="left">
                                                                <asp:TextBox ID="txtPolicyNumber" runat="server" Width="200px" MaxLength="35" TabIndex="7"></asp:TextBox>
                                                                <%--<asp:RequiredFieldValidator ID="rfvPolicyNumber" runat="server" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please Enter [Liquor Liability Policies]/Policy Number" ControlToValidate="txtPolicyNumber"
                                                                    Display="none" SetFocusOnError="true" />--%>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                Issue Date&nbsp;<span id="Span4" style="color: Red; display: none;" runat="server">*</span>
                                                            </td>
                                                            <td align="center">
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtIssueDate" runat="server" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Other Liability Policies]/Issue Date" IsRequiredField="false" RegularExpressionMessage="Please enter Valid [Other Liability Policies]/Issue Date"
                                                                    TabIndex="3" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            ...
                                                            <td align="left">
                                                                Effective Date&nbsp;<span id="Span5" style="color: Red; display: none;" runat="server">*</span>
                                                            </td>
                                                            <td align="center">
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtEffectiveDate" runat="server" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Other Liability Policies]/Effective Date" IsRequiredField="false" RegularExpressionMessage="Please enter Valid [Other Liability Policies]/Effective Date"
                                                                    TabIndex="8" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                Expiration Date&nbsp;<span id="Span6" style="color: Red; display: none;" runat="server">*</span>
                                                            </td>
                                                            <td align="center">
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtExpirationDate" runat="server" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Other Liability Policies]/Expiration Date" IsRequiredField="false" RegularExpressionMessage="Please enter Valid [Other Liability Policies]/Expiration Date"
                                                                    TabIndex="4" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            ...
                                                            <td align="left">
                                                                Cancellation Date&nbsp;<span id="Span7" style="color: Red; display: none;" runat="server">*</span>
                                                            </td>
                                                            <td align="center">
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <uc:ctrlCalendar ID="txtCancellationDate" runat="server" ValidationGroup="vsErrorGroup"
                                                                    ErrorMessage="Please enter [Other Liability Policies]/Cancellation Date" IsRequiredField="false" RegularExpressionMessage="Please enter Valid [Other Liability Policies]/Cancellation Date"
                                                                    TabIndex="9" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                $&nbsp;<asp:TextBox ID="txtEachOccur" Width="190px" runat="server" SkinID="DollarFieldBox"
                                                                    onkeypress="javascript:return FormatNumber(event,this.id,13,false);" TabIndex="5"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            <td align="left">
                                                                Aggregate&nbsp;<span id="Span9" style="color: Red; display: none;" runat="server">*</span>
                                                            </td>
                                                            <td align="center">
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                $&nbsp;<asp:TextBox ID="txtAggregate" Width="190px" runat="server" SkinID="DollarFieldBox"
                                                                    onkeypress="javascript:return FormatNumber(event,this.id,13,false);" TabIndex="10"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <asp:Panel ID="Panel2" runat="server" Style="display: block; height: 100%">
                                                    ...
                                                    <table cellpadding="5" cellspacing="1" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                $&nbsp;<asp:Label ID="lblEachOccur" runat="server"></asp:Label>
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                                            </td>
