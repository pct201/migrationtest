...
Calendar = function (mondayFirst, dateStr, onSelected, onClose, afterSelected, afterSelectedArgs) {    
	// member variables
	this.activeDiv = null;
    ...
    this.afterSelectionFunction = afterSelected || null;
    this.afterSelectionFuncArgs = afterSelectedArgs || null;
...
Calendar.cellClick = function(el) {
	...
	if (typeof el.navtype == "undefined") {
		...
		//Following 2 lines added by Rakshit for closing calendar upon clicking on any date
		Calendar.removeClass(el, "hilite");
		...
		switch (el.navtype) {
			...
			//Following Else Added by Rakshit For Closing calendar on clicking  today button
			else
			{
			cal.callHandler();
			Calendar.removeClass(el, "hilite");
...
Calendar.prototype.callHandler = function () {
	if (this.onSelected) {
		...
		if(this.afterSelectionFunction) {
		    if(this.afterSelectionFuncArgs)
		        this.afterSelectionFunction(this.afterSelectionFuncArgs);
		    else
		        this.afterSelectionFunction();
		}
	}
};
