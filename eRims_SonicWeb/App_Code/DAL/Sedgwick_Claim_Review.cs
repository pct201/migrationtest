...
namespace BAL
{
	...
	public sealed class Sedgwick_Claim_Review
	{
        ...
        private string _Broker_Claim_Comments;
        ...
        /// <summary>
        /// Gets or sets the Broker_Claim_Comments value.
        /// </summary>
        public string Broker_Claim_Comments
        {
            get { return _Broker_Claim_Comments; }
            set { _Broker_Claim_Comments = value; }
        }
		...
		private void SetValue (DataRow drSedgwick_Claim_Review) 
		{
                ...
                if (drSedgwick_Claim_Review["Broker_Claim_Comments"] == DBNull.Value)
                    this._Broker_Claim_Comments = null;
                else
                    this._Broker_Claim_Comments = (string)drSedgwick_Claim_Review["Broker_Claim_Comments"];

                if (drSedgwick_Claim_Review["FK_Employee_Id"] == DBNull.Value)
                    this._FK_Employee_Id = null;
                else
                    this._FK_Employee_Id = (decimal?)drSedgwick_Claim_Review["FK_Employee_Id"];
		...
		public int Insert()
		{
            ...
            if (string.IsNullOrEmpty(this._Broker_Claim_Comments))
                db.AddInParameter(dbCommand, "Broker_Claim_Comments", DbType.String, DBNull.Value);
            else
                db.AddInParameter(dbCommand, "Broker_Claim_Comments", DbType.String, this._Broker_Claim_Comments);
		...
		/// <summary>
		/// Selects all records from the Sedgwick_Claim_Review table.
		/// </summary>
		/// <returns>DataSet</returns>
		public static DataSet SelectAll()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Sedgwick_Claim_ReviewSelectAll");
        ...
        /// Updates a record in the Sedgwick_Claim_Review table.
        /// </summary>
        public void Sedgwick_Claim_Review_CopyFromPreviousQuarter(decimal FK_LU_Sedgwick_Field_Office, string FK_Workers_Comp_ClaimsIds, int Year, int Quarter, string Updated_By, DateTime Update_Date, decimal FK_Employee_Id)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Sedgwick_Claim_Review_CopyFromPreviousQuarter");
            ...
            db.AddInParameter(dbCommand, "FK_Workers_Comp_ClaimsIds", DbType.String, FK_Workers_Comp_ClaimsIds);
