...
[Serializable]
public abstract class CPropEnvPermits
{

	#region Constructor
    public CPropEnvPermits()
	{
		this._pK_Other_Environmental_Permits = 0;
	...
	private System.Decimal _pK_Other_Environmental_Permits;
	...
	public System.Decimal PK_Other_Environmental_Permits
	{
		get { return  _pK_Other_Environmental_Permits; }
		set { _pK_Other_Environmental_Permits = value; }
	}
    ...
    public abstract DataSet PropEnvPermits_GetByID(System.Decimal lPK_Other_Environmental_Permits);
    public abstract int PropEnvPermits_InsertUpdate(RIMS_Base.CPropEnvPermits obj);
    public abstract DataSet GetOEType();
    public abstract DataSet PropEnvPermits_GetByEnvID(System.Decimal EnvID);
    public abstract int PropEnvPermits_Delete(System.String lPK_Other_Environmental_Permits);
	#endregion
