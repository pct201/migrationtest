...
[Serializable]
public abstract class CPropUtilContacts
{

	#region Constructor
    public CPropUtilContacts()
	{
		this._pK_Utility_Contacts = -1;
	...
	private System.Decimal _pK_Utility_Contacts;
	...
	public System.Decimal PK_Utility_Contacts
	{
		get { return  _pK_Utility_Contacts; }
		set { _pK_Utility_Contacts = value; }
	}
	...
	public abstract DataSet PropUtilContacts_GetByID(System.Decimal lPK_Utility_Contacts);
    public abstract int PropUtilContacts_InsertUpdate(RIMS_Base.CPropUtilContacts obj);
    public abstract int PropUtilContacts_Delete(System.String lPK_Utility_Contacts);
    public abstract DataSet UtilContacts_ByContactID(System.Decimal PK_Contacts);
