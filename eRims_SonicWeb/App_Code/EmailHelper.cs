...
public class EmailHelper
{
    ...
    /// </history> 
    /// ----------------------------------------------------------------------------- 
    public bool SendMail(string fromEmail, string fromName, string[] toEmail, string subject, string body, bool isHtml, string[] strFilePath, string[] cc)
    {
        if (!AppConfig.AllowMailSending)
            return false;
        // Instantiate a new instance of MailMessage 
    ...
    public bool SendEventMailMessage(string fromEmail, string fromName, string[] toEmail, string subject, string body, bool isHtml, string[] strFilePath, string cc)
    {
        if (!AppConfig.AllowMailSending)
            return false;
        // Instantiate a new instance of MailMessage 
