...
/// <summary>
/// Summary description for clsPrintClaimNotesEPMActionNotes
/// </summary>
public class clsPrintClaimNotesEPMActionNotes
{
    public static void PrintSelectedSonicNotes(string strPKs, long ClaimID)
    {
        ...
        dtNotes = clsEPM_Action_Notes_RM.SelectByIDs(strPKs).Tables[0];
        ...
        if (!string.IsNullOrEmpty(objEPM_Identification.Project_Number.ToString()))
        strProjectNumber = objEPM_Identification.Project_Number;
        if (!string.IsNullOrEmpty(objEPM_Identification.PK_EPM_Identification.ToString()))
