        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if ((clsSession.IsACIUser == true && !(strUrl.Contains("rptDefault") || strUrl.Contains("rptACI_Key_Contact_Report"))) || (clsSession.IsACIUser == false && (strUrl.Contains("rptDefault") || strUrl.Contains("rptACI_Key_Contact_Report"))))
                            Response.Redirect(AppConfig.SiteURL + "Error.aspx?msg=errAcc");
                    }
                }
            }
