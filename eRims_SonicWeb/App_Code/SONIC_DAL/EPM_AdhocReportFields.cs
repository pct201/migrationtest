...
namespace ERIMS.DAL
{
    public class EPM_AdhocReportFields
    {
        ...
        /// <returns></returns>
        public List<EPM_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<EPM_AdhocReportFields> results = new List<EPM_AdhocReportFields>();
                EPM_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectEPMAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<EPM_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            {
                List<EPM_AdhocReportFields> results = new List<EPM_AdhocReportFields>();
                EPM_AdhocReportFields objAdHoc = new EPM_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectEPMAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected EPM_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.EPM_AdhocReportFields objAdHoc = new ERIMS.DAL.EPM_AdhocReportFields();
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectEPMAdHocFilterFileds");
