...
namespace ERIMS.DAL
{
    public class Invest_AdhocReportFields
    {
        ...
        /// Default Constructor
        /// </summary>
        public Invest_AdhocReportFields()
        {
        ...
        /// <returns></returns>
        public List<Invest_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<Invest_AdhocReportFields> results = new List<Invest_AdhocReportFields>();
                Invest_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectInvestAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<Invest_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            {
                List<Invest_AdhocReportFields> results = new List<Invest_AdhocReportFields>();
                Invest_AdhocReportFields objAdHoc = new Invest_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectInvestAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected Invest_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.Invest_AdhocReportFields objAdHoc = new ERIMS.DAL.Invest_AdhocReportFields();
