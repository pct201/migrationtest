...
namespace ERIMS.DAL
{
    ...
    public sealed class clsLU_Event_Type
    {
        ...
        private decimal? _FK_LU_Event_Level;
        ...
        public decimal? FK_LU_Event_Level
        {
            get { return _FK_LU_Event_Level; }
            set { _FK_LU_Event_Level = value; }
        }
        ...
        private void SetValue(DataRow drLU_Event_Type)
        {
            ...
            if (drLU_Event_Type["FK_LU_Event_Level"] == DBNull.Value)
                this._FK_LU_Event_Level = null;
            else
                this._FK_LU_Event_Level = (decimal?)drLU_Event_Type["FK_LU_Event_Level"];
        ...
        public int Insert()
        {
            ...
            db.AddInParameter(dbCommand, "FK_LU_Event_Level", DbType.Decimal, this._FK_LU_Event_Level);
        ...
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet SelectAllEventTypes()
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectAllEventTypes");
