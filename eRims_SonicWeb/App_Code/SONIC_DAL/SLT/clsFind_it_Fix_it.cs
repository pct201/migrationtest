...
namespace ERIMS.DAL
{
    ...
    public sealed class clsFind_it_Fix_it
    {
        ...
        private void SetValue(DataRow drFind_it_Fix_it)
        {
            ...
            if (drFind_it_Fix_it["Status"] == DBNull.Value)
                this._Status = null;
            else
                this._Status = (string)drFind_it_Fix_it["Status"];

            if (drFind_it_Fix_it["Created_Date"] == DBNull.Value)
                this._Created_Date = null;
            else
                this._Created_Date = (DateTime?)drFind_it_Fix_it["Created_Date"];
