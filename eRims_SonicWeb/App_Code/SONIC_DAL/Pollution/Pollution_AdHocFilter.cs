...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class Pollution_AdHocFilter
    {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<Pollution_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<Pollution_AdHocFilter> results = new List<Pollution_AdHocFilter>();
                Pollution_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("Pollution_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private Pollution_AdHocFilter MapFrom(IDataReader reader)
        {
            Pollution_AdHocFilter objAdHoc = new Pollution_AdHocFilter();
            try
            {
