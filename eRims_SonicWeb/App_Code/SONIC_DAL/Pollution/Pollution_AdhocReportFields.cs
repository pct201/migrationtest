...
namespace ERIMS.DAL
{
    public class Pollution_AdhocReportFields
    {
        ...
        /// Default Constructor
        /// </summary>
        public Pollution_AdhocReportFields()
        {
        ...
        /// <returns></returns>
        public List<Pollution_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<Pollution_AdhocReportFields> results = new List<Pollution_AdhocReportFields>();
                Pollution_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectPollutionAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<Pollution_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            {
                List<Pollution_AdhocReportFields> results = new List<Pollution_AdhocReportFields>();
                Pollution_AdhocReportFields objAdHoc = new Pollution_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectPollutionAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected Pollution_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.Pollution_AdhocReportFields objAdHoc = new ERIMS.DAL.Pollution_AdhocReportFields();
        ...
        public static DataSet GetAdHocFilterFields(string strFieldType)
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("SelectPollutionAdHocFilterFileds");
