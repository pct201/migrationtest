...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class Pollution_AdHocReport
    {
        ...
        /// </summary>
        public Pollution_AdHocReport(decimal pk_AdHocReport)
        {
        ...
        public decimal Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocReportInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocReportSelectByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocReportUpdate");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocReportDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocReportSelect");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Pollution_AdHocReportExistsReport");
