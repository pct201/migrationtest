...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class Franchise_AdHocReport
    {
        ...
        /// </summary>
        public Franchise_AdHocReport(decimal pk_AdHocReport)
        {
        ...
        public decimal Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocReportInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocReportSelectByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocReportUpdate");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocReportDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocReportSelect");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocReportExistsReport");
