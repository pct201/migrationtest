...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class SLT_AdHocFilter
    {
        ...
        /// </summary>
        public SLT_AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("SLT_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SLT_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<SLT_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<SLT_AdHocFilter> results = new List<SLT_AdHocFilter>();
                SLT_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SLT_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private SLT_AdHocFilter MapFrom(IDataReader reader)
        {
            SLT_AdHocFilter objAdHoc = new SLT_AdHocFilter();
            try
            {
