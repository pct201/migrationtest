...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class DPD_AdHocReport
    {
        ...
        /// </summary>
        public DPD_AdHocReport(decimal pk_AdHocReport)
        {
        ...
        public decimal Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocReportInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocReportSelectByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocReportUpdate");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocReportDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocReportSelect");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocReportExistsReport");
