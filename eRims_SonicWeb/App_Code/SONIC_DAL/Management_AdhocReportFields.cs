    ...
    public class Management_AdhocReportFields
    {
        ...
        public List<Management_AdhocReportFields> GetAdHocReportFieldByPk(decimal PK_Management_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<ERIMS.DAL.Management_AdhocReportFields> results = new List<ERIMS.DAL.Management_AdhocReportFields>();
                ERIMS.DAL.Management_AdhocReportFields objAdHoc;
        ...
        public List<Management_AdhocReportFields> GetAdHocReportFieldByMultipleID(string PK_Management_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<ERIMS.DAL.Management_AdhocReportFields> results = new List<ERIMS.DAL.Management_AdhocReportFields>();
                ERIMS.DAL.Management_AdhocReportFields objAdHoc = new ERIMS.DAL.Management_AdhocReportFields();
        ...
        /// <returns></returns>
        protected ERIMS.DAL.Management_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.Management_AdhocReportFields objAdHoc = new ERIMS.DAL.Management_AdhocReportFields();
