...
{
    /// <summary>
    /// Summary description for AP_AdHocReport
    /// </summary>
    public class AP_AdHocReport
    {
        ...
        /// </summary>
        public AP_AdHocReport(decimal pk_AdHocReport)
        {
            ...
            if (dtAdHocReport.Rows.Count == 1)
            {
                ...
                if (drAdHocReport["ReportType"] == DBNull.Value)
                    this._ReportType = null;
                else
                    this._ReportType = (int)drAdHocReport["ReportType"];
        ...
        public decimal Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocReportInsert");
            ...
            db.AddInParameter(dbCommand, "ReportType", DbType.Int32, this._ReportType);
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocReportSelectByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocReportUpdate");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocReportDeleteByPK");
        ...
        /// <returns></returns>
        public static DataSet SelectReportName(int ReportType)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocReportSelect");
        ...
        /// <param name="CoverageType"></param>
        /// <returns></returns>
        public static DataTable ExistsReportName(string ReportName, decimal pk_AdHocReport,int Report_Type)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocReportExistsReport");
            ...
            db.AddInParameter(dbCommand, "@Report_Type", DbType.Int16, Report_Type);
