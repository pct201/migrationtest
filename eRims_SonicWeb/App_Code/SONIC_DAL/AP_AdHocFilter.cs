...
{
    /// <summary>
    /// Summary description for AP_AdHocFilter
    /// </summary>
    public class AP_AdHocFilter
    {
        ...
        /// </summary>
        public AP_AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<AP_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<AP_AdHocFilter> results = new List<AP_AdHocFilter>();
                AP_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("AP_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private AP_AdHocFilter MapFrom(IDataReader reader)
        {
            AP_AdHocFilter objAdHoc = new AP_AdHocFilter();
            try
            {
