...
namespace ERIMS.DAL
{
    public class DPD_AdhocReportFields
    {
        ...
        /// <returns></returns>
        public List<DPD_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<DPD_AdhocReportFields> results = new List<DPD_AdhocReportFields>();
                DPD_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectDPDAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<DPD_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            {
                List<DPD_AdhocReportFields> results = new List<DPD_AdhocReportFields>();
                DPD_AdhocReportFields objAdHoc = new DPD_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectDPDAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected DPD_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.DPD_AdhocReportFields objAdHoc = new ERIMS.DAL.DPD_AdhocReportFields();
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectDPDAdHocFilterFileds");
