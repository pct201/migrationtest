...
namespace ERIMS.DAL
{
    public class Franchise_AdhocReportFields
    {
        ...
        /// Default Constructor
        /// </summary>
        public Franchise_AdhocReportFields()
        {
        ...
        /// <returns></returns>
        public List<Franchise_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<Franchise_AdhocReportFields> results = new List<Franchise_AdhocReportFields>();
                Franchise_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectFranchiseAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<Franchise_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            {
                List<Franchise_AdhocReportFields> results = new List<Franchise_AdhocReportFields>();
                Franchise_AdhocReportFields objAdHoc = new Franchise_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectFranchiseAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected Franchise_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.Franchise_AdhocReportFields objAdHoc = new ERIMS.DAL.Franchise_AdhocReportFields();
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectFranchiseAdHocFilterFileds");
