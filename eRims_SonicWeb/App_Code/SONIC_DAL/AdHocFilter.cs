...
namespace ERIMS.DAL
{
    ...
    public sealed class AdHocFilter
    {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AdHocFilterUpdate");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AdHocFilterDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Franchise_AdHocFilterDeleteByFK");
        ...
        public List<AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<AdHocFilter> results = new List<AdHocFilter>();
                AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("Franchise_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private AdHocFilter MapFrom(IDataReader reader)
        {
            AdHocFilter objAdHoc = new AdHocFilter();
            try
            {
