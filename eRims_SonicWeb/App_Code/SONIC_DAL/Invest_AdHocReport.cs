...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class Invest_AdHocReport
    {
        ...
        /// </summary>
        public Invest_AdHocReport(decimal pk_AdHocReport)
        {
        ...
        public decimal Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocReportInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocReportSelectByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocReportUpdate");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocReportDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocReportSelect");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocReportExistsReport");
