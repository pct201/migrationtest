...
{
	/// <summary>
	/// Data access class for Sonic_U_Train_AdHocReport table.
	/// </summary>
	public sealed class Sonic_U_Train_AdHocReport
	{
		...
		/// <summary>
		/// Initializes a new instance of the Sonic_U_Train_AdHocReport class with default value.
		/// </summary>
		public Sonic_U_Train_AdHocReport() 
		{
		...
		/// <summary>
		/// Initializes a new instance of the Sonic_U_Train_AdHocReport class based on Primary Key.
		/// </summary>
        public Sonic_U_Train_AdHocReport(decimal pk_AdHocReport)
        {
		...
		/// <summary>
		/// Inserts a record into the Sonic_U_Train_AdHocReport table.
		/// </summary>
		/// <returns></returns>
		public int Insert()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Sonic_U_Train_AdHocReportInsert");
		...
		/// <summary>
		/// Selects a single record from the Sonic_U_Train_AdHocReport table by a primary key.
		/// </summary>
		/// <returns>DataSet</returns>
		private DataSet SelectByPK(decimal pk_AdHocReport)
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Sonic_U_Train_AdHocReportSelectByPK");
		...
		/// <summary>
		/// Updates a record in the Sonic_U_Train_AdHocReport table.
		/// </summary>
		public void Update()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Sonic_U_Train_AdHocReportUpdate");
		...
		/// <summary>
		/// Deletes a record from the Sonic_U_Train_AdHocReport table by a composite primary key.
		/// </summary>
		public static void DeleteByPK(decimal pk_AdHocReport)
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Sonic_U_Train_AdHocReportDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Sonic_U_Train_AdHocReportSelect");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Sonic_U_Train_AdHocReportExistsReport");
