...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class Inspection_AdHocFilter
    {
        ...
        /// </summary>
        public Inspection_AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Inspection_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Inspection_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<Inspection_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<Inspection_AdHocFilter> results = new List<Inspection_AdHocFilter>();
                Inspection_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("Inspection_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private Inspection_AdHocFilter MapFrom(IDataReader reader)
        {
            Inspection_AdHocFilter objAdHoc = new Inspection_AdHocFilter();
            try
            {
