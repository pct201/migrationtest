...
namespace ERIMS.DAL
{
    public class DealershipDetails_AdHocReportFields
    {
        ...
        /// Default Constructor
        /// </summary>
        public DealershipDetails_AdHocReportFields()
        {
        ...
        /// <returns></returns>
        public List<DealershipDetails_AdHocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<DealershipDetails_AdHocReportFields> results = new List<DealershipDetails_AdHocReportFields>();
                DealershipDetails_AdHocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectDealershipDetailsAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<DealershipDetails_AdHocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            {
                List<DealershipDetails_AdHocReportFields> results = new List<DealershipDetails_AdHocReportFields>();
                DealershipDetails_AdHocReportFields objAdHoc = new DealershipDetails_AdHocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectDealershipDetailsAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected DealershipDetails_AdHocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.DealershipDetails_AdHocReportFields objAdHoc = new ERIMS.DAL.DealershipDetails_AdHocReportFields();
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectDealershipDetailsAdHocFilterFileds");
