...
namespace ERIMS.DAL
{
    public class SLT_AdhocReportFields
    {
        ...
        /// <returns></returns>
        public List<SLT_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<SLT_AdhocReportFields> results = new List<SLT_AdhocReportFields>();
                SLT_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectSLTAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<SLT_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            {
                List<SLT_AdhocReportFields> results = new List<SLT_AdhocReportFields>();
                SLT_AdhocReportFields objAdHoc = new SLT_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectSLTAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected SLT_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.SLT_AdhocReportFields objAdHoc = new ERIMS.DAL.SLT_AdhocReportFields();
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectSLTAdHocFilterFileds");
