...
{
	/// <summary>
	/// Data access class for Auto_Loss_RMW table.
	/// </summary>
	public sealed class Auto_Loss_RMW
    {
        #region Fields


        private decimal _PK_Auto_Loss_RMW;
        private decimal _FK_Auto_Loss_Claims;
        private DateTime _Update_Date;
        private string _Updated_By;
        private Nullable<bool> _Claimant_Customer;
        private Nullable<bool> _Claimant_Third_Party;
        private Nullable<bool> _Driver_Customer;
        private Nullable<bool> _Driver_Associate;
        ...
        private decimal _FK_LU_Part_Of_Body;
        private decimal _FK_LU_Nature_Of_Injury;
        ...
        /// <summary> 
        /// Gets or sets the PK_Auto_Loss_RMW value.
        /// </summary>
        public decimal PK_Auto_Loss_RMW
        {
            get { return _PK_Auto_Loss_RMW; }
            set { _PK_Auto_Loss_RMW = value; }
        }


        /// <summary> 
        /// Gets or sets the FK_Auto_Loss_Claims value.
        /// </summary>
        public decimal FK_Auto_Loss_Claims
        {
            get { return _FK_Auto_Loss_Claims; }
            set { _FK_Auto_Loss_Claims = value; }
        }
        ...
        /// <summary> 
        /// Gets or sets the Driver_Customer value.
        /// </summary>
        public Nullable<bool> Driver_Customer
        {
            get { return _Driver_Customer; }
            set { _Driver_Customer = value; }
        }


        /// <summary> 
        /// Gets or sets the Driver_Associate value.
        /// </summary>
        public Nullable<bool> Driver_Associate
        {
            get { return _Driver_Associate; }
            set { _Driver_Associate = value; }
        }
        ...
        /// <summary> 
        /// Gets or sets the FK_LU_Part_Of_Body value.
        /// </summary>
        public decimal FK_LU_Part_Of_Body
        {
            get { return _FK_LU_Part_Of_Body; }
            set { _FK_LU_Part_Of_Body = value; }
        }


        /// <summary> 
        /// Gets or sets the FK_LU_Nature_Of_Injury value.
        /// </summary>
        public decimal FK_LU_Nature_Of_Injury
        {
            get { return _FK_LU_Nature_Of_Injury; }
            set { _FK_LU_Nature_Of_Injury = value; }
        }
        ...
        /// Initializes a new instance of the Auto_Loss_RMW class. with the default value.

        /// </summary>
        public Auto_Loss_RMW()
        {

            this._PK_Auto_Loss_RMW = -1;
            this._FK_Auto_Loss_Claims = -1;
            ...
            this._Driver_Customer = false;
            this._Driver_Associate = false;
            ...
            this._FK_LU_Part_Of_Body = -1;
            this._FK_LU_Nature_Of_Injury = -1;
        ...
        /// <summary> 
        /// Initializes a new instance of the Auto_Loss_RMW class for passed PrimaryKey with the values set from Database.
        /// </summary>
        public Auto_Loss_RMW(decimal PK)
        {

            DataTable dtAuto_Loss_RMW = SelectByPK(PK).Tables[0];

            if (dtAuto_Loss_RMW.Rows.Count > 0)
            {

                DataRow drAuto_Loss_RMW = dtAuto_Loss_RMW.Rows[0];

                this._PK_Auto_Loss_RMW = drAuto_Loss_RMW["PK_Auto_Loss_RMW"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["PK_Auto_Loss_RMW"]) : 0;
                this._FK_Auto_Loss_Claims = drAuto_Loss_RMW["FK_Auto_Loss_Claims"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["FK_Auto_Loss_Claims"]) : 0;
                this._Update_Date = drAuto_Loss_RMW["Update_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["Update_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._Updated_By = Convert.ToString(drAuto_Loss_RMW["Updated_By"]);
                if (drAuto_Loss_RMW["Claimant_Customer"] != DBNull.Value)
                    this._Claimant_Customer = Convert.ToBoolean(drAuto_Loss_RMW["Claimant_Customer"]);
                if(drAuto_Loss_RMW["Claimant_Third_Party"] != DBNull.Value)
                    this._Claimant_Third_Party =  Convert.ToBoolean(drAuto_Loss_RMW["Claimant_Third_Party"]);
                if(drAuto_Loss_RMW["Driver_Customer"] != DBNull.Value )
                    this._Driver_Customer = Convert.ToBoolean(drAuto_Loss_RMW["Driver_Customer"]);
                if(drAuto_Loss_RMW["Driver_Associate"] != DBNull.Value)
                    this._Driver_Associate = Convert.ToBoolean(drAuto_Loss_RMW["Driver_Associate"]);
                this._Liability_Analysis = Convert.ToString(drAuto_Loss_RMW["Liability_Analysis"]);
                if(drAuto_Loss_RMW["Demand"] != DBNull.Value )
                    this._Demand = Convert.ToBoolean(drAuto_Loss_RMW["Demand"]);
                this._Claimant_Counsel_Name = Convert.ToString(drAuto_Loss_RMW["Claimant_Counsel_Name"]);
                this._Plantiff_Counsel_Name = Convert.ToString(drAuto_Loss_RMW["Plantiff_Counsel_Name"]);
                if(drAuto_Loss_RMW["Property_Damaged"] != DBNull.Value)
                    this._Property_Damaged = Convert.ToBoolean(drAuto_Loss_RMW["Property_Damaged"]);
                this._Property_Damages_Description = Convert.ToString(drAuto_Loss_RMW["Property_Damages_Description"]);
                this._Damage_Amount = drAuto_Loss_RMW["Damage_Amount"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["Damage_Amount"]) : 0;
                if(drAuto_Loss_RMW["Bodily_Injury"] != DBNull.Value)
                    this._Bodily_Injury = Convert.ToBoolean(drAuto_Loss_RMW["Bodily_Injury"]);
                this._Injury_Description = Convert.ToString(drAuto_Loss_RMW["Injury_Description"]);
                this._FK_LU_Part_Of_Body = drAuto_Loss_RMW["FK_LU_Part_Of_Body"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["FK_LU_Part_Of_Body"]) : 0;
                this._FK_LU_Nature_Of_Injury = drAuto_Loss_RMW["FK_LU_Nature_Of_Injury"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["FK_LU_Nature_Of_Injury"]) : 0;
                this._Medical_Treatment_Description = Convert.ToString(drAuto_Loss_RMW["Medical_Treatment_Description"]);
                this._Medical_Cost = drAuto_Loss_RMW["Medical_Cost"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["Medical_Cost"]) : 0;
                this._Requested_Amount = drAuto_Loss_RMW["Requested_Amount"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["Requested_Amount"]) : 0;
                this._Potential_Total_Exposure = drAuto_Loss_RMW["Potential_Total_Exposure"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["Potential_Total_Exposure"]) : 0;
                if(drAuto_Loss_RMW["Settled"] != DBNull.Value)
                    this._Settled = Convert.ToBoolean(drAuto_Loss_RMW["Settled"]);
                this._Settled_Amount = drAuto_Loss_RMW["Settled_Amount"] != DBNull.Value ? Convert.ToDecimal(drAuto_Loss_RMW["Settled_Amount"]) : 0;
                this._GM_Email_To = Convert.ToString(drAuto_Loss_RMW["GM_Email_To"]);
                if(drAuto_Loss_RMW["GM_Decision"] != DBNull.Value)
                    this._GM_Decision =  Convert.ToBoolean(drAuto_Loss_RMW["GM_Decision"]);
                this._GM_Last_Email_Date = drAuto_Loss_RMW["GM_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["GM_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._GM_Response_Date = drAuto_Loss_RMW["GM_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["GM_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._CRM_Email_To = Convert.ToString(drAuto_Loss_RMW["CRM_Email_To"]);
                if(drAuto_Loss_RMW["CRM_Decision"] != DBNull.Value)
                    this._CRM_Decision =  Convert.ToBoolean(drAuto_Loss_RMW["CRM_Decision"]);
                this._CRM_Last_Email_Date = drAuto_Loss_RMW["CRM_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["CRM_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._CRM_Response_Date = drAuto_Loss_RMW["CRM_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["CRM_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._RVP_Email_To = Convert.ToString(drAuto_Loss_RMW["RVP_Email_To"]);
                if(drAuto_Loss_RMW["RVP_Decision"] != DBNull.Value)
                    this._RVP_Decision = Convert.ToBoolean(drAuto_Loss_RMW["RVP_Decision"]);
                this._RVP_Last_Email_Date = drAuto_Loss_RMW["RVP_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["RVP_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._RVP_Response_Date = drAuto_Loss_RMW["RVP_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["RVP_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._AGC_Email_To = Convert.ToString(drAuto_Loss_RMW["AGC_Email_To"]);
                if(drAuto_Loss_RMW["AGC_Decision"] != DBNull.Value)
                    this._AGC_Decision = Convert.ToBoolean(drAuto_Loss_RMW["AGC_Decision"]);
                this._AGC_Last_Email_Date = drAuto_Loss_RMW["AGC_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["AGC_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._AGC_Response_Date = drAuto_Loss_RMW["AGC_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["AGC_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._DRM_Email_To = Convert.ToString(drAuto_Loss_RMW["DRM_Email_To"]);
                if(drAuto_Loss_RMW["DRM_Decision"] != DBNull.Value)
                    this._DRM_Decision = Convert.ToBoolean(drAuto_Loss_RMW["DRM_Decision"]);
                this._DRM_Last_Email_Date = drAuto_Loss_RMW["DRM_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["DRM_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._DRM_Response_Date = drAuto_Loss_RMW["DRM_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["DRM_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._CFO_Email_To = Convert.ToString(drAuto_Loss_RMW["CFO_Email_To"]);
                if(drAuto_Loss_RMW["CFO_Decision"] != DBNull.Value)
                    this._CFO_Decision =  Convert.ToBoolean(drAuto_Loss_RMW["CFO_Decision"]);
                this._CFO_Last_Email_Date = drAuto_Loss_RMW["CFO_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["CFO_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._CFO_Response_Date = drAuto_Loss_RMW["CFO_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["CFO_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._COO_Email_To = Convert.ToString(drAuto_Loss_RMW["COO_Email_To"]);
                if (drAuto_Loss_RMW["COO_Decision"] != DBNull.Value)
                    this._COO_Decision = Convert.ToBoolean(drAuto_Loss_RMW["COO_Decision"]);
                this._COO_Last_Email_Date = drAuto_Loss_RMW["COO_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["COO_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._COO_Response_Date = drAuto_Loss_RMW["COO_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["COO_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._President_Email_To = Convert.ToString(drAuto_Loss_RMW["President_Email_To"]);
                if(drAuto_Loss_RMW["President_Decision"] != DBNull.Value)
                    this._President_Decision = Convert.ToBoolean(drAuto_Loss_RMW["President_Decision"]);
                this._President_Last_Email_Date = drAuto_Loss_RMW["President_Last_Email_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["President_Last_Email_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._President_Response_Date = drAuto_Loss_RMW["President_Response_Date"] != DBNull.Value ? Convert.ToDateTime(drAuto_Loss_RMW["President_Response_Date"]) : (DateTime)System.Data.SqlTypes.SqlDateTime.MinValue;
                this._Comments = Convert.ToString(drAuto_Loss_RMW["Comments"]);
        ...
        #region Methods
        /// <summary>
		/// Inserts a record into the Auto_Loss_RMW table.
		/// </summary>
		/// <returns></returns>
		public int Insert()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Auto_Loss_RMWInsert");

			db.AddInParameter(dbCommand, "FK_Auto_Loss_Claims", DbType.Decimal, this._FK_Auto_Loss_Claims);
            ...
            if( this._Driver_Customer!= true && this._Driver_Customer!= false)
			    db.AddInParameter(dbCommand, "Driver_Customer", DbType.Boolean, DBNull.Value);
            else
                db.AddInParameter(dbCommand, "Driver_Customer", DbType.Boolean, this._Driver_Customer);
            if( this._Driver_Associate!= true && this._Driver_Associate!= false)
			    db.AddInParameter(dbCommand, "Driver_Associate", DbType.Boolean, DBNull.Value);
            else
                db.AddInParameter(dbCommand, "Driver_Associate", DbType.Boolean, this._Driver_Associate);
			...
			db.AddInParameter(dbCommand, "FK_LU_Part_Of_Body", DbType.Decimal, this._FK_LU_Part_Of_Body);
			db.AddInParameter(dbCommand, "FK_LU_Nature_Of_Injury", DbType.Decimal, this._FK_LU_Nature_Of_Injury);
		...
		/// <summary>
		/// Selects a single record from the Auto_Loss_RMW table by a primary key.
		/// </summary>
		/// <returns>DataSet</returns>
		public static DataSet SelectByPK(decimal pK_Auto_Loss_RMW)
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Auto_Loss_RMWSelectByPK");
        ...
        /// <summary>
        /// Selects a single record from the Auto_Loss_Claims table by a Foreign key.
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet SelectByFK(decimal FK_Auto_Loss_Claims)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Auto_Loss_RMWSelectByFK");

            db.AddInParameter(dbCommand, "FK_Auto_Loss_Claims", DbType.Decimal, FK_Auto_Loss_Claims);

            return db.ExecuteDataSet(dbCommand);
        } 
		/// <summary>
		/// Selects all records from the Auto_Loss_RMW table.
		/// </summary>
		/// <returns>DataSet</returns>
		public static DataSet SelectAll()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Auto_Loss_RMWSelectAll");

			return db.ExecuteDataSet(dbCommand);
		}

		/// <summary>
		/// Updates a record in the Auto_Loss_RMW table.
		/// </summary>
		public void Update()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Auto_Loss_RMWUpdate");

			db.AddInParameter(dbCommand, "PK_Auto_Loss_RMW", DbType.Decimal, this._PK_Auto_Loss_RMW);
            db.AddInParameter(dbCommand, "FK_Auto_Loss_Claims", DbType.Decimal, this._FK_Auto_Loss_Claims);
            db.AddInParameter(dbCommand, "Update_Date", DbType.DateTime, this._Update_Date);
            db.AddInParameter(dbCommand, "Updated_By", DbType.String, this._Updated_By);
            if (this._Claimant_Customer != true && this._Claimant_Customer != false)
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Auto_Loss_RMWUpdateByFK");
		...
		/// <summary>
		/// Deletes a record from the Auto_Loss_RMW table by a composite primary key.
		/// </summary>
		public static void DeleteByPK(decimal pK_Auto_Loss_RMW)
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("Auto_Loss_RMWDeleteByPK");
