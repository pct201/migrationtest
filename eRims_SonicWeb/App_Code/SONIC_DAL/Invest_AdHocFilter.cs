...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class Invest_AdHocFilter
    {
        ...
        /// </summary>
        public Invest_AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Invest_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<Invest_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<Invest_AdHocFilter> results = new List<Invest_AdHocFilter>();
                Invest_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("Invest_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private Invest_AdHocFilter MapFrom(IDataReader reader)
        {
            Invest_AdHocFilter objAdHoc = new Invest_AdHocFilter();
            try
            {
