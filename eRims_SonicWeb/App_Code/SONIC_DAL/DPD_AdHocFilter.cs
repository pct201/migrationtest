...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class DPD_AdHocFilter
    {
        ...
        /// </summary>
        public DPD_AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DPD_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<DPD_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<DPD_AdHocFilter> results = new List<DPD_AdHocFilter>();
                DPD_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("DPD_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private DPD_AdHocFilter MapFrom(IDataReader reader)
        {
            DPD_AdHocFilter objAdHoc = new DPD_AdHocFilter();
            try
            {
