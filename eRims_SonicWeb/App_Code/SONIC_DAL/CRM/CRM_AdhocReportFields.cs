...
namespace ERIMS.DAL
{
    public class CRM_AdhocReportFields
    {
        ...
        /// <returns></returns>
        public List<CRM_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<CRM_AdhocReportFields> results = new List<CRM_AdhocReportFields>();
                CRM_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectCRMAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<CRM_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            Database dbHelper = null;
            DbCommand cmd = null;
            IDataReader reader = null;
            try
            {
                ...
                List<CRM_AdhocReportFields> results = new List<CRM_AdhocReportFields>();
                CRM_AdhocReportFields objAdHoc = new CRM_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectCRMAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected CRM_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.CRM_AdhocReportFields objAdHoc = new ERIMS.DAL.CRM_AdhocReportFields();
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectCRMAdHocFilterFileds");
