...
{
	/// <summary>
	/// Data access class for AP_AL_FROIs table.
	/// </summary>
	public sealed class clsAP_AL_FROIs
	{

		#region Private variables used to hold the property values

		private decimal? _PK_AP_AL_FROIs;
		...
		/// <summary>
		/// Gets or sets the PK_AP_AL_FROIs value.
		/// </summary>
		public decimal? PK_AP_AL_FROIs
		{
			get { return _PK_AP_AL_FROIs; }
			set { _PK_AP_AL_FROIs = value; }
		}
		...
		/// <summary>
		/// Initializes a new instance of the clsAP_AL_FROIs class with default value.
		/// </summary>
		public clsAP_AL_FROIs() 
		{
		...
		/// <summary>
		/// Initializes a new instance of the clsAP_AL_FROIs class based on Primary Key.
		/// </summary>
		public clsAP_AL_FROIs(decimal pK_AP_AL_FROIs) 
		{
			DataTable dtAP_AL_FROIs = SelectByPK(pK_AP_AL_FROIs).Tables[0];

			if (dtAP_AL_FROIs.Rows.Count == 1)
			{
				 SetValue(dtAP_AL_FROIs.Rows[0]);
		...
		/// <summary>
		/// Initializes a new instance of the clsAP_AL_FROIs class based on Datarow passed.
		/// </summary>
		private void SetValue (DataRow drAP_AL_FROIs) 
		{
				if (drAP_AL_FROIs["PK_AP_AL_FROIs"] == DBNull.Value)
					this._PK_AP_AL_FROIs = null;
				else
					this._PK_AP_AL_FROIs = (decimal?)drAP_AL_FROIs["PK_AP_AL_FROIs"];

				if (drAP_AL_FROIs["FK_LU_Location"] == DBNull.Value)
					this._FK_LU_Location = null;
				else
					this._FK_LU_Location = (decimal?)drAP_AL_FROIs["FK_LU_Location"];

				if (drAP_AL_FROIs["FK_AL_FR"] == DBNull.Value)
					this._FK_AL_FR = null;
				else
					this._FK_AL_FR = (decimal?)drAP_AL_FROIs["FK_AL_FR"];

				if (drAP_AL_FROIs["Third_Party_Vendor_Related_Theft"] == DBNull.Value)
					this._Third_Party_Vendor_Related_Theft = null;
				else
					this._Third_Party_Vendor_Related_Theft = (string)drAP_AL_FROIs["Third_Party_Vendor_Related_Theft"];

				if (drAP_AL_FROIs["Access_Control_Failures"] == DBNull.Value)
					this._Access_Control_Failures = null;
				else
					this._Access_Control_Failures = (string)drAP_AL_FROIs["Access_Control_Failures"];

				if (drAP_AL_FROIs["Breaking_And_Entering"] == DBNull.Value)
					this._Breaking_And_Entering = null;
				else
					this._Breaking_And_Entering = (string)drAP_AL_FROIs["Breaking_And_Entering"];

				if (drAP_AL_FROIs["Burglar_Alarm_Failure"] == DBNull.Value)
					this._Burglar_Alarm_Failure = null;
				else
					this._Burglar_Alarm_Failure = (string)drAP_AL_FROIs["Burglar_Alarm_Failure"];

				if (drAP_AL_FROIs["Camera_Dead_Spot"] == DBNull.Value)
					this._Camera_Dead_Spot = null;
				else
					this._Camera_Dead_Spot = (string)drAP_AL_FROIs["Camera_Dead_Spot"];

				if (drAP_AL_FROIs["CCTV_Monitoring_Failure"] == DBNull.Value)
					this._CCTV_Monitoring_Failure = null;
				else
					this._CCTV_Monitoring_Failure = (string)drAP_AL_FROIs["CCTV_Monitoring_Failure"];

				if (drAP_AL_FROIs["CCTV_Monitoring_Failure_By_Operator"] == DBNull.Value)
					this._CCTV_Monitoring_Failure_By_Operator = null;
				else
					this._CCTV_Monitoring_Failure_By_Operator = (string)drAP_AL_FROIs["CCTV_Monitoring_Failure_By_Operator"];

				if (drAP_AL_FROIs["Design_Weakness_Property_Protection"] == DBNull.Value)
					this._Design_Weakness_Property_Protection = null;
				else
					this._Design_Weakness_Property_Protection = (string)drAP_AL_FROIs["Design_Weakness_Property_Protection"];

				if (drAP_AL_FROIs["Environmental_Obstruction_and_or_Condition_Camera"] == DBNull.Value)
					this._Environmental_Obstruction_and_or_Condition_Camera = null;
				else
					this._Environmental_Obstruction_and_or_Condition_Camera = (string)drAP_AL_FROIs["Environmental_Obstruction_and_or_Condition_Camera"];

				if (drAP_AL_FROIs["Failure_to_Report_and_or_Late_Report"] == DBNull.Value)
					this._Failure_to_Report_and_or_Late_Report = null;
				else
					this._Failure_to_Report_and_or_Late_Report = (string)drAP_AL_FROIs["Failure_to_Report_and_or_Late_Report"];

				if (drAP_AL_FROIs["Key_Swap"] == DBNull.Value)
					this._Key_Swap = null;
				else
					this._Key_Swap = (string)drAP_AL_FROIs["Key_Swap"];

				if (drAP_AL_FROIs["Lighting_Deficiencies"] == DBNull.Value)
					this._Lighting_Deficiencies = null;
				else
					this._Lighting_Deficiencies = (string)drAP_AL_FROIs["Lighting_Deficiencies"];

				if (drAP_AL_FROIs["Lock_Box_Not_Properly_Secured"] == DBNull.Value)
					this._Lock_Box_Not_Properly_Secured = null;
				else
					this._Lock_Box_Not_Properly_Secured = (string)drAP_AL_FROIs["Lock_Box_Not_Properly_Secured"];

				if (drAP_AL_FROIs["Negligence_Lack_of_key_Control_Program_Unattended_Keys"] == DBNull.Value)
					this._Negligence_Lack_of_key_Control_Program_Unattended_Keys = null;
				else
					this._Negligence_Lack_of_key_Control_Program_Unattended_Keys = (string)drAP_AL_FROIs["Negligence_Lack_of_key_Control_Program_Unattended_Keys"];

				if (drAP_AL_FROIs["Non_Permissible_User_of_Taking_Vehicle"] == DBNull.Value)
					this._Non_Permissible_User_of_Taking_Vehicle = null;
				else
					this._Non_Permissible_User_of_Taking_Vehicle = (string)drAP_AL_FROIs["Non_Permissible_User_of_Taking_Vehicle"];

				if (drAP_AL_FROIs["Power_Outage"] == DBNull.Value)
					this._Power_Outage = null;
				else
					this._Power_Outage = (string)drAP_AL_FROIs["Power_Outage"];

				if (drAP_AL_FROIs["Security_Guard_Failure"] == DBNull.Value)
					this._Security_Guard_Failure = null;
				else
					this._Security_Guard_Failure = (string)drAP_AL_FROIs["Security_Guard_Failure"];

				if (drAP_AL_FROIs["Stolen_Id"] == DBNull.Value)
					this._Stolen_Id = null;
				else
					this._Stolen_Id = (string)drAP_AL_FROIs["Stolen_Id"];

				if (drAP_AL_FROIs["Theft_By_Deception"] == DBNull.Value)
					this._Theft_By_Deception = null;
				else
					this._Theft_By_Deception = (string)drAP_AL_FROIs["Theft_By_Deception"];

				if (drAP_AL_FROIs["Unauthorized_Building_Entry_Forcible"] == DBNull.Value)
					this._Unauthorized_Building_Entry_Forcible = null;
				else
					this._Unauthorized_Building_Entry_Forcible = (string)drAP_AL_FROIs["Unauthorized_Building_Entry_Forcible"];

				if (drAP_AL_FROIs["Unauthorized_Building_Entry_Unlocked"] == DBNull.Value)
					this._Unauthorized_Building_Entry_Unlocked = null;
				else
					this._Unauthorized_Building_Entry_Unlocked = (string)drAP_AL_FROIs["Unauthorized_Building_Entry_Unlocked"];

				if (drAP_AL_FROIs["Unauthorized_Vehicle_Entry_Forcible"] == DBNull.Value)
					this._Unauthorized_Vehicle_Entry_Forcible = null;
				else
					this._Unauthorized_Vehicle_Entry_Forcible = (string)drAP_AL_FROIs["Unauthorized_Vehicle_Entry_Forcible"];

				if (drAP_AL_FROIs["Unauthorized_Vehicle_Entry_Unlocked"] == DBNull.Value)
					this._Unauthorized_Vehicle_Entry_Unlocked = null;
				else
					this._Unauthorized_Vehicle_Entry_Unlocked = (string)drAP_AL_FROIs["Unauthorized_Vehicle_Entry_Unlocked"];

				if (drAP_AL_FROIs["Vehicle_Taken_By_Tow_Truck"] == DBNull.Value)
					this._Vehicle_Taken_By_Tow_Truck = null;
				else
					this._Vehicle_Taken_By_Tow_Truck = (string)drAP_AL_FROIs["Vehicle_Taken_By_Tow_Truck"];

				if (drAP_AL_FROIs["Weather_Related_Damage_and_or_Loss"] == DBNull.Value)
					this._Weather_Related_Damage_and_or_Loss = null;
				else
					this._Weather_Related_Damage_and_or_Loss = (string)drAP_AL_FROIs["Weather_Related_Damage_and_or_Loss"];

				if (drAP_AL_FROIs["Other_Describe"] == DBNull.Value)
					this._Other_Describe = null;
				else
					this._Other_Describe = (string)drAP_AL_FROIs["Other_Describe"];

				if (drAP_AL_FROIs["Investigation_Finding_Other_Description"] == DBNull.Value)
					this._Investigation_Finding_Other_Description = null;
				else
					this._Investigation_Finding_Other_Description = (string)drAP_AL_FROIs["Investigation_Finding_Other_Description"];

				if (drAP_AL_FROIs["Root_Cause"] == DBNull.Value)
					this._Root_Cause = null;
				else
					this._Root_Cause = (string)drAP_AL_FROIs["Root_Cause"];

				if (drAP_AL_FROIs["Incident_Prevention"] == DBNull.Value)
					this._Incident_Prevention = null;
				else
					this._Incident_Prevention = (string)drAP_AL_FROIs["Incident_Prevention"];

				if (drAP_AL_FROIs["Person_Tasked"] == DBNull.Value)
					this._Person_Tasked = null;
				else
					this._Person_Tasked = (string)drAP_AL_FROIs["Person_Tasked"];

				if (drAP_AL_FROIs["Target_Date_of_Completion"] == DBNull.Value)
					this._Target_Date_of_Completion = null;
				else
					this._Target_Date_of_Completion = (DateTime?)drAP_AL_FROIs["Target_Date_of_Completion"];

				if (drAP_AL_FROIs["Status_Due_On"] == DBNull.Value)
					this._Status_Due_On = null;
				else
					this._Status_Due_On = (DateTime?)drAP_AL_FROIs["Status_Due_On"];

				if (drAP_AL_FROIs["Comments"] == DBNull.Value)
					this._Comments = null;
				else
					this._Comments = (string)drAP_AL_FROIs["Comments"];

				if (drAP_AL_FROIs["Financial_Loss"] == DBNull.Value)
					this._Financial_Loss = null;
				else
					this._Financial_Loss = (decimal?)drAP_AL_FROIs["Financial_Loss"];

				if (drAP_AL_FROIs["Recovery"] == DBNull.Value)
					this._Recovery = null;
				else
					this._Recovery = (decimal?)drAP_AL_FROIs["Recovery"];

				if (drAP_AL_FROIs["Item_Status"] == DBNull.Value)
					this._Item_Status = null;
				else
					this._Item_Status = (string)drAP_AL_FROIs["Item_Status"];

				if (drAP_AL_FROIs["Updated_By"] == DBNull.Value)
					this._Updated_By = null;
				else
					this._Updated_By = (string)drAP_AL_FROIs["Updated_By"];

				if (drAP_AL_FROIs["Update_Date"] == DBNull.Value)
					this._Update_Date = null;
				else
					this._Update_Date = (DateTime?)drAP_AL_FROIs["Update_Date"];
		...
		/// <summary>
		/// Inserts a record into the AP_AL_FROIs table.
		/// </summary>
		/// <returns></returns>
		public int Insert()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("AP_AL_FROIsInsert");
		...
		/// <summary>
		/// Selects a single record from the AP_AL_FROIs table by a primary key.
		/// </summary>
		/// <returns>DataSet</returns>
		private DataSet SelectByPK(decimal pK_AP_AL_FROIs)
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("AP_AL_FROIsSelectByPK");
		...
		/// <summary>
		/// Selects all records from the AP_AL_FROIs table.
		/// </summary>
		/// <returns>DataSet</returns>
		public static DataSet SelectAll()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("AP_AL_FROIsSelectAll");

			return db.ExecuteDataSet(dbCommand);
		}

		/// <summary>
		/// Updates a record in the AP_AL_FROIs table.
		/// </summary>
		public void Update()
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("AP_AL_FROIsUpdate");

			
			db.AddInParameter(dbCommand, "PK_AP_AL_FROIs", DbType.Decimal, this._PK_AP_AL_FROIs);
		...
		/// <summary>
		/// Deletes a record from the AP_AL_FROIs table by a composite primary key.
		/// </summary>
		public static void DeleteByPK(decimal pK_AP_AL_FROIs)
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("AP_AL_FROIsDeleteByPK");
        ...
        /// 
        /// </summary>
        /// <param name="PK_AL_FR_ID"></param>
        /// <returns></returns>
        public static DataSet GetAL_FROIs_DetailByPK(decimal PK_AL_FR_ID)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AL_FROIs_GetAL_DetailByPK");
        ...
        /// <returns></returns>
        public static DataSet GetClaimNotesByPk(decimal PK_AL_FR_ID, int intPageNo, int intPageSize)
        {
            Database db = DatabaseFactory.CreateDatabase();
            
            DbCommand dbCommand = db.GetStoredProcCommand("AP_AL_FROIs_GetClaimNotesByPk");
