...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class AdHocFilterDealershipDetails
    {
        ...
        /// </summary>
        public AdHocFilterDealershipDetails()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the AdHocFilterDealershipDetails class based on Primary Key.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a record into the AdHocFilterDealershipDetails table.
        /// </summary>
        /// <returns></returns>
        public int Insert()
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DealershipDetails_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("DealershipDetails_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<AdHocFilterDealershipDetails> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<AdHocFilterDealershipDetails> results = new List<AdHocFilterDealershipDetails>();
                AdHocFilterDealershipDetails objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("DealershipDetails_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private AdHocFilterDealershipDetails MapFrom(IDataReader reader)
        {
            AdHocFilterDealershipDetails objAdHoc = new AdHocFilterDealershipDetails();
            try
            {
