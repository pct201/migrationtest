...
{
    /// <summary>
    /// Summary description for Management_AdHocReport
    /// </summary>
    public sealed class Management_AdHocReport
    {

        #region Private variables used to hold the property values

        private decimal? _PK_Management_AdHocReport;
        ...
        /// <summary>
        /// Gets or sets the PK_Management_AdHocReport value.
        /// </summary>
        public decimal? PK_Management_AdHocReport
        {
            get { return _PK_Management_AdHocReport; }
            set { _PK_Management_AdHocReport = value; }
        }
        ...
        /// </summary>
        public Management_AdHocReport()
        {
         
            this._PK_Management_AdHocReport = null;
        ...
        /// </summary>
        public Management_AdHocReport(decimal PK_Management_AdHocReport)
        {
            DataTable dtAdHocReport = SelectByPK(PK_Management_AdHocReport).Tables[0];

            if (dtAdHocReport.Rows.Count == 1)
            {
                DataRow drAdHocReport = dtAdHocReport.Rows[0];
                if (drAdHocReport["PK_Management_AdHocReport"] == DBNull.Value)
                    this._PK_Management_AdHocReport = null;
                else
                    this._PK_Management_AdHocReport = (decimal?)drAdHocReport["PK_Management_AdHocReport"];
        ...
        public decimal Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("Management_AdHocReportInsert");
        ...
        private static DataSet SelectByPK(decimal PK_Management_AdHocReport)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Management_AdHocReportSelectByPK");

            db.AddInParameter(dbCommand, "PK_Management_AdHocReport", DbType.Decimal, PK_Management_AdHocReport);
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Management_AdHocReportUpdate");


            db.AddInParameter(dbCommand, "PK_Management_AdHocReport", DbType.Decimal, this._PK_Management_AdHocReport);
        ...
        /// </summary>
        public static void DeleteByPK(decimal PK_Management_AdHocReport)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Management_AdHocReportDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Management_AdHocReportSelectByCoverage");
        ...
        /// <param name="CoverageType"></param>
        /// <returns></returns>
        public static DataTable ExistsReportName(string CoverageType, string ReportName, decimal PK_Management_AdHocReport)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("Management_AdHocReportExistsReport");
