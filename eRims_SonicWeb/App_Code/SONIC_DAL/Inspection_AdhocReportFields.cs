...
namespace ERIMS.DAL
{
    public class Inspection_AdhocReportFields
    {
        ...
        /// Default Constructor
        /// </summary>
        public Inspection_AdhocReportFields()
        {
        ...
        /// <returns></returns>
        public List<Inspection_AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<Inspection_AdhocReportFields> results = new List<Inspection_AdhocReportFields>();
                Inspection_AdhocReportFields objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("SelectInspectionAdHocReportField_ByPk");
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<Inspection_AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            Database dbHelper = null;
            DbCommand cmd = null;
            IDataReader reader = null;
            try
            {
                ...
                List<Inspection_AdhocReportFields> results = new List<Inspection_AdhocReportFields>();
                Inspection_AdhocReportFields objAdHoc = new Inspection_AdhocReportFields();

                dbHelper = DatabaseFactory.CreateDatabase();
                cmd = dbHelper.GetStoredProcCommand("SelectInspectionAdHocReportWhereFileld");
        ...
        /// <returns></returns>
        protected Inspection_AdhocReportFields MapFrom(IDataReader reader)
        {
            ERIMS.DAL.Inspection_AdhocReportFields objAdHoc = new ERIMS.DAL.Inspection_AdhocReportFields();
        ...
        /// <param name="strFieldType"></param>
        /// <returns></returns>
        public static DataSet GetAdHocFilterFields(string strFieldType,string strIncidentType)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("SelectInspectionAdHocFilterFileds");
                       
            db.AddInParameter(dbCommand, "FieldType", DbType.String, strFieldType);
            db.AddInParameter(dbCommand, "IncidentType", DbType.String, strIncidentType);
