...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class EPM_AdHocFilter
    {
        ...
        /// </summary>
        public EPM_AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("EPM_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("EPM_AdHocFilterDeleteByFK");
        ...
        /// <returns></returns>
        public List<EPM_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<EPM_AdHocFilter> results = new List<EPM_AdHocFilter>();
                EPM_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("EPM_AdHocFilterSelectByFK");
        ...
        /// <returns></returns>
        private EPM_AdHocFilter MapFrom(IDataReader reader)
        {
            EPM_AdHocFilter objAdHoc = new EPM_AdHocFilter();
            try
            {
