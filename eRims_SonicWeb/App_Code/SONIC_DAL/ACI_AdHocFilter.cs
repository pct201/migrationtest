...
namespace ERIMS.DAL
{
    ...
    /// </summary>
    public sealed class ACI_AdHocFilter
    {
        ...
        /// </summary>
        public ACI_AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        public int Insert()
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("ACI_AdHocFilterInsert");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("ACI_AdHocFilterSelectByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("ACI_AdHocFilterUpdate");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("ACI_AdHocFilterDeleteByPK");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("ACI_AdHocFilterDeleteByFK_AdHocReport");
        ...
        /// <returns></returns>
        public List<ACI_AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<ERIMS.DAL.ACI_AdHocFilter> results = new List<ERIMS.DAL.ACI_AdHocFilter>();
                ERIMS.DAL.ACI_AdHocFilter objAdHoc;

                cmd = dbHelper.GetStoredProcCommand("ACI_AdHocFilterSelectByFkAdHocReport");
        ...
        /// <returns></returns>
        private ERIMS.DAL.ACI_AdHocFilter MapFrom(IDataReader reader)
        {
            ERIMS.DAL.ACI_AdHocFilter objAdHoc = new ERIMS.DAL.ACI_AdHocFilter();
            try
            {
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("ACI_AdHocReport_Schedule_SelectByFK");
