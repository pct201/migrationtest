                ...
                <div style="overflow: scroll; width: 997px; height: 398px;" id="dvGrid" runat="server">
                    <asp:GridView ID="gvDescription" EnableTheming="false" DataKeyNames="dba" runat="server"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <table width="4180px" cellpadding="4" cellspacing="0" border="0" style="font-weight: bold;"
                                ...
                                <ItemTemplate>
                                    <table width="4180px" cellpadding="4" cellspacing="0" border="0" id="tblDetails"
                                        ...
                                        <tr align="left" valign="top">
                                            ...
                                            <td width="150px" align="left">
                                                <%# Eval("PropertyInsurenceRequired")%>
                                            </td>
                                            <td width="150px" align="left">
                                                <%# Eval("COIInCompliance")%>
                                            </td>
                                            <td width="180px" align="left">
                                                <%# Convert.ToString(Eval("Coverage_Type")).Replace("<br/>","<br style='mso-data-placement:same-cell;'/>") %>
                                            </td>
                                            <td width="100px" align="left">
                                                <%# Convert.ToString(Eval("Effective_Date")).Replace("<br/>", "<br style='mso-data-placement:same-cell;'/>")%>
                                            </td>
                                            <td width="100px" align="left">
                                                <%# Convert.ToString(Eval("Expiration_Dates")).Replace("<br/>", "<br style='mso-data-placement:same-cell;'/>")%>
                                            </td>
                                            <td width="180px" align="left">
                                                <%# Convert.ToString(Eval("Risk_Profile_Category")).Replace("<br/>", "<br style='mso-data-placement:same-cell;'/>")%>
                                            </td>
                                            <td width="150px" align="right">
                                                <%# Convert.ToString(Eval("RiskProfileLimit")).Replace("<br/>", "<br style='mso-data-placement:same-cell;'/>")%>
                                            </td>
                                            <td width="130px" align="right">
                                                <%# Convert.ToString(Eval("COILimits")).Replace("<br/>", "<br style='mso-data-placement:same-cell;'/>")%>
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
