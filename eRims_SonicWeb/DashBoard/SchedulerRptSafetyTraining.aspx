<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchedulerRptSafetyTraining.aspx.cs" Inherits="DashBoard_SchedulerRptSafetyTraining"  %>
...
<head id="Head1" runat="server">
    ...
    <title>eRIMS Sonic :: Safety Training Inspection Report</title>
</head>
<body>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            <tr>
                <td align="left" class="ghc">Safety Training Inspection Report
                </td>
            </tr>
            <tr>
                    ...
                    <table border="0" cellpadding="5" cellspacing="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left" nowrap="nowrap">
                                <asp:TextBox runat="server" ID="txtScheduleDate" Width="175px" ></asp:TextBox>
