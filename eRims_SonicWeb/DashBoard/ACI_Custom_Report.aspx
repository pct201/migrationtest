<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="ACI_Custom_Report.aspx.cs" Inherits="ACI_Custom_Report" %>
    ...
    <table width="100%" cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td align="left" class="ghc" >
                <asp:Label ID="lblHeading" runat="server" Text="ACI Custom Report"></asp:Label>
            </td>
        </tr>
        <tr>
            <td width="100%" class="Spacer" style="height: 3px;">
            ...
            <td align="center" width="100%">
                <table border="0" cellpadding="5" cellspacing="1" width="80%" align="center">
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox ID="txtFrom_Date_Of_Event" runat="server" Width="160px" SkinID="txtDate"
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox ID="txtTo_Date_Of_Event" runat="server" Width="160px" SkinID="txtDate"
                                MaxLength="10"></asp:TextBox>
