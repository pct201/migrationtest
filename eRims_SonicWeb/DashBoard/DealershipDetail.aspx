    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlAggregatePerformance" runat="server" Visible="false">
            <table width="100%" style="text-align: left" cellpadding="2" cellspacing="3">
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><asp:Label ID="lblScoreSLT" runat="server" /></td>
                </tr>
                <tr>
                    <td align="left" valign="top">Facility Inspection</td>
                    <td align="center" valign="top">:</td>
                    <td align="left" valign="top"><asp:Label ID="lblScoreFacility" runat="server" /></td>
                </tr>
                <tr>
                    <td align="left" valign="top">Sonic University Training</td>
                    <td align="center" valign="top">:</td>
                    <td align="left" valign="top"><asp:Label ID="lblScoreTraining" runat="server" /></td>
                </tr>
                <tr>
                    <td align="left" valign="top">Incident Investigation</td>
                    <td align="center" valign="top">:</td>
                    <td align="left" valign="top"><asp:Label ID="lblScoreIncidentInvestigation" runat="server" /></td>
                </tr>
                <tr>
                    <td align="left" valign="top">Worker's Compensation Claims Management</td>
                    <td align="center" valign="top">:</td>
                    <td align="left" valign="top"><asp:Label ID="lblScoreWCClaim" runat="server" /></td>
                </tr>
                <tr>
                    <td align="left" valign="top">Incident Reduction</td>
                    <td align="center" valign="top">:</td>
                    <td align="left" valign="top"><asp:Label ID="lblScoreIncidentReduction" runat="server" /></td>
                </tr>
                <tr>
                    <td>
                        &nbsp;
                ...
                <tr>
                    ...
                    <td align="center" valign="top">:</td>
                    <td align="left" valign="top"><asp:Label ID="lblScoreTotal" runat="server" />&nbsp;out of possible 200</td>
                </tr>
                <tr>
                    <td>
                        &nbsp;
                ...
                <tr>
                    ...
                    <td align="center" valign="top">:</td>
                    <td align="left" valign="top"><asp:Label ID="lblResultingScore" runat="server" /></td>
                </tr>
             </table>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlIncidentInvestigation" runat="server" Visible="false">
            <table width="100%" style="text-align: left" cellpadding="2" cellspacing="3">
                ...
                <tr>
                    <td>
                        Total Number of Investigations for Calendar Year
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
                ...
                <tr>
                    <td>
                        Average Investigative Quality Score
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
        ...
        <asp:Panel ID="pnlInvestigationReduction" runat="server" Visible="false">
            <table width="100%" style="text-align: left" cellpadding="2" cellspacing="3">
                ...
                <tr align="left" style="width: 40%">
                    <td>
                        Number of Incidents with S1 Causes
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
                ...
                <tr align="left" style="width: 40%">
                    <td>
                        Number of Incidents with S0-1 Causes
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
                ...
                <tr align="left" style="width: 40%">
                    <td>
                        Number of Incidents with S2 Causes
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
                ...
                <tr align="left" style="width: 40%">
                    <td>
                        Number of Incidents with S0-2 Causes
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
        ...
        <asp:Panel ID="pnlWCClaimMgmt" runat="server" Visible="false">
            <table width="100%" style="text-align: left" cellpadding="2" cellspacing="3">
                ...
                <tr>
                    <td>
                        Average Claim Closure for past 200 days
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
        ...
        <table width="100%" style="text-align: left" cellpadding="2" cellspacing="3">
                ...
                <tr>
                    <td>
                        Meeting held and 100% Participation
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
                ...
                <tr>
                    <td>
                       Saftey Walk conducted and 100% participated
                    </td>
                    <td align="center" style="width: 5%">
                        :
                    </td>
