...
public partial class DashBoard_RlcmQuarterlyReport : clsBasePage
{
    ...
    private void GetTreadLineStyle(StringBuilder strChartXML, decimal Average)
    {
        ...
        strChartXML.Append("<line startValue='9.8' color='49563A' displayvalue='" + Charts.Tin_Label + "' /> ");
        strChartXML.Append("<line startValue='11.2' color='49563A' displayvalue='" + Charts.Bronze_Label + "' /> ");
        strChartXML.Append("<line startValue='12.6' color='49563A' displayvalue='" + Charts.Silver_Label + "' /> ");
        strChartXML.Append("<line startValue='13.3' color='49563A' displayvalue='" + Charts.Gold_Label + "' /> ");
