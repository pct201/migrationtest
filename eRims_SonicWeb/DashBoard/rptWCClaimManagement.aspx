<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="rptWCClaimManagement.aspx.cs" Inherits="rptWCClaimManagement" %>
    ...
    <table width="100%" cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td align="left" class="ghc" colspan="2">
                <asp:Label ID="lblHeading" runat="server" Text="Worker's Compensation Claims Management Report"></asp:Label>
            </td>
        </tr>
        <tr>
            <td width="100%" class="Spacer" style="height: 3px;" colspan="2">
