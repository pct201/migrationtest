...
using System.IO;
using ERIMS.DAL;
public partial class rptIncidentReduction : clsBasePage
{
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        ...
        lblHeading.Text = "Incident Reduction Report";
    }
    #endregion
    ...
    private System.Text.StringBuilder GenerageMonthlyReport()
    {
        ...
        if (dtRegions.Rows.Count > 0)
        {
            ...
            sbRecorords.Append("<td align='center' style='font-size:9pt;' colspan='9' ><b> INCIDENT REDUCTION - MONTHLY REPORT FOR " + drpYear.SelectedValue + " </b></td>");
    ...
    private System.Text.StringBuilder GenerageQuarterlyReport()
    {
        ...
        if (dtRegions.Rows.Count > 0)
        {
            ...
            sbRecorords.Append("<td align='center' style='font-size:9pt;' colspan='3' ><b> INCIDENT REDUCTION - QUARTERLY REPORT FOR " + drpYear.SelectedValue + " </b></td>");
    ...
    private System.Text.StringBuilder GenerageAnnaulyReport()
    {
        ...
        if (dtRegions.Rows.Count > 0)
        {
            ...
            sbRecorords.Append("<tr style='font-weight: bold;background-color:#7f7f7f;color:White;font-size:11pt;height:25'>"); //Title
            sbRecorords.Append("<td align='left' style='font-size:9pt;' colspan='1'><b>Sonic Automotive</b></td>");
            sbRecorords.Append("<td align='center' style='font-size:9pt;' colspan='4' ><b> INCIDENT REDUCTION - ANNAUL REPORT FOR " + drpYear.SelectedValue + " </b></td>");
            sbRecorords.Append("<td style='font-size:9pt' align='right' colspan='3'>Valuation Date: " + DateTime.Now.ToString("MM/dd/yyy HH:mm tt") + "</td></tr>");
