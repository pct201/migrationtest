...
public partial class ScheduleRptIncidentInvestigation : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            Tatva_RptIncidentInvestigationSchedule obj = new Tatva_RptIncidentInvestigationSchedule();
