<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleInsurance.aspx.cs" Inherits="Policy_ScheduleInsurance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>eRIMS Sonic :: Policy – Insurance Schedule Report</title>
</head>
<body>
    ...
    <table width="100%">
        <tr>
            <td align="left" class="ghc">
                Policy – Insurance Schedule Report
            </td>
        </tr>
        <tr>
            ...
            <td align="center">
                <table border="0" cellpadding="5" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td align="left" width="150">
                            <asp:DropDownList ID="drpRecurringPeriod" runat="server"  Width="200px" EnableTheming="True" SkinID="dropGen"
                                >
