<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.master" CodeFile="Diary.aspx.cs"
    Inherits="Liability_Diary" Title="Risk Management Insurance System" Theme="Default"
      %>
...
//    }
//     function focussecond(control)
//    {
//        clearfocus();        
//        document.getElementById(control).className="left_menu_active";        
//        document.getElementById("ctl00_ContentPlaceHolder1_divSearch").style.display = "block"; 
//        document.getElementById("ctl00_ContentPlaceHolder1_divthird").style.display = "block";        
//    }
//    function clearfocus()
//    {
//        document.getElementById("ctl00_ContentPlaceHolder1_first").className="left_menu";     
//        document.getElementById("ctl00_ContentPlaceHolder1_second").className="left_menu";     
//        
                                                            ...
                                                            <tr>
                                                                <td style="text-align: left;">
                                                                    <asp:GridView ID="gvDiaryDetails" runat="server" AutoGenerateColumns="false" OnRowCommand="gvDiaryDetails_RowCommand"
                                                                        ...
                                                                        AllowPaging="True" AllowSorting="True" OnSorting="gvDiaryDetails_Sorting">
                                                                        <Columns>
                                                                            <asp:TemplateField>
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Date Of Note Entry" SortExpression="Diary_Date">
                                                                                <ItemTemplate>
                                                                                ...
                                                                                <table cellpadding="2" cellspacing="2" style="width:100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width:25%;" align="left" class="ic">
                                                                                            ...
                                                                                            <asp:RequiredFieldValidator ID="rfvIDiaryDate" ControlToValidate="txtIDiaryDate" Display="None" 
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" class="ic" colspan="4" style="width:75%;">
                                                                                            <asp:TextBox runat="server" ID="txtINote" MaxLength="4000" TextMode="MultiLine" Width="93%"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" class="lc" style="width:25%;">
                                                                                        ...
                                                                                        <td align="left" class="ic" style="width:25%;">
                                                                                            ...
                                                                                            <asp:RadioButton runat="server" GroupName="Clear" ID="rbIClearNo" Text="No" />
                                                                                        </td>
                                                                                        <td align="left" class="lc" style="width:25%;">
                                                                                        ...
                                                                                        <td align="left" class="ic" style="width:25%;">
                                                                                            <asp:TextBox runat="server" ID="txtIAssignTo" ReadOnly="true"></asp:TextBox>&nbsp;
                                                                                            <asp:Button ID="btnIAssignTO" Text=">>" runat="server" CssClass="btn" />
                                                                            ...
                                                                            <div>
                                                                                <table cellpadding="2" cellspacing="2" style="width:100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" class="ic" colspan="4" style="width:75%;">
                                                                                            <asp:TextBox runat="server" ID="txtNote" MaxLength="4000" TextMode="MultiLine" Width="93%"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" class="lc" style="width:25%">
                                                                                        ...
                                                                                        <td align="left" class="ic" style="width:25%">
                                                                                            ...
                                                                                            <asp:RadioButton runat="server" GroupName="Clear" ID="rbClearNo" Text="No" />
                                                                                        </td>
                                                                                        <td align="left" class="lc" style="width:25%">
                                                                                            <asp:Label runat="server" ID="lblAssignTo">Assigned To</asp:Label>
                                                                                            <span class="mf">*</span>
                                                                                        ...
                                                                                        <td align="left" class="ic" style="width:25%">
                                                                                            <asp:TextBox runat="server" ID="txtAssignTo" Enabled="false"></asp:TextBox>&nbsp;
                                                                                            <asp:Button ID="btnAssignTO" Text=">>" runat="server" CssClass="btn" />
                                                                            ...
                                                                            <div>
                                                                                <table cellpadding="2" cellspacing="2" style="width:100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width:25%;" align="left" class="lc">
                                                                                            <asp:Label runat="server" ID="Label1"> Diary Date</asp:Label>
                                                                                        </td>
                                                                                        <td  align="Center" class="lc">
                                                                                            :
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" class="lc" style="width:25;">
                                                                                            <asp:Label runat="server" ID="Label2">Note</asp:Label>
                                                                                        </td>
                                                                                        <td align="Center" class="lc">
                                                                                            :
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" class="lc" style="width:25;">
                                                                                            <asp:Label runat="server" ID="Label3"> Clear?</asp:Label>
                                                                                        </td>
                                                                                        <td align="Center" class="lc">
                                                                                            :
                                                                                        </td>
                                                                                        ...
                                                                                        <td align="left" class="lc" style="width:25;">
                                                                                            <asp:Label runat="server" ID="Label4">Assigned To</asp:Label> 
                                                                                        </td>
                                                                                        <td align="Center" class="lc">
                                                                                            :
                                                                                        </td>
