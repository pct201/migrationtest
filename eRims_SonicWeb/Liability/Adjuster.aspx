        ...
        <div id="Div1" runat="server" style="width: 100%; text-align: left;">
            <table border="0" cellpadding="1" cellspacing="0" width="88%">
                <tr>
                    ...
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                        <a class="main_menu" href="Subrogation.aspx">Subrogation Detail</a>
                    </td>
                    <td align="center" class="normal_tab" style="background-image: url('../images/normal_btn.jpg')"
                        valign="middle">
                                                        ...
                                                        <div>
                                                            <table cellpadding="2" cellspacing="2" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" class="ic">
                                                                        <asp:TextBox ReadOnly="true" MaxLength="30" runat="server" ID="txtAuthor" Text='<%#Eval("Author_Of_Note") %>'></asp:TextBox>
                                                                    </td>
                                                                    <td align="left" class="lc">
                                                                        Note Type <span class="mf">*</span>
                                                                    </td>
                                                                    <td align="Center" class="lc">
                                                                        :
                                                                    </td>
                                                                    <td align="left" class="ic">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="rfvNoteType" runat="server" ControlToValidate="dwNoteType"
                                                                            InitialValue="--Select Note Type--" Display="none" ErrorMessage="Please Select Note Type" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" class="lc">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" class="ic" colspan="4">
                                                                        <asp:TextBox runat="server" ID="txtNote" MaxLength="2000" TextMode="MultiLine" Width="93.5%" Text='<%#Eval("Notes") %>'></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                            ...
                                                            <table cellpadding="2" cellspacing="2" class="stylesheet" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4" class="ic">
                                                                        <asp:TextBox ID="txtDescription" runat="server" MaxLength="2000" TextMode="MultiLine" Width="93.5%"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="lc">
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                <tr>
                                                                    <td class="ic" align="center">
                                                                        <asp:Button ID="btnAddAttachment" runat="server" Text="Add Attachment" OnClientClick="javascript:return ValidAttachment();"
                                                        ...
                                                        <div>
                                                            <table cellpadding="2" cellspacing="2" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" class="ic">
                                                                        <asp:TextBox runat="server" MaxLength="30" ReadOnly="true" ID="txtAuthor"></asp:TextBox>
                                                                    </td>
                                                                    <td align="left" class="lc">
                                                                        Note Type <span class="mf">*</span>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" class="ic" colspan="4">
                                                                        <asp:TextBox runat="server" ID="txtNote" MaxLength="4000" TextMode="MultiLine" Width="93.5%"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                        <div style="width: 100%;" id="divAttachment">
                                                            <table cellpadding="2" cellspacing="0" class="stylesheet" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4" class="ic">
                                                                        <asp:TextBox ID="txtDescription" runat="server" MaxLength="4000" TextMode="MultiLine" Width="93.5%"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="lc">
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" class="ic">
                    ...
                    <asp:Button runat="server" ID="btnNextStep" SkinID="btnGen" EnableTheming="false" Visible="false"
