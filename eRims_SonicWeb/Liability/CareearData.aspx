<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="CareearData.aspx.cs"
    Inherits="Liability_CareearData" Title="Carrier Data" Theme="Default"   %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%" id="contmain">
        ...
        <div id="Div1" runat="server" style="width: 100%; text-align: left">
            <table border="0" cellpadding="1" cellspacing="0" width="88%">
                <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="95%">
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td>
                        <a class="left_menu" id="second" onclick="javascript:getsecond();" href="#">
                        Carrier Data Information</a>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <div id="mainContent" runat="server" style="border: solid 1px #7F7F7F; width: 79%;
            ...
            <div style="width: 100%; display: none;" id="divsecond" runat="server">
                <table cellpadding="2" cellspacing="0" class="stylesheet">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="lc" style="width: 21%;">
                            <asp:Label runat="server" ID="lblMDefenseMedicalEva">Defense Medical Evaluation paid <br />to
                            Date </asp:Label>
                        ...
                        <td class="ic" style="width: 27%;">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvDefenseMedicalEva" Display="None"
                                ErrorMessage="Please Enter Defense Medical Evaluation paid to Date." ValidationGroup="vsErrorGroup"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvEmpLegalExp" Display="None" ErrorMessage="Please Enter Employer Legal Expense to Date."
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvExpertWitnessPaid" Display="None"
                                ErrorMessage="Please Enter Expert Witness Paid To Date." ValidationGroup="vsErrorGroup"
                    ...
                    <tr>
                        ...
                        <td class="ic" colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvMajorClassCode" Display="None"
                                ErrorMessage="Please Select Major Class Code." InitialValue="--Select Major Class Code--"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLumpSumRemarriage" Display="None"
                                ErrorMessage="Please Enter Lump Sum Remarriage Payment." InitialValue="" ValidationGroup="vsErrorGroup"
                    ...
                    <tr>
                        ...
                        <td class="ic" colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondAct" Display="None" ErrorMessage="Please Select Loss Condition Act."
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondRecovery" Display="None"
                                ErrorMessage="Please Select Loss Condition Type Recovery." InitialValue="--Select Loss Condition Type Recovery--"
                    ...
                    <tr>
                        ...
                        <td class="ic" colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCoverageCode" Display="None"
                                ErrorMessage="Please Select Loss Coverage Code." InitialValue="--Select Loss Coverage Code--"
                    ...
                    <tr>
                        ...
                        <td class="ic" style="height: 40px">
                            $<asp:TextBox ID="txtPenaltyPaid" SkinID="txtCarrier" runat="server" MaxLength="11"
                                onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvPenaltyPaid" Display="None" ErrorMessage="Please Enter Penalties Paid To Date."
                        ...
                        <td style="height: 40px" class="ic">
                            $<asp:TextBox ID="txtPensionIndem" SkinID="txtCarrier" runat="server" onKeyPress="return(currencyFormat(this,',','.',event))"
                                MaxLength="11"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvPensionIndem" Display="None" ErrorMessage="Please Enter Pension Indemnity Benefit Paid To Valuation Date."
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvGarageState" Display="None" ErrorMessage="Please Select Garage State."
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <cc1:MaskedEditValidator ID="mskValDtStart" runat="server" ControlExtender="mskSingleSumPaidDate"
                                ControlToValidate="txtSingleSumPaidDate" Display="dynamic" IsValidEmpty="true"
                            ...
                            <asp:RegularExpressionValidator ID="revIDONoteEntry" runat="server" ControlToValidate="txtSingleSumPaidDate"
                                ...
                                ErrorMessage="Date Not Valid" Display="none" ValidationGroup="vsErrorGroup"></asp:RegularExpressionValidator>
                        </td>
                        <td class="lc">
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLumpSumSettleAmt" Display="None"
                                ErrorMessage="Please Enter Lump Sum Settlement Amount." InitialValue="" ValidationGroup="vsErrorGroup"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvContovertedcase" Display="None"
                                ErrorMessage="Please Select Controverter Case?." InitialValue="" ValidationGroup="vsErrorGroup"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondLoss" Display="None" ErrorMessage="Please Select Loss Conditions Loss."
                                InitialValue="--Select Loss Condition Loss--" ValidationGroup="vsErrorGroup"
                                ControlToValidate="dwLossCondLoss">
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="lc">
                            <asp:Label runat="server" ID="lblMLossCondSettlement">Loss Condition Settlement </asp:Label>
                            <span class="mf">*</span></td>
                        <td>
                            :
                        </td>
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLossCondSettlement" Display="None"
                                ErrorMessage="Please Select Loss Condition Settlement." InitialValue="--Select Condition Settlement--"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvDeductibleIndicator" Display="None"
                                ErrorMessage="Please Select Deductible Indicator." InitialValue="" ValidationGroup="vsErrorGroup"
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvDeductRaimbursh" Display="None"
                                ErrorMessage="Please Enter Deductible Reimbursement Amount." InitialValue=""
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvSettlementMethod" Display="None"
                                ErrorMessage="Please Select Settlement Method." InitialValue="--Select Settlement Method--"
                    ...
                    <tr>
                        ...
                        <td class="ic">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvLegalRepresant" Display="None"
                                ErrorMessage="Please Select Legal Representation." InitialValue="" ValidationGroup="vsErrorGroup"
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvAttorneyForm" Display="None" ErrorMessage="Please Select Attorney form."
        ...
        <div style="width: 100%;">
            <table cellpadding="2" cellspacing="4" class="stylesheet" width="100%">
                ...
                <tr>
                    ...
                    <td class="lc">
                        <asp:Label runat="server" ID="lblVTypeCode">Type Code</asp:Label>
                    </td>
                    <td align="center">
                        :
                    </td>
