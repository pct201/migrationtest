...
public partial class Liability_Subrogation : System.Web.UI.Page
{
    ...
    public string m_strFolderName = "Liability_Subrogation";
    ...
    protected void btnNextStep_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("subrogationDetails.aspx");
    ...
    protected void btnAddAttachment_Click(object sender, EventArgs e)
    {
        ...
        ((DropDownList)fvSubrogation.FindControl("ddlAttachType")).SelectedIndex = 0;
    ...
    protected void fvSubrogation_DataBound(object sender, EventArgs e)
    {
        try
        {
            ...
            if (fvSubrogation.CurrentMode != FormViewMode.ReadOnly)
            {
                ...
                ((DropDownList)fvSubrogation.FindControl("dwPaymentID")).DataTextField = "VendorType_FLD_Desc";
    ...
    private void InsertUpdate()
    {
        ...
        if (ViewState["Subrogation_ID"] != null && ViewState["Subrogation_ID"].ToString() != String.Empty)
        {
            ...
            objSubrogation.Updated_By = "UserName";
        }
        ...
        if (((DropDownList)fvSubrogation.FindControl("dwProviderName")).SelectedIndex != 0)
            objSubrogation.FK_Provider = Convert.ToDecimal(((DropDownList)fvSubrogation.FindControl("dwProviderName")).SelectedValue);
