...
using System.IO;
public partial class Liability_subrogationDetails : System.Web.UI.Page
{
    #region Variable
    ...
    public string m_strFolderName = "Liability_Subrogation_Detail";
    ...
    private void InsertUpdateData()
    {
        try
        {
            ...
            if (ViewState["Pk_SubrogationDetail"] != null && ViewState["Pk_SubrogationDetail"].ToString() != String.Empty)
            {
                ...
                objSubrogationDetail.Updated_By = "UserName";
