<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.master" CodeFile="subrogation.aspx.cs"
    Inherits="Liability_Subrogation" Title="Risk Management Insurance System" %>
    ...
    <div id="contmain" runat="server" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <asp:GridView ID="gvSubrogation" runat="server" AutoGenerateColumns="false" OnRowCommand="gvSubrogation_RowCommand"
                                                    DataKeyNames="PK_Subrogation" Width="100%" OnPageIndexChanging="gvSubrogation_PageIndexChanging"
                                                    AllowPaging="True" AllowSorting="True" OnSorting="gvSubrogation_Sorting">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Date Of Transaction" SortExpression="Update_Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblDOTransaction" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Update_Date", "{0:MM/dd/yyyy}")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Check Amount $" SortExpression="Check_Amount">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Subrogation" SortExpression="Subrogation">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSubrogation" runat="server" Text='<%#Eval("Subrogation")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField HeaderText="Payment" DataField="Payment_Id" SortExpression="Payment_Id" />
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                    ...
                                                    <InsertItemTemplate>
                                                        <table border="0" cellpadding="2" cellspacing="2" class="lc" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic" style="width: 25%">
                                                                    $<asp:TextBox ID="txtCheckAmt" runat="server" SkinID="txtAmt" MaxLength="11" onKeyPress="return(currencyFormat(this,',','.',event))"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvCheckAmt" ControlToValidate="txtCheckAmt"
                                                                        ErrorMessage="Please Enter Check Amount." Display="none" InitialValue="" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                                <td align="left" class="lc" style="width: 25%">
                                                                ...
                                                                <td align="left" class="ic" style="width: 25%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvProviderName" ControlToValidate="dwProviderName"
                                                                        ErrorMessage="Please Select Provider Name." Display="none" InitialValue="--Select Provider--"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvPAdd1" ControlToValidate="txtPAdd1"
                                                                        ErrorMessage="Please Enter Provider Address (1)." Display="none" InitialValue=""
                                                                        ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                                <td align="left" class="lc">
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvPAdd2" ControlToValidate="txtPAdd2"
                                                                        ErrorMessage="Please Enter Provider Address (2)." Display="none" InitialValue=""
                                                                        ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvPTaxID" ControlToValidate="txtPTaxID"
                                                                        ErrorMessage="Please Enter Provider Tax Id Number." Display="none" InitialValue=""
                                                                        ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvPCity" ControlToValidate="txtPCity"
                                                                        ErrorMessage="Please Enter Provider City." Display="none" InitialValue="" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="lc">
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvPState" ControlToValidate="txtPState"
                                                                        ErrorMessage="Please Enter Provider State." Display="none" InitialValue="" ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                                <td align="left" class="lc">
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvPZip" ControlToValidate="txtPZip"
                                                                        ErrorMessage="Please Enter Provider Zip Code." Display="none" InitialValue=""
                                                                        ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RequiredFieldValidator runat="server" ID="rfvCheckNo" ControlToValidate="txtCheckNo"
                                                                        ErrorMessage="Please Enter Original Check Number." Display="None" InitialValue=""
                                                                        ValidationGroup="vsErrorGroup"></asp:RequiredFieldValidator>
                                                                </td>
                                                                <td align="left" class="lc">
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RadioButton ID="rbtnSubrogationNo" runat="server" GroupName="Subrogation" Text="No" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="lc">
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RadioButton ID="rbtnSalvageNo" runat="server" GroupName="Salvage" Text="No" />
                                                                </td>
                                                                <td align="left" class="lc">
                                                                ...
                                                                <td align="left" class="ic">
                                                                    ...
                                                                    <asp:RadioButton ID="rbtnOtherNo" runat="server" GroupName="Other" Text="No" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="lc">
                                                        ...
                                                        <table cellpadding="2" cellspacing="2" style="width: 100%;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="ic" colspan="4">
                                                                    <asp:TextBox runat="server" ID="txtRecoveryDesc" MaxLength="4000" TextMode="MultiLine"
                                                                        Width="95%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table border="0" cellpadding="2" cellspacing="2" class="stylesheet" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic" style="width: 25%;">
                                                                    ...
                                                                    <asp:RadioButton ID="rbtnFRefundNo" runat="server" GroupName="FullRefund" Text="No" />
                                                                </td>
                                                                <td align="left" class="lc" style="width: 25%;">
                                                        ...
                                                        <table cellpadding="2" cellspacing="2" class="stylesheet" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="4" class="ic" style="width:75%;">
                                                                    <asp:TextBox ID="txtAttachDesc" runat="server" MaxLength="4000" TextMode="MultiLine"
                                                                        Width="95%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <EditItemTemplate>
                                                        <table border="0" cellpadding="2" cellspacing="2" class="lc" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic" style="width: 25%">
                                                                    $<asp:TextBox ID="txtCheckAmt" runat="server" MaxLength="11" SkinID="txtAmt" onKeyPress="return(currencyFormat(this,',','.',event))"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="ic" colspan="4">
                                                                    <asp:TextBox ID="txtDescription" runat="server" Text='<%#Eval("Other_Description") %>'
                                                        ...
                                                        <table cellpadding="2" cellspacing="2" class="stylesheet" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="4" class="ic" style="width:75%;">
                                                                    <asp:TextBox ID="txtAttachDesc" runat="server" TextMode="MultiLine" Width="95%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="lc">
        ...
        <div id="divView" runat="server" style="display: none;">
            <table cellpadding="2" cellspacing="2" border="0" style="width: 100%;">
                ...
                <tr>
                    <td align="left" class="lc">
                        <asp:Label runat="server" ID="lblDLastName">Last Name</asp:Label>
                    </td>
                    <td align="Center" class="lc">
                        :
                    </td>
