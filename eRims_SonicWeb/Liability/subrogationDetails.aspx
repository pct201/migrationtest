<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.master" CodeFile="subrogationDetails.aspx.cs"
    Inherits="Liability_subrogationDetails" Title="Risk Management Insurance System" %>
...
<asp:Content ID="cntSubrogation" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="lc">
                    ...
                    <tr>
                        ...
                        <td style="width: 25%" class="ic">
                            ...
                            <asp:RequiredFieldValidator ID="rfvAppInsPolCompName" runat="server" ControlToValidate="txtAppInsPolCompName"
                            ErrorMessage="Please Enter Applicable Insurance Policy Company's Name" ValidationGroup="vsErrorGroup" InitialValue="" Display="None"></asp:RequiredFieldValidator>
                        </td>
                        <td style="width: 25%" class="ic">
                        ...
                        <td style="width: 25%" class="ic">
                            ...
                            <asp:RequiredFieldValidator ID="rfvAppInsuPolicy" runat="server" ControlToValidate="txtAppInsuPolicy"
                            ErrorMessage="Please Enter Applicable Insurance Policy" ValidationGroup="vsErrorGroup" InitialValue="" Display="None"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="ic">
                        ...
                        <td class="ic">
                            ...
                            ErrorMessage="Please Enter Adjustor On Claim" ValidationGroup="vsErrorGroup" InitialValue="" Display="None"></asp:RequiredFieldValidator>
                        </td>
                        <td class="ic">
                ...
                <table cellpadding="2" cellspacing="2" class="stylesheet" width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="ic">
                            <asp:TextBox ID="txtDescription" runat="server" MaxLength="4000" TextMode="MultiLine" Width="93%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="lc" style="width: 25%">
                        ...
                        <td colspan="4" class="ic" style="width: 75%">
                            <asp:FileUpload runat="server" ID="uplCommon" ValidationGroup="vsErrorGroup"/>
                             <asp:RequiredFieldValidator ID="rfvUpload" runat="server" ControlToValidate="uplCommon" InitialValue="" 
                                Display="None" ErrorMessage="Please Select File to Upload." ValidationGroup="vsErrorGroup">                                                                        
    ...
    <div id="divSaveView" runat="server" style="width: 100%;display: none;" >
        ...
        <div id="div3">
            <table style="widows:100%;" border="0" cellpadding="4" cellspacing="2" class="lc">
                <tr>
                    <td colspan="6" class="ghc">
                        Insurance Information</td>
                </tr>
