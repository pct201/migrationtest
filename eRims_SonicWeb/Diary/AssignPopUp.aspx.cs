...
public partial class Diary_AssignPopUp : clsBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                if (Request.QueryString.Count > 0 && Request.QueryString[1] != null)
                {
    ...
    protected void btnAddDiary_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            m_objDiary.ClaimType = Request.QueryString[2].ToString();
            m_objDiary.AssignBy = "3";
    ...
    private DataSet GetUserListForAssign(System.String m_strCostCenter)
    {
        try
        {
