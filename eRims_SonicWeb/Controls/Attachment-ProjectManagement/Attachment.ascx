<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment.ascx.cs" Inherits="Controls_Attachment_ProjectManagement_Attachment" %>
<%@ Register Src="~/Controls/Attachment-ProjectManagement/EPM_Attach_Section.ascx"
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <input type="hidden" id="hdnID" runat="server" value='<%#Eval("PK_LU_EPM_Attachment_Type")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="File Name" SortExpression="Attachment_Description">
                        ...
                        <ItemTemplate>
                            ...
                            <input type="hidden" id="hdnID" runat="server" value='<%#Eval("PK_EPM_Attachments")%>' />
                    ...
                    <asp:TemplateField HeaderText="Action">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="EditAttachment"
                                CommandArgument='<%# Eval("PK_EPM_Attachments")%>' />&nbsp;
                            ...
                            <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CommandName="DeleteAttachment"
                                CommandArgument='<%# Eval("PK_EPM_Attachments") + ":" + Eval("Attachment_Filename") %>'
