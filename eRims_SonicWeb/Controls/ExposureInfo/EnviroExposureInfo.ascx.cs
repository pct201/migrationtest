...
public partial class EnviroExposureInfo : System.Web.UI.UserControl
{
    #region "Properties"
    ...
    public void BindExposureInfo()
    {
        if (PK_LU_Location > 0)
        {
            ...
            decimal FK_Building_ID = Convert.ToDecimal(Session["EnviroBuilding"]);
            Building objBuilding = new Building((int)FK_Building_ID);
            lblBuildingNumber.Text = objBuilding.Building_Number;
        }
    }
