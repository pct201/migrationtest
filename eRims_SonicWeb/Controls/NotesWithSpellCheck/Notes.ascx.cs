...
/// </summary>
public partial class Controls_LongDescription_LongDescription_SpellCheck : System.Web.UI.UserControl
{
    #region "Enums"
    /// <summary>
    ...
    {
        set { imgSpellCheck.Visible = value; }
    }
    ...
    public CtrlType ControlType
    {
        ...
        set
        {
            if (value == CtrlType.Label)
            {
                ...
                imgSpellCheck.Style["display"] = "none";
            }
        }
    }
    /// <summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        imgSpellCheck.Attributes.Add("onclick", "javascript:checkSpellingById('" + txtNote.ClientID + "');");
