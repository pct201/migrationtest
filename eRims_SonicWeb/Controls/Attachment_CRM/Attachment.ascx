<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment.ascx.cs" Inherits="Hudson_Attachment" %>
        ...
        <td>
            <table cellpadding="3" cellspacing="1" width="100%">              
                <tr valign="top" align="left">
                    ...
                    <td>
                        <uc:ctrlMultiLineTextBox ID="txtAttachDesc" Rows="5" runat="server" ValidationGroup="AddAttachment"
                            MaxLength="4000" onkeypress="javascript:return CheckMaxLength(e,this,4000);" />
                    </td>
                </tr>
                <tr>
                    <td colspan="3" class="spacer" height="5px">
                    </td>
                </tr>
                <tr>
                        ...
                        <table cellpadding="1" cellspacing="0" width="500px">
                            <tr id="trAttachment1" runat="server">
                                ...
                                <td width="10%" align="left">
                                    <asp:LinkButton ID="lbtAdd1" runat="server" Text="--Add--" OnClientClick="javascript:return ShowNewAttachment(2);"></asp:LinkButton>
                                </td>
                                <td align="left">
                            ...
                            <tr id="trAttachment2" runat="server" style="display: none;" width="265px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd2" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment3" runat="server" style="display: none;">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd3" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment4" runat="server" style="display: none;">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd4" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment5" runat="server" style="display: none;">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd5" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment6" runat="server" style="display: none;">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd6" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment7" runat="server" style="display: none;">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd7" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment8" runat="server" style="display: none;">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd8" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment9" runat="server" style="display: none;">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtAdd9" runat="server" Text="--Add--" Style="display: none;"
                            ...
                            <tr id="trAttachment10" runat="server" style="display: none;">
                                <td align="left">
                                    ...
                                    <asp:LinkButton ID="lbtAdd10" runat="server" Text="--Add--" Style="display: none;"
