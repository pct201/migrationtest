<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment.ascx.cs" Inherits="Controls_Attachment_Construction_Attachment" %>
<%@ Register Src="~/Controls/Attachment_Construction/EPM_Attach_Section.ascx"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="File Name" SortExpression="Attachment_Description">
                        ...
                        <ItemTemplate>
                            ...
                            <input type="hidden" id="hdnID" runat="server" value='<%#Eval("PK_FCP_Attachments")%>' />
...
<script type="text/javascript">
    ...
    function ShowMailPage(Attach_IDs) {
        ShowDialog("<%=AppConfig.SiteURL%>SONIC/Exposures/FCP_Attachment_Mail.aspx?Attch_Ids=" + Attach_IDs, 600, 450);
        return false;
    }
