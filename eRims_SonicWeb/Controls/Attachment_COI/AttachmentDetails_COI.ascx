<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AttachmentDetails_COI.ascx.cs" Inherits="AttachmentDetails_COI" %>
...
<script type="text/javascript">
  ...
  function ShowMailPage(attTbl)
  {
        ...
        if (cnt==0)
        {
            ...
            var oWnd=window.open('<%=AppConfig.SiteURL%>COI/SendEmail.aspx?EmailType= <%=Convert.ToString((int)clsGeneral.EmailTYpe.Attachment)%>&AttachmentId='+m_strAttIds,"Erims","location=0,status=0,scrollbars=1,menubar=0,resizable=1,toolbar=0,width=600,height=300");
            oWnd.moveTo(260,180);
            return false;
        }
   }
