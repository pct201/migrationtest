<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment_SLT.ascx.cs" Inherits="Controls_Attachment_SLT_Attachment" %>
...
<asp:ValidationSummary ID="valSummayAttachment" runat="server" ShowMessageBox="true"
    ValidationGroup="AddSLTAttachment" ShowSummary="false" HeaderText="Verify the following field(s):" />
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <asp:CustomValidator ID="reqFile" runat="Server" ErrorMessage="Please select file(s) for attachment"
                            Display="None" ValidationGroup="AddSLTAttachment" ClientValidationFunction="CheckFiles"
                ...
                <tr>
                    <td colspan="3" align="center">
                        <asp:Button ID="btnAddAttachment" runat="server" Text="Add Attachment" CausesValidation="true"
                            OnClientClick="return Page_ClientValidate('AddSLTAttachment')" OnClick="btnAddAttachment_Click" />
                    </td>
                </tr>
            </table>
        </td>
