            ...
            <table cellpadding="3" cellspacing="1" width="100%">
                <tr id="trAttachmentType" runat="server" style="display: none">
                    <td width="18%" align="left">
                        Attachment Type&nbsp;<span class="msg1">*</span>
                    </td>
                    ...
                    <td align="left">
                        ...
                        &nbsp;<asp:RequiredFieldValidator ID="reqAttachType" runat="server" Enabled="false"
                            ...
                            ValidationGroup="AddAttachment" InitialValue="0"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" valign="top">
                        <uc:ctrlMultiLineTextBox ID="txtAttachDesc" runat="server" MaxLength="4000" ValidationGroup="AddAttachment" />
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="top">
                    ...
                    <td align="left" valign="top">
                        ...
                        <asp:RequiredFieldValidator ID="reqFile" runat="server" ControlToValidate="fpFile1"
                           ValidationGroup="AddAttachment" Enabled="false" Display="None" ErrorMessage="Please select the file"></asp:RequiredFieldValidator>
