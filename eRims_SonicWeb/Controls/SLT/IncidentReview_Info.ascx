    ...
    <tr id="trWC_Fr" runat="server" visible="false">
        <td>
            <table width="100%" cellpadding="3" cellspacing="1" border="0">
                ...
                <tr>
                    <td colspan="6" align="left" class="bandHeaderRow" style="height: 10px;">
            ...
            <table width="100%" cellpadding="3" cellspacing="1" border="0">
                ...
                <tr>
                    <td align="left" colspan="6" valign="top">
                        What is the incidents root cause? &nbsp;<span id="Span1" runat="server" style="color: Red;
                            display: none;">*</span> &nbsp;:
                    </td>
                    <%--<td width="1%">
                        :
                ...
                <tr>
                    <td align="left" colspan="6" valign="top">
                        How can the incident be prevented from happening again? &nbsp;<span id="Span2" runat="server"
                ...
                <tr>
                    <td align="left" valign="top" colspan="3">
                        Who has been tasked with implementing practices/procedures to prevent re-occurrence?
                ...
                <tr>
                    <td width="24%" align="left" valign="top">
                        Target Date of Completion&nbsp;<span id="Span4" runat="server" style="color: Red;
                            display: none;">*</span>
                    </td>
                    <td width="1%" valign="top">
                        :
                    ...
                    <td width="20%" align="center" valign="top">
                        Status Due On&nbsp;<span id="Span5" runat="server" style="color: Red; display: none;">*</span>&nbsp;&nbsp;&nbsp;:
                    </td>
                    <%--<td width="1%" valign="top"> 
                        :
                    </td>--%>
                ...
                <tr>
                    ...
                    <td colspan="2" align="center">
                        <asp:Button ID="btnSaveNext" runat="server" Text="Save" ValidationGroup="vsIncidentReview"
    ...
    <tr id="trIncident_Review_View" runat="server" visible="false">
        <td width="100%">
            <table width="100%" cellpadding="3" cellspacing="1" border="0">
                ...
                <tr>
                    <td align="left" colspan="6" valign="top">
                        What is the incidents root cause? &nbsp;:
                    </td>
                    <%--<td width="1%">
                        :
                    </td>
                ...
                <tr>
                    <td width="24%" align="left" valign="top">
                        Incident Investigation Reviewed &nbsp;
                    </td>
                    <td width="1%" valign="top">
                        :
                    </td>
