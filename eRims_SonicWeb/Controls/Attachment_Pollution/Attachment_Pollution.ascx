<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment_Pollution.ascx.cs"
    Inherits="Attachment_Pollution" %>
    ...
    <tr>
        <td>
            <table cellpadding="3" cellspacing="1" width="100%">
                <tr id="trAttachment_Type" runat="server" visible="false">
