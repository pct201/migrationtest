<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AttachmentEvent.ascx.cs" Inherits="Controls_Attachments_AttachmentEvent" %>
            ...
            <table cellpadding="3" cellspacing="1" width="100%">
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:RequiredFieldValidator ID="rfvFile" runat="server" ControlToValidate="fpFile"
                            ErrorMessage="Please select File for attachment" SetFocusOnError="true" Display="None"
                            ValidationGroup="AddAttachment" />
                    </td>
                </tr>
                <tr>
