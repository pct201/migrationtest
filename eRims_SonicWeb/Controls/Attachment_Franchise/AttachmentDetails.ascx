<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AttachmentDetails.ascx.cs" Inherits="Franchise_AttachmentDetails" %>
<script type="text/javascript">
 ...
 //Used to display Mail Page
  function ShowMailPage(attTbl)
  {
        ...
        {
            var oWnd = window.open('<%=AppConfig.SiteURL%>SONIC/Franchise/SendEmail.aspx?AttachmentId=' + m_strAttIds, "Erims", "location=0,status=0,scrollbars=1,menubar=0,resizable=1,toolbar=0,width=600,height=300");
            oWnd.moveTo(260,180);
            return false;
        }
   }
</script>
<div class="bandHeaderRow">Attachment Details</div>
            ...
            <asp:GridView ID="gvAttachment" runat="server" AllowPaging="false" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <input type="hidden" id='hdnID<%#Container.DataItemIndex%>' value='<%#Eval("PK_Franchise_Attachments")%>'/>
                            <input type="hidden" id="hdnID" runat="server"
                                value='<%#Eval("PK_Franchise_Attachments")%>' /></ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <%--<asp:TemplateField HeaderText="Attachment Description">
                        ...
                        <ItemTemplate>                        
                        <asp:Label ID="lblDesc" runat="server" Width="250px" Text='<%#Eval("Description")%>' CssClass="textAttachment"></asp:Label>
                    ...
                    <asp:TemplateField HeaderText="View">
                        ...
                        <ItemTemplate>
                            <input type="hidden" id="hdnFileName" runat="server" value='<%#Eval("Path") %>' />
                ...
                <EmptyDataTemplate>
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center">
                               <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="Currently There Is No Attachment.<br />Please Add One Or More Attachment." />
                            </td>
                        </tr>
                    </table>
                </EmptyDataTemplate>
