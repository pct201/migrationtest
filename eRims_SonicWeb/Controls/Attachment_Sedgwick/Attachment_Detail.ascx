<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment_Detail.ascx.cs" Inherits="Controls_Attachment_Sedgwick_Attachment_Detail" %>
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <input type="hidden" id="hdnID" runat="server" value='<%#Eval("PK_Sedgwick_Attachments")%>' /></ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Attachment Description" SortExpression="CAST(Attachment_Description AS NVARCHAR(4000))">
