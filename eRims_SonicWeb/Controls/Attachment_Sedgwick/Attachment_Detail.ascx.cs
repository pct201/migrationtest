...
public partial class Controls_Attachment_Sedgwick_Attachment_Detail : System.Web.UI.UserControl
{
    ...
    public void InitializeAttachmentDetails(int FK, string FK_Field_Name, string pK_Field_Name, bool AllowRemove, int intAttachmentPanelNumber)
    {
        ...
        SortBy = "CAST(Attachment_Description AS NVARCHAR(4000)),Attachment_Path";
        SortOrder = "ASC";
    ...
    public void Bind()
    {
        ...
        {
            string strSQL = "";
            strSQL = strSQL + "SELECT " + PK_Field_Name + " AS PK_Sedgwick_Attachments,";
            ...
            if (SortBy == "Attachment_Description")
                SortBy = "CAST(Attachment_Description AS NVARCHAR(4000))";
