...
/// </summary>
public partial class Controls_ClaimAttachment_AttachmentDetails : System.Web.UI.UserControl
{
    ...
    protected void btnRemoveAttachment_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < gvAttachment.Rows.Count; i++)
        {
            ...
            CheckBox chkSelect = (CheckBox)gvAttachment.Rows[i].FindControl("chkSelectClaim");
