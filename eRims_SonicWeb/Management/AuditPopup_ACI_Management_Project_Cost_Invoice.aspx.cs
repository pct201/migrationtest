...
using System.Data;
public partial class Management_AuditPopup_ACI_Management_Project_Cost_Invoice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["id"]))
            {
                ...
                // show Case Grid 
                dvGrid.Visible = true;
                lbltable_Name.Text = "Project Cost Invoice";

                // Fill grid with audit table
                dt = AuditTrail.Get_ACI_Management_ProjectCostInvoice_AuditTrial(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
