...
public partial class SONIC_Exposures_ACI_Management_ProjectCost_Invoice : clsBasePage
{
    ...
    private void SetValidations()
    {
        ...
        DataTable dtFieldsProjectCost = clsScreen_Validators.SelectByScreen(clsScreen.ScreenSelectByName("Project Cost - Invoice", "ACI Management", "ACI Management")).Tables[0];
