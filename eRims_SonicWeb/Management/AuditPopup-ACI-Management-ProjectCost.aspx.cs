...
public partial class Management_AuditPopup_ACI_Management_ProjectCost : clsBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["id"]))
            {
                ...
                dt = AuditTrail.GetACI_Management_ProjectCost_AuditTrial(Convert.ToDecimal(Request.QueryString["id"])).Tables[0];
