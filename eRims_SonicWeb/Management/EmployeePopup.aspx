<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeePopup.aspx.cs" Inherits="Management_EmployeePopup" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function ClosePopup(EmpId, EmpFirstName,EmpLastName,Phone,Email) {
            ...
            parent.parent.document.getElementById('ctl00_ContentPlaceHolder1_txtStore_Contact_First_Name').value = EmpFirstName;
            parent.parent.document.getElementById('ctl00_ContentPlaceHolder1_txtStore_Contact_Last_Name').value = EmpLastName;
            parent.parent.document.getElementById('ctl00_ContentPlaceHolder1_txtStore_Contact_Phone').value = Phone;
            parent.parent.document.getElementById('ctl00_ContentPlaceHolder1_txtStore_Contact_Email').value = Email;
