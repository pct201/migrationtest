<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditPopup_ACI_Management_Project_Cost_Invoice.aspx.cs" Inherits="Management_AuditPopup_ACI_Management_Project_Cost_Invoice" %>
            ...
            <tr>
                <td colspan="2">
                    <div style="overflow: hidden; width: 650px;" id="dvHeader" runat="server">
                        <table cellpadding="4" cellspacing="0" style="width: 1867px; border-collapse: collapse;">
                            <tbody>
                    ...
                    <div style="overflow: scroll; width: 1867px; height: 400px;" id="dvGrid" runat="server">
                        <asp:GridView ID="gvProjectCost" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="FK_EPM_Identification">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblFK_EPM_Identification" runat="server" Text='<%#Eval("FK_Management")%>' CssClass="TextClip"
                                            Width="100px" ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
