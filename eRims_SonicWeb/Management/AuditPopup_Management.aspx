                        ...
                        <table cellpadding="4" cellspacing="0" style="width: 600px; border-collapse: collapse;"
                            ...
                            <tbody>
                                ...
                                <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px;">Total Repair Cost</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px;">RPM Approval</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px;">No Approval Needed</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px;">Approval Needed</span>
                                    </th>
                                    <th class="cols">
                                    ...
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px;">Original Service Estimate</span>
                                    </th>
                                    <th class="cols">
                                        <span style="display: inline-block; width: 150px;">Repair and Estimate Amount</span>
                                    </th>
                                    <%--<th class="cols">
                    ...
                    <div style="overflow: scroll; width: 600px; height: 425px;" id="divgvManagement_Audit_Grid"
                        ...
                        <asp:GridView ID="gvManagement_Audit" runat="server" AutoGenerateColumns="False" Style="word-wrap: normal; word-break: break-all;"
                            ...
                            <asp:TemplateField HeaderText="Facilities Issue">
                                ...
                                <asp:TemplateField HeaderText="RPM Approval">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblRPM_Approval" runat="server" Text='<%# Convert.ToString(Eval("RPM_Approval")) != null && Convert.ToString(Eval("RPM_Approval")).ToUpper() == "TRUE" ? "Yes" : "No" %>' Width="150px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="No Approval Needed">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblNo_Approval_Needed" runat="server" Text='<%# Convert.ToString(Eval("No_Approval_Needed")) != null && Convert.ToString(Eval("No_Approval_Needed")).ToUpper() == "TRUE" ? "Yes" : "No" %>'
                                            Width="150px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Approval Needed">
                                    <ItemStyle CssClass="cols" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblApproval_Needed" runat="server" Text='<%# Convert.ToString(Eval("Approval_Needed")) != null && Convert.ToString(Eval("Approval_Needed")).ToUpper() == "TRUE" ? "Yes" : "No" %>'
                                            Width="150px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
