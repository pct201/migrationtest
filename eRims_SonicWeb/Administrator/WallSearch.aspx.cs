...
public partial class Administrator_WallSearch : clsBasePage
{
    #region "Properties"
    /// <summary>
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                DataTable dtAttachment = clsMain_Wall.DeleteByPKs(strSelected).Tables[0];
    ...
    protected void gvWallSearch_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("EditWallPost.aspx?id=" + Encryption.Encrypt(Convert.ToString(e.CommandArgument)), true);
        }
    }
