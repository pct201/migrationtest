<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="WC_AllocationCharges.aspx.cs"
    Inherits="Administrator_WC_AllocationCharges" Title="eRIMS Sonic :: WC Allocation Charges" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function AuditPopUp()
        {
            ...
            obj= window.open("AuditPopup_WC_AllocationCharges.aspx?id=" + '<%=PK_WC_Allocation_Charges%>','AuditPopUp','width=' + winWidth +',height=' + winHeight + ',left=' + (window.screen.width - winWidth) / 2 + ',top=' + (window.screen.height - winHeight) / 2 + ',sizable=no,titlebar=no,location=0,status=0,scrollbars=1,menubar=0');        
            obj.focus();
            return false;
        }
    </script>
                ...
                <asp:Panel ID="pnlEditWC_Allocation" runat="server">
                    <table width="80%" cellpadding="3" cellspacing="3" style="text-align: left; vertical-align: top;">
                        <tr valign="top">
                            ...
                            <td style="width: 20%;">
                                Charge Type <span class="mf">*</span>
                            </td>
                            <td style="width: 3%;">
                                :
                            </td>
                        ...
                        <tr valign="top">
                            <td>
                                Charge Date <span class="mf">*</span>
                            </td>
                            <td>
                                :
                            </td>
                        ...
                        <tr valign="top">
                            <td valign="top">
                                Change Explanation<span class="mf">*</span>
                            </td>
                            <td valign="top">
                                :
                            </td>
