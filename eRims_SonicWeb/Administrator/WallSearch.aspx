<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="WallSearch.aspx.cs" Inherits="Administrator_WallSearch" %>
                        ...
                        <tr>
                            <td align="left">
                                <asp:GridView ID="gvWallSearch" runat="server" Width="100%" OnRowCommand="gvWallSearch_RowCommand" AutoGenerateColumns="false"
                                    AllowSorting="true" OnRowCreated="gvWallSearch_RowCreated" DataKeyNames="PK_Main_Wall" OnRowDataBound="gvWallSearch_RowDataBound"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <input name="chkItem" id="chkItemID" type="checkbox" value='<%# Eval("PK_Main_Wall")%>' onclick="javascript:UnCheckHeader('gvWallSearch')" />
