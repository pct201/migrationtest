<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="DashboardWallSearch.aspx.cs" Inherits="Administrator_DashboardWallSearch" %>
        ...
        <table cellpadding="1" cellspacing="1" width="100%">
                        ...
                        <tr>
                            <td align="left">
                                <asp:GridView ID="gvWallSearch" runat="server" Width="100%" OnRowCommand="gvWallSearch_RowCommand" AutoGenerateColumns="false"
                                    AllowSorting="true" OnRowCreated="gvWallSearch_RowCreated" DataKeyNames="PK_Dashboard_Wall" OnRowDataBound="gvWallSearch_RowDataBound"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <input name="chkItem" id="chkItemID" type="checkbox" value='<%# Eval("PK_Dashboard_Wall")%>' onclick="javascript:UnCheckHeader('gvWallSearch')" />
                                        ...
                                        <asp:TemplateField HeaderText="Disposition ">
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" Text=" Edit " CommandName="EditWall"
                                                    CommandArgument='<%#Eval("PK_Dashboard_Wall")%>' />
                                            </ItemTemplate>
            ...
            <tr>
                <td align="center">
                    ...
                    &nbsp; &nbsp;
                    <asp:Button ID="btnDelete" runat="server" Text=" Delete " SkinID="btnGen" OnClick="btnDelete_Click" />
                    &nbsp; &nbsp;
