...
public partial class Administrator_AuditPopup_WC_AllocationCharges_ByMarket : clsBasePage
{
    # region " Properties "
    ...
    private void BindALFirstReport_Audit()
    {
        ...
        dt = AuditTrail.GetWC_Allocation_Charges_ByMarket_AuditTrial(PK).Tables[0];
