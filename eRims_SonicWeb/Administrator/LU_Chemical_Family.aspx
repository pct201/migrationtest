<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="LU_Chemical_Family.aspx.cs"
    Inherits="Administrator_LU_Chemical_Family" Title="eRIMS Sonic :: Franchise Option" %>
                        ...
                        <td align="center" colspan="2">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:GridView ID="gvChemicalFamily" runat="server" Width="100%" AutoGenerateColumns="false"
                                                PageSize="10" EnableViewState="true" AllowPaging="true" OnRowCommand="gvChemicalFamily_RowCommand"
                                                OnPageIndexChanging="gvChemicalFamily_PageIndexChanging">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Chemical Family">
                                                        <ItemStyle Width="60%" />
                                                        <ItemTemplate>
                                                            <%#Eval("Fld_Desc") %>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_Chemical_Family") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 25%" align="left">
                                            Chemical Family<span class="mf">*</span>
                                        </td>
                                        <td style="width: 4%" align="center">
                                            :
                                        </td>
                                        <td align="left" colspan="4">
                                            <asp:TextBox ID="txtChemicalFamily" runat="server" MaxLength="50"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvStatus" runat="server" ValidationGroup="vsError"
                                                SetFocusOnError="true" ErrorMessage="Please Enter Chemical Family" Display="none"
                                                ControlToValidate="txtChemicalFamily"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 25%" align="left">
