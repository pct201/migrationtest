<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.master" CodeFile="LU_Find_Fix_Category.aspx.cs" Inherits="Administrator_LU_Find_Fix_Category" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        jq(function () {
            jq('.gvFindFixCategory').each(function () {
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            ...
            <tr>
                <td class="bandHeaderRow" align="left" colspan="4">Administrator :: Find It And Fix It Category
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <asp:GridView ID="gvFindFixCategory" CssClass="gvFindFixCategory" runat="server" Width="100%" AutoGenerateColumns="false"
                                        PageSize="10" EnableViewState="true" AllowPaging="false" GridLines="None" OnRowCommand="gvFindFixCategory_RowCommand" ShowHeader="false" dontUseScrolls="true">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemStyle Width="50%" />
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                        CommandArgument='<%#Eval("PK_LU_Find_Fix_Category") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:HiddenField runat="server" Value='<%# Eval("PK_LU_Find_Fix_Category") %>' ID="hdnPK" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataTemplate>
