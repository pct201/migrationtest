<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="UserHelp.aspx.cs"
    Inherits="Administrator_UserHelp" Title="Risk Insurance Management System :: User Help" %>
    ...
    <asp:UpdatePanel runat="server" ID="updGroup">
        <ContentTemplate>
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="bandHeaderRow" colspan="3" align="left">
                        Administrator :: User Help
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        &nbsp;<asp:Label runat="server" ID="lblError" SkinID="lblError" EnableViewState="false"></asp:Label>
                    </td>
                </tr>
                <tr runat="server" id="trGrid">
                    ...
                    <td align="center">
                        <table cellpadding="3" cellspacing="2" border="0" width="100%">
                            ...
                            <tr>
                                <td align="left">
                                    &nbsp;<asp:Button runat="server" ID="btnAddNew" Text="  Add  " OnClick="btnAddNew_Click">
                                    </asp:Button>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td align="center">
                        <table width="70%" cellpadding="3" cellspacing="2" border="0">
                            <tr>
                                ...
                                <td width="68%" align="left">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="rfvType" ValidationGroup="vsError"
                                        SetFocusOnError="true" ErrorMessage="Please Select Help Type" Display="none"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    URL <span class="mf">*</span>
                                </td>
                                <td align="center">
                                    :
                                </td>
                                <td align="left" nowrap="nowrap">
                                    http://<asp:TextBox ID="txtUrl" runat="server" MaxLength="500" Width="360px"></asp:TextBox>
                            ...
                            <tr>
                                <td colspan="4" class="spacer" height="10px">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
