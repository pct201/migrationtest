<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="LU_Property_Contact_Type.aspx.cs" Inherits="LU_Property_Contact_Type" %>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="bandHeaderRow" align="left" colspan="4">
                            Administrator :: Property Contact Type
                        ...
                        <td align="center" colspan="2">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:GridView ID="gvPropertyContactType" runat="server" Width="100%" AutoGenerateColumns="false"
                                                PageSize="10" EnableViewState="true" AllowPaging="true" OnRowCommand="gvPropertyContactType_RowCommand"
                                                OnPageIndexChanging="gvPropertyContactType_PageIndexChanging">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_Property_Contact_Type") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
                        ...
                        <td colspan="2">
                            <table cellspacing="1" cellpadding="3" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 25%" align="left">
                                            Category<span class="mf">*</span>
                                        </td>
                                        <td style="width: 4%" align="center">
                                            :
                                        </td>
                                        <td align="left" colspan="4">
                                            <asp:DropDownList ID="drpCategory" runat="server" SkinID="dropGen">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvCategory" runat="server" ValidationGroup="vsError"
                                                SetFocusOnError="true" ErrorMessage="Please select Category" Display="none"
                                                ControlToValidate="drpCategory" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 25%" align="left">
