...
public partial class Administrator_AdjustPastCharge : clsBasePage
{
    #region "Declaration"
    ...
    {
        DataTable dtWc_fr = WC_FR.SelectByRegion(drpRegion.SelectedItem.Value);
    ...
    {
        gvWC_Allocation.DataSource = WC_Allocation_Charges.SearchByFR_Number(FK_WC_FR_ID);
    ...
    {
        clsSession.FK_WC_FR_ID = FK_WC_FR_ID;
        Response.Redirect("WC_AllocationCharges.aspx");
    }
    ...
    protected void gvWC_Allocation_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "EditRecord")
            Response.Redirect("WC_AllocationCharges.aspx?mode=edit&id=" + Encryption.Encrypt(Pk_Wc_Allocation.ToString()));
        else if (e.CommandName == "View")
            Response.Redirect("WC_AllocationCharges.aspx?mode=view&id=" + Encryption.Encrypt(Pk_Wc_Allocation.ToString()));
    }
}
