...
<body>
    ...
    <script type="text/javascript">
        function test(arg) {
            var val = "<%=val%>";
            var test = arg.split(",");
            window.opener.document.getElementById('ctl00_ContentPlaceHolder1_txtIAssignToDiary').value = test[0];
            window.opener.document.getElementById('ctl00_ContentPlaceHolder1_txtIAssignToIDDiary').value = test[1];
            self.close();
        }
    </script>
    <div>
