...
public partial class Administrator_DashboardWallSearch : clsBasePage
{
    #region "Properties"
    /// <summary>
    ...
    {
        Response.Redirect("../Dashboard/DashboardGraph.aspx", true);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                DataTable dtAttachment = clsDashboard_Wall.DeleteByPKs(strSelected).Tables[0];
    ...
    protected void gvWallSearch_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("EditDashboardWallPost.aspx?id=" + Encryption.Encrypt(Convert.ToString(e.CommandArgument)), true);
        }
    }
