<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="LU_Auto_Liability_Type.aspx.cs" Inherits="Administrator_LU_Auto_Liability_Type" %>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="bandHeaderRow" align="left" colspan="4">
                            Administrator :: Auto Liability - Type
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                        ...
                        <td align="center" colspan="2">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:GridView ID="gvAuto_Liability_Type" runat="server" Width="100%" AutoGenerateColumns="false"
                                                PageSize="10" EnableViewState="true" AllowPaging="true" OnRowCommand="gvAuto_Liability_Type_RowCommand"
                                                OnPageIndexChanging="gvAuto_Liability_Type_PageIndexChanging">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Auto Liability Type">
                                                        <ItemStyle Width="60%" />
                                                        <ItemTemplate>
                                                            <%#Eval("Fld_Desc") %>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_Auto_Liability_Type") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 25%" align="left">
                                           Auto Liability Type<span class="mf">*</span>
                                        </td>
                                        <td style="width: 4%" align="center">
                                            :
                                        </td>
                                        <td align="left" colspan="4">
                                            <asp:TextBox ID="txtLU_Auto_Liability_Type" runat="server" MaxLength="50"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvStatus" runat="server" ValidationGroup="vsError"
                                                SetFocusOnError="true" ErrorMessage="Please Enter Auto Liability Type" Display="none"
                                                ControlToValidate="txtLU_Auto_Liability_Type"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 25%" align="left">
