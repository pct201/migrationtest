<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="LU_Secondary_Containment_Type.aspx.cs" Inherits="Administrator_Secondary_Containment_Type" %>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="bandHeaderRow" align="left" colspan="4">
                            Administrator :: Pollution Secondary Containment Type
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                        ...
                        <td align="center" colspan="2">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:GridView ID="gvSecondaryContainmentType" runat="server" Width="100%" AutoGenerateColumns="false"
                                                PageSize="10" EnableViewState="true" AllowPaging="true" OnRowCommand="gvSecondaryContainmentType_RowCommand"
                                                OnPageIndexChanging="gvSecondaryContainmentType_PageIndexChanging">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_Secondary_Containment_Type") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
