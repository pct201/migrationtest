...
<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="LU_Event_DBA.aspx.cs" Inherits="Administrator_LU_Event_DBA" %>
                                            ...
                                            <asp:GridView ID="gvEvent_Description" runat="server" Width="100%" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="&nbsp;&nbsp;&nbsp;&nbsp;Edit">
                                                        <ItemStyle Width="10%" />
                                                        <ItemTemplate>
                                                            <asp:Button runat="server" ID="lnkEdit" Text=" Edit " CommandName="EditRecord" CommandArgument='<%#Eval("PK_LU_Location") %>'>
                                                            </asp:Button>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                            ...
                            <table cellspacing="1" cellpadding="3" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" colspan="4">
                                            <asp:TextBox ID="txtDBA" runat="server" Width="170px" MaxLength="100"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvDBA" runat="server" ValidationGroup="vsError"
                                                SetFocusOnError="true" ErrorMessage="Please Enter DBA" Display="none"
                                                ControlToValidate="txtDBA"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 18%" align="left">
                                            Location Code<span class="mf">*</span>
                                        </td>
                                        <td style="width: 4%" align="center">
                                            :
                                        </td>
                                        <td align="left" colspan="4">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="vsError"
                                                SetFocusOnError="true" ErrorMessage="Please Enter Location Code" Display="none" ControlToValidate="txtCode"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 18%" align="left">
                                            ACI Group ID<span class="mf">*</span>
                                        </td>
                                        <td style="width: 4%" align="center">
                                            :
                                        </td>
                                        <td align="left" colspan="4">
                                           <asp:DropDownList ID="ddlGroupId" runat="server" Width="175px">
                                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="rfvGroupId" runat="server" ValidationGroup="vsError" InitialValue="0"
                                                SetFocusOnError="true" ErrorMessage="Please Select Group ID" Display="none" ControlToValidate="ddlGroupId"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
