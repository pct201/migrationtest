<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="LU_Roof_Repairs.aspx.cs" Inherits="Administrator_LU_Roof_Repairs" %>
        ...
        <ContentTemplate>
            <table cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td class="bandHeaderRow" align="left" colspan="4">Administrator :: Roof Repairs
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">&nbsp;
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_Roof_Repairs") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
