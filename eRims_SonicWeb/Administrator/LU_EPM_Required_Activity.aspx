<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeFile="LU_EPM_Required_Activity.aspx.cs" Inherits="Administrator_LU_EPM_Required_Activity" %>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="bandHeaderRow" align="left" colspan="4">
                            Administrator :: Required Activity
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                        ...
                        <td align="center" colspan="2">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:GridView ID="gvRequiredActivity" runat="server" Width="100%" AutoGenerateColumns="false"
                                                PageSize="10" EnableViewState="true" AllowPaging="true" OnRowCommand="gvRequiredActivity_RowCommand"
                                                OnPageIndexChanging="gvRequiredActivity_PageIndexChanging">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_EPM_Required_Activity") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
