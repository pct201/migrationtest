<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="CRM_Category.aspx.cs" Inherits="Administrator_CRM_Category" %>
                        ...
                        <td align="center" colspan="2">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:GridView ID="gvCRM_Category" runat="server" Width="100%" AutoGenerateColumns="false"
                                                PageSize="10" EnableViewState="true" AllowPaging="true" OnRowCommand="gvCRM_Category_RowCommand"
                                                OnPageIndexChanging="gvCRM_Category_PageIndexChanging">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Description">
                                                     ...
                                                     <asp:TemplateField HeaderText="Email">
                                                        <ItemStyle Width="20%" />
                                                        <ItemTemplate>                                                         
                                                           <asp:Label runat="server" ID="lblEmail" Text='<%#(Eval("Email").ToString() == "Y" ? "Active" : "In Active") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_CRM_Category") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
                                ...
                                <tbody>
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="left" colspan="4">
                                            <asp:RadioButtonList ID="rdbEmail" runat="server">
