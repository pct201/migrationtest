<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="CRM_Note_Type.aspx.cs" Inherits="Administrator_CRM_Note_Type" %>
                        ...
                        <td align="center" colspan="2">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:GridView ID="gvCRMNoteType" runat="server" Width="100%" AutoGenerateColumns="false"
                                                PageSize="10" EnableViewState="true" AllowPaging="true" OnRowCommand="gvCRMNoteType_RowCommand"
                                                OnPageIndexChanging="gvCRMNoteType_PageIndexChanging">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkEdit" Text="Edit" CommandName="EditRecord"
                                                                CommandArgument='<%#Eval("PK_LU_CRM_Note_Type") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
                            ...
                            <table cellspacing="1" cellpadding="3" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="center">:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="drpTableName" runat="server" Width="160px" SkinID="dropGen">
                                                <asp:ListItem Text="CRM_Customer" Value="CRM_Customer" Selected="True" />
                                                <asp:ListItem Text="CRM_Non_Customer" Value="CRM_Non_Customer" />
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
