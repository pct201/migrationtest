...
namespace ERIMS_DAL
{
    ...
    /// </summary>
    public sealed class AdHocFilter
    {
        ...
        /// </summary>
        public AdHocFilter(decimal pK_AdHocFilter)
        {
        ...
        /// <returns></returns>
        public List<AdHocFilter> GetAdHocReportFieldByPk(decimal Pk_AdHocReport)
        {
            ...
            try
            {
                ...
                List<ERIMS_DAL.AdHocFilter> results = new List<ERIMS_DAL.AdHocFilter>();
                ERIMS_DAL.AdHocFilter objAdHoc;
        ...
        /// <returns></returns>
        private ERIMS_DAL.AdHocFilter MapFrom(IDataReader reader)
        {
            ERIMS_DAL.AdHocFilter objAdHoc = new ERIMS_DAL.AdHocFilter();
            try
            {
