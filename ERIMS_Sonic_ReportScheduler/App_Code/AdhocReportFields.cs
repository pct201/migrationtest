...
namespace ERIMS_DAL
{
    public class AdhocReportFields
    {
        ...
        /// <returns></returns>
        public List<AdhocReportFields> GetAdHocReportFieldByPk(decimal Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<AdhocReportFields> results = new List<AdhocReportFields>();
                AdhocReportFields objAdHoc;
        ...
        /// <param name="Pk_AdhocReportFields"></param>
        /// <returns></returns>
        public List<AdhocReportFields> GetAdHocReportFieldByMultipleID(string Pk_AdhocReportFields)
        {
            ...
            try
            {
                ...
                List<AdhocReportFields> results = new List<AdhocReportFields>();
                AdhocReportFields objAdHoc = new AdhocReportFields();
        ...
        /// <returns></returns>
        protected AdhocReportFields MapFrom(IDataReader reader)
        {
            AdhocReportFields objAdHoc = new AdhocReportFields();
