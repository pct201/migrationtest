    ...
    public sealed class Management_AdHocFilter
    {
        ...
        public List<Management_AdHocFilter> GetAdHocReportFieldByPk(decimal FK_Management_AdHocReport)
        {
            ...
            try
            {
                ...
                List<ERIMS_DAL.Management_AdHocFilter> results = new List<ERIMS_DAL.Management_AdHocFilter>();
                ERIMS_DAL.Management_AdHocFilter objAdHoc;
        ...
        /// <returns></returns>
        private ERIMS_DAL.Management_AdHocFilter MapFrom(IDataReader reader)
        {
            ERIMS_DAL.Management_AdHocFilter objAdHoc = new ERIMS_DAL.Management_AdHocFilter();
            try
            {
